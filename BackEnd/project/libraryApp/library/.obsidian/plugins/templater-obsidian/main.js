...
var ga = (e) => Ir(e, "__esModule", { value: !0 });
var To = (e, t) => {
    ga(e);
    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of wo(t))
        !jo.call(e, i) &&
          ...
          Ir(e, i, {
            get: () => t[i],
            enumerable: !(r = bo(t, i)) || r.enumerable,
          });
    return e;
  },
  $ = (e) =>
...
To(exports, { default: () => ta });
var er = $(require("obsidian"));
var ri = $(require("obsidian"));
var te = (function () {
  function e() {}
  return (
    (e.explainIfInvalidTSDocTagName = function (t) {
      if (t[0] !== "@") return 'A TSDoc tag name must start with an "@" symbol';
      if (!e._tsdocTagNameRegExp.test(t))
        return "A TSDoc tag name must start with a letter and contain only letters and numbers";
    }),
    (e.validateTSDocTagName = function (t) {
      var r = e.explainIfInvalidTSDocTagName(t);
      if (r) throw new Error(r);
    }),
    (e.explainIfInvalidLinkUrl = function (t) {
      if (t.length === 0) return "The URL cannot be empty";
      if (!e._urlSchemeRegExp.test(t))
      ...
      if (!e._urlSchemeAfterRegExp.test(t))
        return 'An @link URL must have at least one character after "://"';
    }),
    (e.explainIfInvalidHtmlName = function (t) {
      if (!e._htmlNameRegExp.test(t))
        return "An HTML name must be an ASCII letter followed by zero or more letters, digits, or hyphens";
    }),
    (e.validateHtmlName = function (t) {
      var r = e.explainIfInvalidHtmlName(t);
      if (r) throw new Error(r);
    }),
    (e.explainIfInvalidPackageName = function (t) {
      if (t.length === 0) return "The package name cannot be an empty string";
      if (!e._validPackageNameRegExp.test(t))
        return "The package name ".concat(
          JSON.stringify(t),
          " is not a valid package name",
        );
    }),
    (e.explainIfInvalidImportPath = function (t, r) {
      if (t.length > 0) {
        if (t.indexOf("//") >= 0) return 'An import path must not contain "//"';
        if (t[t.length - 1] === "/")
    ...
    (e.isSystemSelector = function (t) {
      return e._systemSelectors.has(t);
    }),
    (e.explainIfInvalidUnquotedIdentifier = function (t) {
      if (t.length === 0) return "The identifier cannot be an empty string";
      if (e._identifierBadCharRegExp.test(t))
        return "The identifier cannot non-word characters";
      if (e._identifierNumberStartRegExp.test(t))
        return "The identifier must not start with a number";
    }),
    (e.explainIfInvalidUnquotedMemberIdentifier = function (t) {
      var r = e.explainIfInvalidUnquotedIdentifier(t);
      if (r !== void 0) return r;
      if (e.isSystemSelector(t))
        return 'The identifier "'.concat(
          t,
          '" must be quoted because it is a TSDoc system selector name',
        );
    }),
    (e._tsdocTagNameRegExp = /^@[a-z][a-z0-9]*$/i),
    (e._urlSchemeRegExp = /^[a-z][a-z0-9]*\:\/\//i),
    (e._urlSchemeAfterRegExp = /^[a-z][a-z0-9]*\:\/\/./i),
    (e._htmlNameRegExp = /^[a-z]+[a-z0-9\-]*$/i),
    (e._identifierBadCharRegExp = /[^a-z0-9_$]/i),
    (e._identifierNumberStartRegExp = /^[0-9]/),
    (e._validPackageNameRegExp = /^(?:@[a-z0-9\-_\.]+\/)?[a-z0-9\-_\.]+$/i),
    (e._systemSelectors = new Set([
      "instance",
      "static",
      "constructor",
      "class",
...
var Di = (function () {
  ...
  return (
    (e.prototype.registerDocNodes = function (t, r) {
      var i = te.explainIfInvalidPackageName(t);
      if (i) throw new Error("Invalid NPM package name: " + i);
      for (var n = 0, a = r; n < a.length; n++) {
        var s = a[n];
        if (!e._nodeKindRegExp.test(s.docNodeKind))
          throw new Error(
            "The DocNode kind ".concat(
              JSON.stringify(s.docNodeKind),
              " is not a valid identifier.",
            ) +
              " It must start with an underscore or letter, and be comprised of letters, numbers, and underscores",
          );
        var c = this._docNodeDefinitionsByKind.get(s.docNodeKind);
        if (c !== void 0)
          throw new Error(
            'The DocNode kind "'.concat(
              s.docNodeKind,
              '" was already registered',
            ) + " by ".concat(c.packageName),
          );
        if (
          ((c = this._docNodeDefinitionsByConstructor.get(s.constructor)),
          c !== void 0)
        )
          throw new Error(
            "This DocNode constructor was already registered by ".concat(
              c.packageName,
            ) + " as ".concat(c.docNodeKind),
          );
        var l = {
          docNodeKind: s.docNodeKind,
          constructor: s.constructor,
          packageName: t,
          allowedChildKinds: new Set(),
        };
        (this._docNodeDefinitionsByKind.set(s.docNodeKind, l),
          this._docNodeDefinitionsByConstructor.set(s.constructor, l));
      }
    }),
    (e.prototype.throwIfNotRegisteredKind = function (t) {
      if (!this._docNodeDefinitionsByKind.has(t))
        throw new Error(
          'The DocNode kind "'.concat(
            t,
    ...
    (e.prototype.registerAllowableChildren = function (t, r) {
      for (var i = this._getDefinition(t), n = 0, a = r; n < a.length; n++) {
        var s = a[n];
        (this._getDefinition(s), i.allowedChildKinds.add(s));
      }
    }),
    (e.prototype.isAllowedChild = function (t, r) {
      var i = this._getDefinition(t);
      return i.allowedChildKinds.has(r);
    }),
    (e.prototype._getDefinition = function (t) {
      var r = this._docNodeDefinitionsByKind.get(t);
      if (r === void 0)
        throw new Error(
          'The DocNode kind "'.concat(
            t,
    ...
    (e._nodeKindRegExp = /^[_a-z][_a-z0-9]*$/i),
    e
  );
})();
var G;
...
var L;
(function (e) {
  ((e[(e.InlineTag = 0)] = "InlineTag"),
    (e[(e.BlockTag = 1)] = "BlockTag"),
    (e[(e.ModifierTag = 2)] = "ModifierTag"));
})(L || (L = {}));
var Mi = (function () {
  function e(t) {
    (te.validateTSDocTagName(t.tagName),
      (this.tagName = t.tagName),
      (this.tagNameWithUpperCase = t.tagName.toUpperCase()),
      (this.syntaxKind = t.syntaxKind),
      (this.standardization = t.standardization || G.None),
      (this.allowMultiple = !!t.allowMultiple));
  }
  return (
    (e.validateTSDocTagName = function (t) {
      te.validateTSDocTagName(t);
    }),
    e
  );
})();
var z = (function () {
  function e() {}
  return (
    (e._defineTag = function (t) {
      return new Mi(t);
    }),
    (e.alpha = e._defineTag({
      tagName: "@alpha",
      syntaxKind: L.ModifierTag,
      standardization: G.Discretionary,
    })),
    (e.beta = e._defineTag({
      tagName: "@beta",
      syntaxKind: L.ModifierTag,
    ...
    (e.decorator = e._defineTag({
      tagName: "@decorator",
      syntaxKind: L.BlockTag,
      allowMultiple: !0,
      standardization: G.Extended,
    })),
    (e.defaultValue = e._defineTag({
      tagName: "@defaultValue",
      syntaxKind: L.BlockTag,
      standardization: G.Extended,
    })),
    (e.deprecated = e._defineTag({
      tagName: "@deprecated",
      syntaxKind: L.BlockTag,
      standardization: G.Core,
    })),
    (e.eventProperty = e._defineTag({
      tagName: "@eventProperty",
      syntaxKind: L.ModifierTag,
      standardization: G.Extended,
    })),
    (e.example = e._defineTag({
      tagName: "@example",
      syntaxKind: L.BlockTag,
      allowMultiple: !0,
      standardization: G.Extended,
    })),
    (e.experimental = e._defineTag({
      tagName: "@experimental",
      syntaxKind: L.ModifierTag,
      standardization: G.Discretionary,
    })),
    (e.inheritDoc = e._defineTag({
      tagName: "@inheritDoc",
      syntaxKind: L.InlineTag,
      standardization: G.Extended,
    })),
    (e.internal = e._defineTag({
      tagName: "@internal",
      syntaxKind: L.ModifierTag,
      standardization: G.Discretionary,
    })),
    (e.label = e._defineTag({
      tagName: "@label",
      syntaxKind: L.InlineTag,
      standardization: G.Core,
    })),
    ...
    (e.override = e._defineTag({
      tagName: "@override",
      syntaxKind: L.ModifierTag,
      standardization: G.Extended,
    })),
    (e.packageDocumentation = e._defineTag({
      tagName: "@packageDocumentation",
      syntaxKind: L.ModifierTag,
      standardization: G.Core,
    })),
    (e.param = e._defineTag({
      tagName: "@param",
      syntaxKind: L.BlockTag,
      allowMultiple: !0,
      standardization: G.Core,
    })),
    (e.privateRemarks = e._defineTag({
      tagName: "@privateRemarks",
      syntaxKind: L.BlockTag,
      standardization: G.Core,
    })),
    (e.public = e._defineTag({
      tagName: "@public",
      syntaxKind: L.ModifierTag,
      standardization: G.Discretionary,
    })),
    (e.readonly = e._defineTag({
      tagName: "@readonly",
      syntaxKind: L.ModifierTag,
      standardization: G.Extended,
    })),
    (e.remarks = e._defineTag({
      tagName: "@remarks",
      syntaxKind: L.BlockTag,
      standardization: G.Core,
    })),
    (e.returns = e._defineTag({
      tagName: "@returns",
      syntaxKind: L.BlockTag,
      standardization: G.Core,
    })),
    (e.sealed = e._defineTag({
      tagName: "@sealed",
      syntaxKind: L.ModifierTag,
      standardization: G.Extended,
    })),
    ...
    (e.throws = e._defineTag({
      tagName: "@throws",
      syntaxKind: L.BlockTag,
      allowMultiple: !0,
      standardization: G.Extended,
    })),
    (e.typeParam = e._defineTag({
      tagName: "@typeParam",
      syntaxKind: L.BlockTag,
      allowMultiple: !0,
      standardization: G.Core,
    })),
    (e.virtual = e._defineTag({
      tagName: "@virtual",
      syntaxKind: L.ModifierTag,
      standardization: G.Extended,
    })),
...
(function (e) {
  ((e.Block = "Block"),
    (e.BlockTag = "BlockTag"),
    (e.Excerpt = "Excerpt"),
    (e.FencedCode = "FencedCode"),
    (e.CodeSpan = "CodeSpan"),
    (e.Comment = "Comment"),
    (e.DeclarationReference = "DeclarationReference"),
    (e.ErrorText = "ErrorText"),
    (e.EscapedText = "EscapedText"),
    (e.HtmlAttribute = "HtmlAttribute"),
    (e.HtmlEndTag = "HtmlEndTag"),
    (e.HtmlStartTag = "HtmlStartTag"),
    (e.InheritDocTag = "InheritDocTag"),
    (e.InlineTag = "InlineTag"),
    (e.LinkTag = "LinkTag"),
    (e.MemberIdentifier = "MemberIdentifier"),
    (e.MemberReference = "MemberReference"),
    (e.MemberSelector = "MemberSelector"),
    (e.MemberSymbol = "MemberSymbol"),
    (e.Paragraph = "Paragraph"),
    (e.ParamBlock = "ParamBlock"),
    (e.ParamCollection = "ParamCollection"),
    (e.PlainText = "PlainText"),
    (e.Section = "Section"),
    (e.SoftBreak = "SoftBreak"));
})(g || (g = {}));
var j = (function () {
  function e(t) {
  ...
  return (
    (e.prototype.getChildNodes = function () {
      return (
        ...
        this.onGetChildNodes().filter(function (t) {
          return t !== void 0;
        })
      );
    }),
    ...
    (e.isParsedParameters = function (t) {
      return t.parsed === !0;
    }),
    e
  );
...
var _a = (function () {
  ...
  return (
    (e.register = function (t) {
      var r = t.docNodeManager;
      (r.registerDocNodes("@microsoft/tsdoc", [
        { docNodeKind: g.Block, constructor: Rt },
        { docNodeKind: g.BlockTag, constructor: Nr },
        { docNodeKind: g.CodeSpan, constructor: Dr },
        { docNodeKind: g.Comment, constructor: Mr },
        { docNodeKind: g.DeclarationReference, constructor: Fr },
        { docNodeKind: g.ErrorText, constructor: bt },
        { docNodeKind: g.EscapedText, constructor: Br },
        { docNodeKind: g.Excerpt, constructor: b },
        { docNodeKind: g.FencedCode, constructor: Or },
        { docNodeKind: g.HtmlAttribute, constructor: qr },
        { docNodeKind: g.HtmlEndTag, constructor: Lr },
        { docNodeKind: g.HtmlStartTag, constructor: Rr },
        { docNodeKind: g.InheritDocTag, constructor: cr },
        { docNodeKind: g.InlineTag, constructor: Vt },
        { docNodeKind: g.LinkTag, constructor: Vr },
        { docNodeKind: g.MemberIdentifier, constructor: ur },
        { docNodeKind: g.MemberReference, constructor: Hr },
        { docNodeKind: g.MemberSelector, constructor: Kr },
        { docNodeKind: g.MemberSymbol, constructor: Ur },
        { docNodeKind: g.Paragraph, constructor: We },
        { docNodeKind: g.ParamBlock, constructor: lr },
        { docNodeKind: g.ParamCollection, constructor: or },
        { docNodeKind: g.PlainText, constructor: Me },
        { docNodeKind: g.Section, constructor: ct },
        { docNodeKind: g.SoftBreak, constructor: $r },
      ]),
        r.registerAllowableChildren(g.Section, [
          g.FencedCode,
          g.Paragraph,
          g.HtmlStartTag,
          g.HtmlEndTag,
        ]),
        r.registerAllowableChildren(g.Paragraph, [
          g.BlockTag,
          g.CodeSpan,
          g.ErrorText,
          g.EscapedText,
...
var w;
(function (e) {
  ((e.ConfigFileNotFound = "tsdoc-config-file-not-found"),
    (e.ConfigInvalidJson = "tsdoc-config-invalid-json"),
    (e.ConfigFileUnsupportedSchema = "tsdoc-config-unsupported-schema"),
    (e.ConfigFileSchemaError = "tsdoc-config-schema-error"),
    (e.ConfigFileCyclicExtends = "tsdoc-config-cyclic-extends"),
    (e.ConfigFileUnresolvedExtends = "tsdoc-config-unresolved-extends"),
    (e.ConfigFileUndefinedTag = "tsdoc-config-undefined-tag"),
    (e.ConfigFileDuplicateTagName = "tsdoc-config-duplicate-tag-name"),
    (e.ConfigFileInvalidTagName = "tsdoc-config-invalid-tag-name"),
    (e.CommentNotFound = "tsdoc-comment-not-found"),
    (e.CommentOpeningDelimiterSyntax =
      "tsdoc-comment-missing-opening-delimiter"),
    (e.CommentMissingClosingDelimiter =
      "tsdoc-comment-missing-closing-delimiter"),
    (e.ExtraInheritDocTag = "tsdoc-extra-inheritdoc-tag"),
    (e.EscapeRightBrace = "tsdoc-escape-right-brace"),
    (e.EscapeGreaterThan = "tsdoc-escape-greater-than"),
    (e.MissingDeprecationMessage = "tsdoc-missing-deprecation-message"),
    (e.InheritDocIncompatibleTag = "tsdoc-inheritdoc-incompatible-tag"),
    (e.InheritDocIncompatibleSummary = "tsdoc-inheritdoc-incompatible-summary"),
    (e.InlineTagMissingBraces = "tsdoc-inline-tag-missing-braces"),
    (e.TagShouldNotHaveBraces = "tsdoc-tag-should-not-have-braces"),
    (e.UnsupportedTag = "tsdoc-unsupported-tag"),
    (e.UndefinedTag = "tsdoc-undefined-tag"),
    (e.ParamTagWithInvalidType = "tsdoc-param-tag-with-invalid-type"),
    (e.ParamTagWithInvalidOptionalName =
      "tsdoc-param-tag-with-invalid-optional-name"),
    (e.ParamTagWithInvalidName = "tsdoc-param-tag-with-invalid-name"),
    (e.ParamTagMissingHyphen = "tsdoc-param-tag-missing-hyphen"),
    (e.UnnecessaryBackslash = "tsdoc-unnecessary-backslash"),
    (e.MissingTag = "tsdoc-missing-tag"),
    (e.AtSignInWord = "tsdoc-at-sign-in-word"),
    (e.AtSignWithoutTagName = "tsdoc-at-sign-without-tag-name"),
    (e.MalformedInlineTag = "tsdoc-malformed-inline-tag"),
    (e.CharactersAfterBlockTag = "tsdoc-characters-after-block-tag"),
    (e.MalformedTagName = "tsdoc-malformed-tag-name"),
    (e.CharactersAfterInlineTag = "tsdoc-characters-after-inline-tag"),
    (e.InlineTagMissingRightBrace = "tsdoc-inline-tag-missing-right-brace"),
    (e.InlineTagUnescapedBrace = "tsdoc-inline-tag-unescaped-brace"),
    (e.InheritDocTagSyntax = "tsdoc-inheritdoc-tag-syntax"),
    (e.LinkTagEmpty = "tsdoc-link-tag-empty"),
    (e.LinkTagUnescapedText = "tsdoc-link-tag-unescaped-text"),
    (e.LinkTagDestinationSyntax = "tsdoc-link-tag-destination-syntax"),
    (e.LinkTagInvalidUrl = "tsdoc-link-tag-invalid-url"),
    (e.ReferenceMissingHash = "tsdoc-reference-missing-hash"),
    (e.ReferenceHashSyntax = "tsdoc-reference-hash-syntax"),
    (e.ReferenceMalformedPackageName =
      "tsdoc-reference-malformed-package-name"),
    (e.ReferenceMalformedImportPath = "tsdoc-reference-malformed-import-path"),
    (e.MissingReference = "tsdoc-missing-reference"),
    (e.ReferenceMissingDot = "tsdoc-reference-missing-dot"),
    (e.ReferenceSelectorMissingParens =
      "tsdoc-reference-selector-missing-parens"),
    (e.ReferenceMissingColon = "tsdoc-reference-missing-colon"),
    (e.ReferenceMissingRightParen = "tsdoc-reference-missing-right-paren"),
    (e.ReferenceSymbolSyntax = "tsdoc-reference-symbol-syntax"),
    (e.ReferenceMissingRightBracket = "tsdoc-reference-missing-right-bracket"),
    (e.ReferenceMissingQuote = "tsdoc-reference-missing-quote"),
    (e.ReferenceEmptyIdentifier = "tsdoc-reference-empty-identifier"),
    (e.ReferenceMissingIdentifier = "tsdoc-reference-missing-identifier"),
    (e.ReferenceUnquotedIdentifier = "tsdoc-reference-unquoted-identifier"),
    (e.ReferenceMissingLabel = "tsdoc-reference-missing-label"),
    (e.ReferenceSelectorSyntax = "tsdoc-reference-selector-syntax"),
    (e.HtmlTagMissingGreaterThan = "tsdoc-html-tag-missing-greater-than"),
    (e.HtmlTagMissingEquals = "tsdoc-html-tag-missing-equals"),
    (e.HtmlTagMissingString = "tsdoc-html-tag-missing-string"),
    (e.HtmlStringMissingQuote = "tsdoc-html-string-missing-quote"),
    (e.TextAfterHtmlString = "tsdoc-text-after-html-string"),
    (e.MissingHtmlEndTag = "tsdoc-missing-html-end-tag"),
    (e.MalformedHtmlName = "tsdoc-malformed-html-name"),
    (e.UnsupportedHtmlElementName = "tsdoc-unsupported-html-name"),
    (e.CodeFenceOpeningIndent = "tsdoc-code-fence-opening-indent"),
    (e.CodeFenceSpecifierSyntax = "tsdoc-code-fence-specifier-syntax"),
    (e.CodeFenceClosingIndent = "tsdoc-code-fence-closing-indent"),
    (e.CodeFenceMissingDelimiter = "tsdoc-code-fence-missing-delimiter"),
    (e.CodeFenceClosingSyntax = "tsdoc-code-fence-closing-syntax"),
    (e.CodeSpanEmpty = "tsdoc-code-span-empty"),
    (e.CodeSpanMissingDelimiter = "tsdoc-code-span-missing-delimiter"));
})(w || (w = {}));
var Gr = [
...
var Bi = (function () {
  function e() {
    ((this._tagDefinitions = []),
      ...
      (this._validation = new Fi()),
      (this._docNodeManager = new Di()),
  ...
  return (
    (e.prototype.clear = function (t) {
      (t === void 0 && (t = !1),
        ...
        t || this.addTagDefinitions(z.allDefinitions));
    }),
    Object.defineProperty(e.prototype, "tagDefinitions", {
      get: function () {
    ...
    Object.defineProperty(e.prototype, "supportedTagDefinitions", {
      get: function () {
        var t = this;
        return this.tagDefinitions.filter(function (r) {
          return t.isTagSupported(r);
        });
      },
      enumerable: !1,
      configurable: !0,
    }),
    Object.defineProperty(e.prototype, "validation", {
      get: function () {
    ...
    Object.defineProperty(e.prototype, "supportedHtmlElements", {
      get: function () {
    ...
    Object.defineProperty(e.prototype, "docNodeManager", {
      get: function () {
    ...
    (e.prototype.tryGetTagDefinition = function (t) {
      return this._tagDefinitionsByName.get(t.toUpperCase());
    }),
    (e.prototype.tryGetTagDefinitionWithUpperCase = function (t) {
      return this._tagDefinitionsByName.get(t);
    }),
    (e.prototype.addTagDefinition = function (t) {
      var r = this._tagDefinitionsByName.get(t.tagNameWithUpperCase);
      if (r !== t) {
        if (r)
          throw new Error(
            "A tag is already defined using the name ".concat(r.tagName),
          );
        (this._tagDefinitions.push(t),
          this._tagDefinitionsByName.set(t.tagNameWithUpperCase, t));
      }
    }),
    (e.prototype.addTagDefinitions = function (t, r) {
      for (var i = 0, n = t; i < n.length; i++) {
        var a = n[i];
        (this.addTagDefinition(a), r !== void 0 && this.setSupportForTag(a, r));
      }
    }),
    (e.prototype.isTagSupported = function (t) {
      return (
        this._requireTagToBeDefined(t),
        this._supportedTagDefinitions.has(t)
      );
    }),
    (e.prototype.setSupportForTag = function (t, r) {
      (this._requireTagToBeDefined(t),
        r
          ? this._supportedTagDefinitions.add(t)
          : this._supportedTagDefinitions.delete(t),
        (this.validation.reportUnsupportedTags = !0));
    }),
    (e.prototype.setSupportForTags = function (t, r) {
      for (var i = 0, n = t; i < n.length; i++) {
        var a = n[i];
        this.setSupportForTag(a, r);
      }
    }),
    (e.prototype.setSupportedHtmlElements = function (t) {
      (this._supportedHtmlElements.clear(),
        (this._validation.reportUnsupportedHtmlElements = !0));
      for (var r = 0, i = t; r < i.length; r++) {
        var n = i[r];
        this._supportedHtmlElements.add(n);
      }
    }),
    (e.prototype.isHtmlElementSupported = function (t) {
      return this._supportedHtmlElements.has(t);
    }),
    (e.prototype.isKnownMessageId = function (t) {
      return xa.has(t);
    }),
    Object.defineProperty(e.prototype, "allTsdocMessageIds", {
      get: function () {
        return Gr;
      },
      enumerable: !1,
    ...
    (e.prototype._requireTagToBeDefined = function (t) {
      var r = this._tagDefinitionsByName.get(t.tagNameWithUpperCase);
      if (!(r && r === t))
        throw new Error(
...
var Oi = (function () {
  ...
  return (
    ...
    (e.prototype.hasTagName = function (t) {
      return this._nodesByName.has(t.toUpperCase());
    }),
    (e.prototype.hasTag = function (t) {
      return !!this.tryGetTag(t);
    }),
    (e.prototype.tryGetTag = function (t) {
      if (t.syntaxKind !== L.ModifierTag)
        throw new Error("The tag definition is not a modifier tag");
      return this._nodesByName.get(t.tagNameWithUpperCase);
    }),
    (e.prototype.addTag = function (t) {
      return this._nodesByName.has(t.tagNameWithUpperCase)
        ? !1
        : (this._nodesByName.set(t.tagNameWithUpperCase, t),
          this._nodes.push(t),
          !0);
    }),
    e
...
var So = (function () {
  ...
  qi = (function (e) {
    ...
    return (
      (t.prototype.isAlpha = function () {
        return this.hasTag(z.alpha);
      }),
      (t.prototype.isBeta = function () {
        return this.hasTag(z.beta);
      }),
      (t.prototype.isEventProperty = function () {
        return this.hasTag(z.eventProperty);
      }),
      (t.prototype.isExperimental = function () {
        return this.hasTag(z.experimental);
      }),
      (t.prototype.isInternal = function () {
        return this.hasTag(z.internal);
      }),
      (t.prototype.isOverride = function () {
        return this.hasTag(z.override);
      }),
      (t.prototype.isPackageDocumentation = function () {
        return this.hasTag(z.packageDocumentation);
      }),
      (t.prototype.isPublic = function () {
        return this.hasTag(z.public);
      }),
      (t.prototype.isReadonly = function () {
        return this.hasTag(z.readonly);
      }),
      (t.prototype.isSealed = function () {
        return this.hasTag(z.sealed);
      }),
      (t.prototype.isVirtual = function () {
        return this.hasTag(z.virtual);
      }),
      t
    );
  })(Oi);
var Co = (function () {
  ...
  Yr = (function (e) {
    ...
    function t(r, i) {
      ...
      return (
        (n._nodes = []),
        i !== void 0 && i.length > 0 && n.appendNodes(i),
        n
      );
    }
    return (
      ...
      (t.prototype.appendNode = function (r) {
        if (
          !this.configuration.docNodeManager.isAllowedChild(this.kind, r.kind)
        )
          throw new Error(
            "The TSDocConfiguration does not allow a ".concat(
              this.kind,
              " node to",
            ) + " contain a node of type ".concat(r.kind),
          );
        this._nodes.push(r);
      }),
      (t.prototype.appendNodes = function (r) {
      ...
      (t.prototype.onGetChildNodes = function () {
        return this._nodes;
      }),
      t
    );
...
var Io = (function () {
  ...
  ct = (function (e) {
    ...
    return (
      ...
      (t.prototype.appendNodeInParagraph = function (r) {
        var i = void 0;
        if (this.nodes.length > 0) {
          var n = this.nodes[this.nodes.length - 1];
          n.kind === g.Paragraph && (i = n);
        }
        (i ||
          ((i = new We({ configuration: this.configuration })),
          this.appendNode(i)),
          i.appendNode(r));
      }),
      (t.prototype.appendNodesInParagraph = function (r) {
        for (var i = 0, n = r; i < n.length; i++) {
          var a = n[i];
          this.appendNodeInParagraph(a);
        }
      }),
      t
    );
...
var No = (function () {
  ...
  Rt = (function (e) {
    ...
    function t(r) {
      ...
      return (
        (i._blockTag = r.blockTag),
        (i._content = new ct({ configuration: i.configuration })),
        i
      );
    }
    return (
      ...
      Object.defineProperty(t.prototype, "blockTag", {
        get: function () {
...
var f;
(function (e) {
  ((e[(e.EndOfInput = 2001)] = "EndOfInput"),
    (e[(e.Newline = 2002)] = "Newline"),
    (e[(e.Spacing = 2003)] = "Spacing"),
    (e[(e.AsciiWord = 2004)] = "AsciiWord"),
    (e[(e.OtherPunctuation = 2005)] = "OtherPunctuation"),
    (e[(e.Other = 2006)] = "Other"),
    (e[(e.Backslash = 2007)] = "Backslash"),
    (e[(e.LessThan = 2008)] = "LessThan"),
    (e[(e.GreaterThan = 2009)] = "GreaterThan"),
    (e[(e.Equals = 2010)] = "Equals"),
    (e[(e.SingleQuote = 2011)] = "SingleQuote"),
    (e[(e.DoubleQuote = 2012)] = "DoubleQuote"),
    (e[(e.Slash = 2013)] = "Slash"),
    (e[(e.Hyphen = 2014)] = "Hyphen"),
    (e[(e.AtSign = 2015)] = "AtSign"),
    (e[(e.LeftCurlyBracket = 2016)] = "LeftCurlyBracket"),
    (e[(e.RightCurlyBracket = 2017)] = "RightCurlyBracket"),
    (e[(e.Backtick = 2018)] = "Backtick"),
    (e[(e.Period = 2019)] = "Period"),
    (e[(e.Colon = 2020)] = "Colon"),
    (e[(e.Comma = 2021)] = "Comma"),
    (e[(e.LeftSquareBracket = 2022)] = "LeftSquareBracket"),
    (e[(e.RightSquareBracket = 2023)] = "RightSquareBracket"),
    (e[(e.Pipe = 2024)] = "Pipe"),
    (e[(e.LeftParenthesis = 2025)] = "LeftParenthesis"),
    (e[(e.RightParenthesis = 2026)] = "RightParenthesis"),
    (e[(e.PoundSymbol = 2027)] = "PoundSymbol"),
    (e[(e.Plus = 2028)] = "Plus"),
    (e[(e.DollarSign = 2029)] = "DollarSign"));
})(f || (f = {}));
var wt = (function () {
  function e(t, r, i) {
    ((this.kind = t), (this.range = r), (this.line = i));
  }
  return (
    (e.prototype.toString = function () {
      return this.kind === f.Newline
        ? `
`
        : this.range.toString();
    }),
...
(function (e) {
  ((e.Spacing = "Spacing"),
    (e.BlockTag = "BlockTag"),
    (e.CodeSpan_OpeningDelimiter = "CodeSpan_OpeningDelimiter"),
    (e.CodeSpan_Code = "CodeSpan_Code"),
    (e.CodeSpan_ClosingDelimiter = "CodeSpan_ClosingDelimiter"),
    (e.DeclarationReference_PackageName = "DeclarationReference_PackageName"),
    (e.DeclarationReference_ImportPath = "DeclarationReference_ImportPath"),
    (e.DeclarationReference_ImportHash = "DeclarationReference_ImportHash"),
    (e.ErrorText = "ErrorText"),
    (e.NonstandardText = "NonstandardText"),
    (e.EscapedText = "EscapedText"),
    (e.FencedCode_OpeningFence = "FencedCode_OpeningFence"),
    (e.FencedCode_Language = "FencedCode_Language"),
    (e.FencedCode_Code = "FencedCode_Code"),
    (e.FencedCode_ClosingFence = "FencedCode_ClosingFence"),
    (e.HtmlAttribute_Name = "HtmlAttribute_Name"),
    (e.HtmlAttribute_Equals = "HtmlAttribute_Equals"),
    (e.HtmlAttribute_Value = "HtmlAttribute_Value"),
    (e.HtmlEndTag_OpeningDelimiter = "HtmlEndTag_OpeningDelimiter"),
    (e.HtmlEndTag_Name = "HtmlEndTag_Name"),
    (e.HtmlEndTag_ClosingDelimiter = "HtmlEndTag_ClosingDelimiter"),
    (e.HtmlStartTag_OpeningDelimiter = "HtmlStartTag_OpeningDelimiter"),
    (e.HtmlStartTag_Name = "HtmlStartTag_Name"),
    (e.HtmlStartTag_ClosingDelimiter = "HtmlStartTag_ClosingDelimiter"),
    (e.InlineTag_OpeningDelimiter = "InlineTag_OpeningDelimiter"),
    (e.InlineTag_TagName = "InlineTag_TagName"),
    (e.InlineTag_TagContent = "InlineTag_TagContent"),
    (e.InlineTag_ClosingDelimiter = "InlineTag_ClosingDelimiter"),
    (e.LinkTag_UrlDestination = "LinkTag_UrlDestination"),
    (e.LinkTag_Pipe = "LinkTag_Pipe"),
    (e.LinkTag_LinkText = "LinkTag_LinkText"),
    (e.MemberIdentifier_LeftQuote = "MemberIdentifier_LeftQuote"),
    (e.MemberIdentifier_Identifier = "MemberIdentifier_Identifier"),
    (e.MemberIdentifier_RightQuote = "MemberIdentifier_RightQuote"),
    (e.MemberReference_Dot = "MemberReference_Dot"),
    (e.MemberReference_LeftParenthesis = "MemberReference_LeftParenthesis"),
    (e.MemberReference_Colon = "MemberReference_Colon"),
    (e.MemberReference_RightParenthesis = "MemberReference_RightParenthesis"),
    (e.MemberSelector = "MemberSelector"),
    (e.DocMemberSymbol_LeftBracket = "DocMemberSymbol_LeftBracket"),
    (e.DocMemberSymbol_RightBracket = "DocMemberSymbol_RightBracket"),
    (e.ParamBlock_ParameterName = "ParamBlock_ParameterName"),
    (e.ParamBlock_Hyphen = "ParamBlock_Hyphen"),
    (e.PlainText = "PlainText"),
    (e.SoftBreak = "SoftBreak"));
})(v || (v = {}));
var b = (function (e) {
  ...
  function t(r) {
    var i = e.call(this, r) || this;
    if (r.excerptKind === v.Spacing)
      for (var n = 0, a = r.content.tokens; n < a.length; n++) {
        var s = a[n];
        switch (s.kind) {
          case f.Spacing:
          case f.Newline:
    ...
    return ((i._excerptKind = r.excerptKind), (i._content = r.content), i);
  }
  return (
    Object.defineProperty(t.prototype, "kind", {
      get: function () {
    ...
    Object.defineProperty(t.prototype, "excerptKind", {
      get: function () {
...
var Mo = (function () {
  ...
  Nr = (function (e) {
    ...
    function t(r) {
      var i = e.call(this, r) || this;
      return (
        te.validateTSDocTagName(r.tagName),
        (i._tagName = r.tagName),
        (i._tagNameWithUpperCase = r.tagName.toUpperCase()),
        j.isParsedParameters(r) &&
          (i._tagNameExcerpt = new b({
            configuration: i.configuration,
            excerptKind: v.BlockTag,
            content: r.tagNameExcerpt,
          })),
        i
      );
    }
    return (
      ...
      Object.defineProperty(t.prototype, "tagNameWithUpperCase", {
        get: function () {
      ...
      (t.prototype.getTokenSequence = function () {
...
var Fo = (function () {
  ...
  Dr = (function (e) {
    ...
    function t(r) {
      ...
      return (
        j.isParsedParameters(r)
          ? ((i._openingDelimiterExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.CodeSpan_OpeningDelimiter,
              content: r.openingDelimiterExcerpt,
            })),
            (i._codeExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.CodeSpan_Code,
              content: r.codeExcerpt,
            })),
            (i._closingDelimiterExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.CodeSpan_ClosingDelimiter,
              content: r.closingDelimiterExcerpt,
            })))
          : (i._code = r.code),
        i
      );
  ...
  return (
    ...
    (e.prototype.toString = function () {
      ...
      if (this._chunks.length > 1) {
        var t = this._chunks.join("");
        ((this._chunks.length = 1), (this._chunks[0] = t));
      }
...
var ya = (function () {
  ...
  return (
    (e.transform = function (t) {
      for (
        var r = [], i = !1, n = [], a = [], s = !1, c = 0, l = t.nodes;
        c < l.length;
        c++
      ) {
        var h = l[c];
        switch (h.kind) {
          case g.PlainText:
            var m = h,
              ...
              k = /^\s/.test(_),
              F = /\s$/.test(_),
              O = _.replace(/\s+/g, " ").trim();
            (k && s && (i = !0),
              O.length > 0 &&
                (i && (n.push(" "), (i = !1)), n.push(O), a.push(h), (s = !0)),
              F && s && (i = !0));
            break;
          case g.SoftBreak:
            (s && (i = !0), a.push(h));
          ...
          default:
            (i && (n.push(" "), (i = !1)),
              n.length > 0 &&
                (r.push(
                  new Me({ configuration: t.configuration, text: n.join("") }),
                ),
                (n.length = 0),
                (a.length = 0)),
              r.push(h),
      ...
      n.length > 0 &&
        (r.push(new Me({ configuration: t.configuration, text: n.join("") })),
        (n.length = 0),
        (a.length = 0));
      var U = new We({ configuration: t.configuration });
      return (U.appendNodes(r), U);
    }),
    e
  );
})();
var Li = (function () {
  function e() {}
  return (
    (e.trimSpacesInParagraph = function (t) {
      return ya.transform(t);
    }),
    e
  );
})();
...
(function (e) {
  ((e[(e.Closed = 0)] = "Closed"),
    (e[(e.StartOfLine = 1)] = "StartOfLine"),
    (e[(e.MiddleOfLine = 2)] = "MiddleOfLine"));
})(ce || (ce = {}));
var Qe = (function () {
  function e() {
    ((this.eol = `
`),
      ...
      (this._lineState = ce.Closed),
      (this._previousLineHadContent = !1),
      (this._hangingParagraph = !1));
  }
  return (
    (e.prototype.renderComment = function (t, r) {
      ((this._emitCommentFraming = !0), this._renderCompleteObject(t, r));
    }),
    (e.prototype.renderHtmlTag = function (t, r) {
      ((this._emitCommentFraming = !1), this._renderCompleteObject(t, r));
    }),
    (e.prototype.renderDeclarationReference = function (t, r) {
      ((this._emitCommentFraming = !1), this._renderCompleteObject(t, r));
    }),
    (e.prototype._renderCompleteObject = function (t, r) {
      ((this._output = t),
        (this._lineState = ce.Closed),
        (this._previousLineHadContent = !1),
        (this._hangingParagraph = !1),
    ...
    (e.prototype._renderNode = function (t) {
      var r = this;
      if (t !== void 0)
        switch (t.kind) {
          case g.Block:
            ...
            (this._ensureLineSkipped(),
              this._renderNode(i.blockTag),
              i.blockTag.tagNameWithUpperCase ===
                z.returns.tagNameWithUpperCase &&
                (this._writeContent(" "), (this._hangingParagraph = !0)),
              this._renderNode(i.content));
            break;
          case g.BlockTag:
            var n = t;
            (this._lineState === ce.MiddleOfLine && this._writeContent(" "),
              this._writeContent(n.tagName));
            break;
          case g.CodeSpan:
            var a = t;
            (this._writeContent("`"),
              this._writeContent(a.code),
              this._writeContent("`"));
            break;
          case g.Comment:
            var s = t;
            (this._renderNodes(
              ...
              s.modifierTagSet.nodes.length > 0 &&
                (this._ensureLineSkipped(),
                this._renderNodes(s.modifierTagSet.nodes)));
            break;
          case g.DeclarationReference:
            var c = t;
            (this._writeContent(c.packageName),
              this._writeContent(c.importPath),
              (c.packageName !== void 0 || c.importPath !== void 0) &&
                this._writeContent("#"),
              this._renderNodes(c.memberReferences));
            break;
          case g.ErrorText:
            var l = t;
            this._writeContent(l.text);
            break;
          case g.EscapedText:
            var h = t;
            this._writeContent(h.encodedText);
            break;
          case g.FencedCode:
            var m = t;
          ...
          case g.HtmlEndTag:
            var k = t;
            (this._writeContent("</"),
              this._writeContent(k.name),
              this._writeContent(">"));
            break;
          case g.HtmlStartTag:
            var F = t;
            (this._writeContent("<"),
              this._writeContent(F.name),
              this._writeContent(F.spacingAfterName));
            for (
              var O =
                  F.spacingAfterName === void 0 ||
                  F.spacingAfterName.length === 0,
                U = 0,
                P = F.htmlAttributes;
              U < P.length;
              U++
              ...
              var Y = P[U];
              (O && this._writeContent(" "),
                this._renderNode(Y),
                (O =
                  Y.spacingAfterValue === void 0 ||
                  Y.spacingAfterValue.length === 0));
            }
            this._writeContent(F.selfClosingTag ? "/>" : ">");
            break;
          case g.InheritDocTag:
            var xe = t;
            this._renderInlineTag(xe, function () {
              xe.declarationReference &&
                (r._writeContent(" "), r._renderNode(xe.declarationReference));
            });
            break;
          case g.InlineTag:
            var ye = t;
            this._renderInlineTag(ye, function () {
              ye.tagContent.length > 0 &&
                (r._writeContent(" "), r._writeContent(ye.tagContent));
            });
            break;
          case g.LinkTag:
            var re = t;
            this._renderInlineTag(re, function () {
              ((re.urlDestination !== void 0 ||
                re.codeDestination !== void 0) &&
                (re.urlDestination !== void 0
                  ? (r._writeContent(" "), r._writeContent(re.urlDestination))
                  : re.codeDestination !== void 0 &&
                    (r._writeContent(" "), r._renderNode(re.codeDestination))),
                re.linkText !== void 0 &&
                  (r._writeContent(" "),
                  r._writeContent("|"),
                  r._writeContent(" "),
                  r._writeContent(re.linkText)));
            });
            break;
          case g.MemberIdentifier:
            ...
            _t.hasQuotes
              ? (this._writeContent('"'),
                this._writeContent(_t.identifier),
                this._writeContent('"'))
              : this._writeContent(_t.identifier);
            break;
          case g.MemberReference:
            var Ie = t;
            (Ie.hasDot && this._writeContent("."),
              Ie.selector && this._writeContent("("),
              Ie.memberSymbol
                ? this._renderNode(Ie.memberSymbol)
                : this._renderNode(Ie.memberIdentifier),
              Ie.selector &&
                (this._writeContent(":"),
                this._renderNode(Ie.selector),
                this._writeContent(")")));
            break;
          case g.MemberSelector:
            var wi = t;
            this._writeContent(wi.selector);
            break;
          case g.MemberSymbol:
            var wr = t;
            (this._writeContent("["),
              this._renderNode(wr.symbolReference),
              this._writeContent("]"));
            break;
          case g.Section:
            var ki = t;
            this._renderNodes(ki.nodes);
            break;
          case g.Paragraph:
            var tr = Li.trimSpacesInParagraph(t);
            tr.nodes.length > 0 &&
              (this._hangingParagraph
                ? (this._hangingParagraph = !1)
                : this._ensureLineSkipped(),
              this._renderNodes(tr.nodes),
              this._writeNewline());
            break;
          case g.ParamBlock:
            var x = t;
            (this._ensureLineSkipped(),
              this._renderNode(x.blockTag),
              this._writeContent(" "),
              this._writeContent(x.parameterName),
              this._writeContent(" - "),
              (this._hangingParagraph = !0),
              this._renderNode(x.content),
              (this._hangingParagraph = !1));
            break;
          case g.ParamCollection:
            var I = t;
            this._renderNodes(I.blocks);
            break;
          case g.PlainText:
            var d = t;
            this._writeContent(d.text);
            break;
        }
    }),
    (e.prototype._renderInlineTag = function (t, r) {
      (this._writeContent("{"),
        this._writeContent(t.tagName),
        r(),
        this._writeContent("}"));
    }),
    (e.prototype._renderNodes = function (t) {
      for (var r = 0, i = t; r < i.length; r++) {
        var n = i[r];
        this._renderNode(n);
      }
    }),
    (e.prototype._ensureAtStartOfLine = function () {
      this._lineState === ce.MiddleOfLine && this._writeNewline();
    }),
    (e.prototype._ensureLineSkipped = function () {
      (this._ensureAtStartOfLine(),
        this._previousLineHadContent && this._writeNewline());
    }),
    (e.prototype._writeContent = function (t) {
      if (!(t === void 0 || t.length === 0)) {
        var r = t.split(/\r?\n/g);
        if (r.length > 1) {
          for (var i = !0, n = 0, a = r; n < a.length; n++) {
            var s = a[n];
            (i ? (i = !1) : this._writeNewline(), this._writeContent(s));
          }
          return;
        }
        (this._lineState === ce.Closed &&
          ...
          (this._lineState = ce.StartOfLine)),
          this._lineState === ce.StartOfLine &&
            this._emitCommentFraming &&
            this._output.append(" "),
          this._output.append(t),
          (this._lineState = ce.MiddleOfLine),
          (this._previousLineHadContent = !0));
      }
    }),
    (e.prototype._writeNewline = function () {
      (this._lineState === ce.Closed &&
        (this._emitCommentFraming &&
          this._output.append("/**" + this.eol + " *"),
        (this._lineState = ce.StartOfLine)),
        (this._previousLineHadContent = this._lineState === ce.MiddleOfLine),
        this._emitCommentFraming
          ? this._output.append(this.eol + " *")
          : this._output.append(this.eol),
        (this._lineState = ce.StartOfLine),
    ...
    (e.prototype._writeEnd = function () {
      (this._lineState === ce.MiddleOfLine &&
        this._emitCommentFraming &&
        this._writeNewline(),
        this._lineState !== ce.Closed &&
    ...
    return (
      ...
      (t.prototype.add = function (r) {
        (this._blocks.push(r),
          ...
          this._blocksByName.has(r.parameterName) ||
            this._blocksByName.set(r.parameterName, r));
      }),
      (t.prototype.clear = function () {
        ((this._blocks.length = 0), (this._blocksByName = void 0));
      }),
      (t.prototype.tryGetBlockByName = function (r) {
        if (this._blocksByName) return this._blocksByName.get(r);
      }),
      (t.prototype.onGetChildNodes = function () {
        return this._blocks;
      }),
...
var Oo = (function () {
  ...
  Mr = (function (e) {
    ...
    function t(r) {
      var i = e.call(this, r) || this;
      return (
        (i.summarySection = new ct({ configuration: i.configuration })),
        (i.remarksBlock = void 0),
        (i.privateRemarks = void 0),
        (i.deprecatedBlock = void 0),
        (i.params = new or({ configuration: i.configuration })),
        (i.typeParams = new or({ configuration: i.configuration })),
        (i.returnsBlock = void 0),
        (i.modifierTagSet = new qi()),
        (i._seeBlocks = []),
        (i._customBlocks = []),
        i
      );
    ...
    return (
      ...
      Object.defineProperty(t.prototype, "seeBlocks", {
        get: function () {
      ...
      Object.defineProperty(t.prototype, "customBlocks", {
        get: function () {
      ...
      (t.prototype._appendSeeBlock = function (r) {
        this._seeBlocks.push(r);
      }),
      (t.prototype.appendCustomBlock = function (r) {
        this._customBlocks.push(r);
      }),
      (t.prototype.onGetChildNodes = function () {
        return zr(
          zr(
      ...
      (t.prototype.emitAsTsdoc = function () {
        var r = new Je(),
          i = new Qe();
        return (i.renderComment(r, this), r.toString());
      }),
      t
    );
  })(j);
var qo = (function () {
  ...
  Fr = (function (e) {
    ...
    function t(r) {
      ...
      return (
        j.isParsedParameters(r)
          ? (r.packageNameExcerpt &&
              (n._packageNameExcerpt = new b({
                configuration: n.configuration,
                excerptKind: v.DeclarationReference_PackageName,
                content: r.packageNameExcerpt,
              })),
            r.importPathExcerpt &&
              (n._importPathExcerpt = new b({
                configuration: n.configuration,
                excerptKind: v.DeclarationReference_ImportPath,
                content: r.importPathExcerpt,
              })),
            r.importHashExcerpt &&
              (n._importHashExcerpt = new b({
                configuration: n.configuration,
                excerptKind: v.DeclarationReference_ImportHash,
                content: r.importHashExcerpt,
              })),
            r.spacingAfterImportHashExcerpt &&
              (n._spacingAfterImportHashExcerpt = new b({
                configuration: n.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterImportHashExcerpt,
              })))
          : ((n._packageName = r.packageName), (n._importPath = r.importPath)),
        (n._memberReferences = []),
        r.memberReferences &&
          (i = n._memberReferences).push.apply(i, r.memberReferences),
        n
      );
    }
    return (
      ...
      Object.defineProperty(t.prototype, "importPath", {
        get: function () {
          return (
      ...
      Object.defineProperty(t.prototype, "memberReferences", {
        get: function () {
      ...
      (t.prototype.emitAsTsdoc = function () {
        var r = new Je(),
          i = new Qe();
        return (i.renderDeclarationReference(r, this), r.toString());
      }),
      (t.prototype.onGetChildNodes = function () {
        return Lo(
          [
...
var Ro = (function () {
  ...
  bt = (function (e) {
    ...
    function t(r) {
      var i = e.call(this, r) || this;
      return (
        (i._textExcerpt = new b({
          configuration: i.configuration,
          excerptKind: v.ErrorText,
          content: r.textExcerpt,
        })),
        (i._messageId = r.messageId),
        (i._errorMessage = r.errorMessage),
        (i._errorLocation = r.errorLocation),
        i
      );
    }
    return (
      ...
      Object.defineProperty(t.prototype, "textExcerpt", {
        get: function () {
...
var Vo = (function () {
  ...
  Wr;
(function (e) {
  e[(e.CommonMarkBackslash = 0)] = "CommonMarkBackslash";
})(Wr || (Wr = {}));
var Br = (function (e) {
  Vo(t, e);
  function t(r) {
    var i = e.call(this, r) || this;
    return (
      (i._escapeStyle = r.escapeStyle),
      (i._encodedTextExcerpt = new b({
        configuration: i.configuration,
        excerptKind: v.EscapedText,
        content: r.encodedTextExcerpt,
      })),
      (i._decodedText = r.decodedText),
      i
    );
  }
  return (
    ...
    Object.defineProperty(t.prototype, "escapeStyle", {
      get: function () {
    ...
    Object.defineProperty(t.prototype, "encodedText", {
      get: function () {
        return (
    ...
    Object.defineProperty(t.prototype, "decodedText", {
      get: function () {
...
var Ho = (function () {
  ...
  Or = (function (e) {
    ...
    function t(r) {
      ...
      return (
        j.isParsedParameters(r)
          ? ((i._openingFenceExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.FencedCode_OpeningFence,
              content: r.openingFenceExcerpt,
            })),
            r.spacingAfterOpeningFenceExcerpt &&
              (i._spacingAfterOpeningFenceExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterOpeningFenceExcerpt,
              })),
            r.languageExcerpt &&
              (i._languageExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.FencedCode_Language,
                content: r.languageExcerpt,
              })),
            r.spacingAfterLanguageExcerpt &&
              (i._spacingAfterLanguageExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterLanguageExcerpt,
              })),
            (i._codeExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.FencedCode_Code,
              content: r.codeExcerpt,
            })),
            r.spacingBeforeClosingFenceExcerpt &&
              (i._spacingBeforeClosingFenceExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingBeforeClosingFenceExcerpt,
              })),
            (i._closingFenceExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.FencedCode_ClosingFence,
              content: r.closingFenceExcerpt,
            })),
            r.spacingAfterClosingFenceExcerpt &&
              (i._spacingAfterClosingFenceExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterClosingFenceExcerpt,
              })))
          : ((i._code = r.code), (i._language = r.language)),
        i
      );
    }
    return (
...
var Ko = (function () {
  ...
  qr = (function (e) {
    ...
    function t(r) {
      ...
      return (
        j.isParsedParameters(r)
          ? ((i._nameExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.HtmlAttribute_Name,
              content: r.nameExcerpt,
            })),
            r.spacingAfterNameExcerpt &&
              (i._spacingAfterNameExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterNameExcerpt,
              })),
            (i._equalsExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.HtmlAttribute_Equals,
              content: r.equalsExcerpt,
            })),
            r.spacingAfterEqualsExcerpt &&
              (i._spacingAfterEqualsExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterEqualsExcerpt,
              })),
            (i._valueExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.HtmlAttribute_Value,
              content: r.valueExcerpt,
            })),
            r.spacingAfterValueExcerpt &&
              (i._spacingAfterValueExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterValueExcerpt,
              })))
          : ((i._name = r.name),
            (i._spacingAfterName = r.spacingAfterName),
            (i._spacingAfterEquals = r.spacingAfterEquals),
            (i._value = r.value),
            (i._spacingAfterValue = r.spacingAfterValue)),
        i
      );
    }
    return (
      ...
      Object.defineProperty(t.prototype, "spacingAfterName", {
        get: function () {
          return (
      ...
      Object.defineProperty(t.prototype, "spacingAfterEquals", {
        get: function () {
          return (
      ...
      Object.defineProperty(t.prototype, "spacingAfterValue", {
        get: function () {
          return (
...
var Uo = (function () {
  ...
  Lr = (function (e) {
    ...
    function t(r) {
      ...
      return (
        j.isParsedParameters(r)
          ? ((i._openingDelimiterExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.HtmlEndTag_OpeningDelimiter,
              content: r.openingDelimiterExcerpt,
            })),
            (i._nameExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.HtmlEndTag_Name,
              content: r.nameExcerpt,
            })),
            r.spacingAfterNameExcerpt &&
              (i._spacingAfterNameExcerpt = new b({
            ...
            (i._closingDelimiterExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.HtmlEndTag_ClosingDelimiter,
              content: r.closingDelimiterExcerpt,
            })))
          : (i._name = r.name),
        i
    ...
    return (
      ...
      (t.prototype.emitAsHtml = function () {
        var r = new Je(),
          i = new Qe();
        return (i.renderHtmlTag(r, this), r.toString());
      }),
      (t.prototype.onGetChildNodes = function () {
        return [
          this._openingDelimiterExcerpt,
...
var $o = (function () {
  ...
  Rr = (function (e) {
    ...
    function t(r) {
      ...
      return (
        j.isParsedParameters(r)
          ? ((n._openingDelimiterExcerpt = new b({
              configuration: n.configuration,
              excerptKind: v.HtmlStartTag_OpeningDelimiter,
              content: r.openingDelimiterExcerpt,
            })),
            (n._nameExcerpt = new b({
              configuration: n.configuration,
              excerptKind: v.HtmlStartTag_Name,
              content: r.nameExcerpt,
            })),
            r.spacingAfterNameExcerpt &&
              (n._spacingAfterNameExcerpt = new b({
                configuration: n.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterNameExcerpt,
              })),
            (n._closingDelimiterExcerpt = new b({
              configuration: n.configuration,
              excerptKind: v.HtmlStartTag_ClosingDelimiter,
              content: r.closingDelimiterExcerpt,
            })))
          : ((n._name = r.name), (n._spacingAfterName = r.spacingAfterName)),
        (n._htmlAttributes = []),
        r.htmlAttributes &&
          (i = n._htmlAttributes).push.apply(i, r.htmlAttributes),
        (n._selfClosingTag = !!r.selfClosingTag),
        n
      );
    }
    return (
      ...
      Object.defineProperty(t.prototype, "htmlAttributes", {
        get: function () {
      ...
      Object.defineProperty(t.prototype, "selfClosingTag", {
        get: function () {
    ...
    function t(r) {
      ...
      return (
        ...
        j.isParsedParameters(r) &&
          ((i._openingDelimiterExcerpt = new b({
            configuration: i.configuration,
            excerptKind: v.InlineTag_OpeningDelimiter,
            content: r.openingDelimiterExcerpt,
          })),
          (i._tagNameExcerpt = new b({
            configuration: i.configuration,
            excerptKind: v.InlineTag_TagName,
            content: r.tagNameExcerpt,
          })),
          r.spacingAfterTagNameExcerpt &&
            (i._spacingAfterTagNameExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.Spacing,
              content: r.spacingAfterTagNameExcerpt,
            })),
          (i._closingDelimiterExcerpt = new b({
            configuration: i.configuration,
            excerptKind: v.InlineTag_ClosingDelimiter,
            content: r.closingDelimiterExcerpt,
          }))),
        (i._tagName = r.tagName),
        (i._tagNameWithUpperCase = r.tagName.toUpperCase()),
...
var Yo = (function () {
  ...
  cr = (function (e) {
    ...
    function t(r) {
      var i = e.call(this, r) || this;
      if (i.tagNameWithUpperCase !== "@INHERITDOC")
        throw new Error(
          'DocInheritDocTag requires the tag name to be "{@inheritDoc}"',
        );
      return ((i._declarationReference = r.declarationReference), i);
    }
    return (
      Object.defineProperty(t.prototype, "kind", {
        get: function () {
      ...
      Object.defineProperty(t.prototype, "declarationReference", {
        get: function () {
      ...
      (t.prototype.getChildNodesForContent = function () {
        return [this._declarationReference];
      }),
      t
    );
  ...
  Vt = (function (e) {
    ...
    function t(r) {
      ...
      return (
        j.isParsedParameters(r)
          ? r.tagContentExcerpt &&
            (i._tagContentExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.InlineTag_TagContent,
              content: r.tagContentExcerpt,
            }))
          : (i._tagContent = r.tagContent),
        i
      );
    }
    return (
      ...
      Object.defineProperty(t.prototype, "tagContent", {
        get: function () {
...
var Wo = (function () {
  ...
  Vr = (function (e) {
    ...
    function t(r) {
      var i = e.call(this, r) || this;
      if (i.tagNameWithUpperCase !== "@LINK")
        throw new Error('DocLinkTag requires the tag name to be "{@link}"');
      if (((i._codeDestination = r.codeDestination), j.isParsedParameters(r))) {
        if (r.codeDestination !== void 0 && r.urlDestinationExcerpt !== void 0)
          throw new Error(
            "Either the codeDestination or the urlDestination may be specified, but not both",
          );
        (r.urlDestinationExcerpt &&
          (i._urlDestinationExcerpt = new b({
            configuration: i.configuration,
            excerptKind: v.LinkTag_UrlDestination,
            content: r.urlDestinationExcerpt,
          })),
          r.spacingAfterDestinationExcerpt &&
            (i._spacingAfterDestinationExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.Spacing,
              content: r.spacingAfterDestinationExcerpt,
            })),
          r.pipeExcerpt &&
            (i._pipeExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.LinkTag_Pipe,
              content: r.pipeExcerpt,
            })),
          r.spacingAfterPipeExcerpt &&
            (i._spacingAfterPipeExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.Spacing,
              content: r.spacingAfterPipeExcerpt,
            })),
          r.linkTextExcerpt &&
            (i._linkTextExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.LinkTag_LinkText,
              content: r.linkTextExcerpt,
            })),
          r.spacingAfterLinkTextExcerpt &&
            (i._spacingAfterLinkTextExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.Spacing,
              content: r.spacingAfterLinkTextExcerpt,
            })));
      } else {
        if (r.codeDestination !== void 0 && r.urlDestination !== void 0)
          throw new Error(
            "Either the codeDestination or the urlDestination may be specified, but not both",
          );
        ((i._urlDestination = r.urlDestination), (i._linkText = r.linkText));
      }
      return i;
    }
    return (
      ...
      Object.defineProperty(t.prototype, "codeDestination", {
        get: function () {
      ...
      Object.defineProperty(t.prototype, "urlDestination", {
        get: function () {
          return (
  ...
  ur = (function (e) {
    ...
    function t(r) {
      ...
      return (
        j.isParsedParameters(r)
          ? (r.leftQuoteExcerpt &&
              (i._leftQuoteExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.MemberIdentifier_LeftQuote,
                content: r.leftQuoteExcerpt,
              })),
            (i._identifierExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.MemberIdentifier_Identifier,
              content: r.identifierExcerpt,
            })),
            r.rightQuoteExcerpt &&
              (i._rightQuoteExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.MemberIdentifier_RightQuote,
                content: r.rightQuoteExcerpt,
              })))
          : (i._identifier = r.identifier),
        i
      );
    }
    return (
      (t.isValidIdentifier = function (r) {
        return !te.explainIfInvalidUnquotedMemberIdentifier(r);
      }),
      Object.defineProperty(t.prototype, "kind", {
        get: function () {
      ...
      Object.defineProperty(t.prototype, "hasQuotes", {
        get: function () {
          return this._identifierExcerpt
            ? !!this._leftQuoteExcerpt
            : !t.isValidIdentifier(this.identifier);
        },
        enumerable: !1,
        configurable: !0,
      }),
...
var Qo = (function () {
  ...
  Hr = (function (e) {
    ...
    function t(r) {
      ...
      return (
        j.isParsedParameters(r)
          ? ((i._hasDot = !!r.dotExcerpt),
            r.dotExcerpt &&
              (i._dotExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.MemberReference_Dot,
                content: r.dotExcerpt,
              })),
            r.spacingAfterDotExcerpt &&
              (i._spacingAfterDotExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterDotExcerpt,
              })),
            r.leftParenthesisExcerpt &&
              (i._leftParenthesisExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.MemberReference_LeftParenthesis,
                content: r.leftParenthesisExcerpt,
              })),
            r.spacingAfterLeftParenthesisExcerpt &&
              (i._spacingAfterLeftParenthesisExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterLeftParenthesisExcerpt,
              })),
            r.spacingAfterMemberExcerpt &&
              (i._spacingAfterMemberExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterMemberExcerpt,
              })),
            r.colonExcerpt &&
              (i._colonExcerpt = new b({
                excerptKind: v.MemberReference_Colon,
                configuration: i.configuration,
                content: r.colonExcerpt,
              })),
            r.spacingAfterColonExcerpt &&
              (i._spacingAfterColonExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterColonExcerpt,
              })),
            r.spacingAfterSelectorExcerpt &&
              (i._spacingAfterSelectorExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterSelectorExcerpt,
              })),
            r.rightParenthesisExcerpt &&
              (i._rightParenthesisExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.MemberReference_RightParenthesis,
                content: r.rightParenthesisExcerpt,
              })),
            r.spacingAfterRightParenthesisExcerpt &&
              (i._spacingAfterRightParenthesisExcerpt = new b({
                configuration: i.configuration,
                excerptKind: v.Spacing,
                content: r.spacingAfterRightParenthesisExcerpt,
              })))
          : (i._hasDot = r.hasDot),
        (i._memberIdentifier = r.memberIdentifier),
        (i._memberSymbol = r.memberSymbol),
        (i._selector = r.selector),
        i
      );
    }
    return (
      ...
      Object.defineProperty(t.prototype, "hasDot", {
        get: function () {
          return this._hasDot;
        },
        enumerable: !1,
      ...
      Object.defineProperty(t.prototype, "memberIdentifier", {
        get: function () {
      ...
      Object.defineProperty(t.prototype, "memberSymbol", {
        get: function () {
...
var Kr = (function (e) {
  ...
  function t(r) {
    ...
    return (
      j.isParsedParameters(r)
        ? ((i._selectorExcerpt = new b({
            configuration: i.configuration,
            excerptKind: v.MemberSelector,
            content: r.selectorExcerpt,
          })),
          (i._selector = r.selectorExcerpt.toString()))
        : (i._selector = r.selector),
      (i._selectorKind = Kt.Error),
      (i._errorMessage = void 0),
      i._selector.length === 0
        ? (i._errorMessage = "The selector cannot be an empty string")
        : t._likeIndexSelectorRegExp.test(i._selector)
          ? t._indexSelectorRegExp.test(i._selector)
            ? (i._selectorKind = Kt.Index)
            : (i._errorMessage =
                "If the selector begins with a number, it must be a positive integer value")
          : t._likeLabelSelectorRegExp.test(i._selector)
            ? t._labelSelectorRegExp.test(i._selector)
              ? (i._selectorKind = Kt.Label)
              : (i._errorMessage =
                  "A label selector must be comprised of upper case letters, numbers, and underscores and must not start with a number")
            : te.isSystemSelector(i._selector)
              ? (i._selectorKind = Kt.System)
              : t._likeSystemSelectorRegExp.test(i._selector)
                ? (i._errorMessage =
                    "The selector ".concat(JSON.stringify(i._selector)) +
                    " is not a recognized TSDoc system selector name")
                : (i._errorMessage = "Invalid syntax for selector"),
      i
    );
  }
  return (
    ...
    Object.defineProperty(t.prototype, "selectorKind", {
      get: function () {
    ...
    (t._likeIndexSelectorRegExp = /^[0-9]/),
    (t._indexSelectorRegExp = /^[1-9][0-9]*$/),
    (t._likeLabelSelectorRegExp = /^[A-Z_]/u),
    (t._labelSelectorRegExp = /^[A-Z_][A-Z0-9_]+$/),
    (t._likeSystemSelectorRegExp = /^[a-z]+$/u),
    t
  );
})(j);
var Zo = (function () {
  ...
  Ur = (function (e) {
    ...
    function t(r) {
      ...
      return (
        j.isParsedParameters(r) &&
          ((i._leftBracketExcerpt = new b({
            configuration: i.configuration,
            excerptKind: v.DocMemberSymbol_LeftBracket,
            content: r.leftBracketExcerpt,
          })),
          r.spacingAfterLeftBracketExcerpt &&
            (i._spacingAfterLeftBracketExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.Spacing,
              content: r.spacingAfterLeftBracketExcerpt,
            })),
          (i._rightBracketExcerpt = new b({
            configuration: i.configuration,
            excerptKind: v.DocMemberSymbol_RightBracket,
            content: r.rightBracketExcerpt,
          }))),
        (i._symbolReference = r.symbolReference),
        i
      );
    }
    return (
      ...
      Object.defineProperty(t.prototype, "symbolReference", {
        get: function () {
...
var ec = (function () {
  ...
  lr = (function (e) {
    ...
    function t(r) {
      var i = e.call(this, r) || this;
      return (
        (i._parameterName = r.parameterName),
        j.isParsedParameters(r) &&
          (r.spacingBeforeParameterNameExcerpt &&
            (i._spacingBeforeParameterNameExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.Spacing,
              content: r.spacingBeforeParameterNameExcerpt,
            })),
          r.unsupportedJsdocTypeBeforeParameterNameExcerpt &&
            (i._unsupportedJsdocTypeBeforeParameterNameExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.NonstandardText,
              content: r.unsupportedJsdocTypeBeforeParameterNameExcerpt,
            })),
          r.unsupportedJsdocOptionalNameOpenBracketExcerpt &&
            (i._unsupportedJsdocOptionalNameOpenBracketExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.NonstandardText,
              content: r.unsupportedJsdocOptionalNameOpenBracketExcerpt,
            })),
          (i._parameterNameExcerpt = new b({
            configuration: i.configuration,
            excerptKind: v.ParamBlock_ParameterName,
            content: r.parameterNameExcerpt,
          })),
          r.unsupportedJsdocOptionalNameRestExcerpt &&
            (i._unsupportedJsdocOptionalNameRestExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.NonstandardText,
              content: r.unsupportedJsdocOptionalNameRestExcerpt,
            })),
          r.spacingAfterParameterNameExcerpt &&
            (i._spacingAfterParameterNameExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.Spacing,
              content: r.spacingAfterParameterNameExcerpt,
            })),
          r.unsupportedJsdocTypeAfterParameterNameExcerpt &&
            (i._unsupportedJsdocTypeAfterParameterNameExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.NonstandardText,
              content: r.unsupportedJsdocTypeAfterParameterNameExcerpt,
            })),
          r.hyphenExcerpt &&
            (i._hyphenExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.ParamBlock_Hyphen,
              content: r.hyphenExcerpt,
            })),
          r.spacingAfterHyphenExcerpt &&
            (i._spacingAfterHyphenExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.Spacing,
              content: r.spacingAfterHyphenExcerpt,
            })),
          r.unsupportedJsdocTypeAfterHyphenExcerpt &&
            (i._unsupportedJsdocTypeAfterHyphenExcerpt = new b({
              configuration: i.configuration,
              excerptKind: v.NonstandardText,
              content: r.unsupportedJsdocTypeAfterHyphenExcerpt,
            }))),
        i
      );
    }
    return (
      ...
      Object.defineProperty(t.prototype, "parameterName", {
        get: function () {
...
var tc = (function () {
  ...
  Me = (function (e) {
    ...
    function t(r) {
      var i = e.call(this, r) || this;
      if (j.isParsedParameters(r))
        i._textExcerpt = new b({
          configuration: i.configuration,
          excerptKind: v.PlainText,
          content: r.textExcerpt,
        });
      else {
        if (t._newlineCharacterRegExp.test(r.text))
          throw new Error(
...
var rc = (function () {
  ...
  $r = (function (e) {
    ...
    function t(r) {
      ...
      if (j.isParsedParameters(r)) {
        var n = r;
        i._softBreakExcerpt = new b({
          configuration: i.configuration,
          excerptKind: v.SoftBreak,
          content: n.softBreakExcerpt,
        });
      }
      return i;
    }
...
var Jr = (function () {
  function e() {}
  return (
    (e.hasAnyTextContent = function (t, r) {
      (r === void 0 || r < 1) && (r = 1);
      var i;
      t instanceof j ? (i = [t]) : (i = t);
      var n = e._scanTextContent(i, r, 0);
      return n >= r;
    }),
    (e._scanTextContent = function (t, r, i) {
      for (var n = 0, a = t; n < a.length; n++) {
        var s = a[n];
        switch (s.kind) {
          case g.FencedCode:
            var c = s;
            i += e._countNonSpaceCharacters(c.code);
            break;
          case g.CodeSpan:
            var l = s;
            i += e._countNonSpaceCharacters(l.code);
            break;
          case g.EscapedText:
            var h = s;
            i += e._countNonSpaceCharacters(h.decodedText);
            break;
          case g.LinkTag:
            var m = s;
            i += e._countNonSpaceCharacters(m.linkText || "");
            break;
          case g.PlainText:
            var _ = s;
            i += e._countNonSpaceCharacters(_.text);
            break;
        }
        if (
          i >= r ||
          ((i += e._scanTextContent(s.getChildNodes(), r, i)), i >= r)
        )
          break;
      }
      return i;
    }),
    (e._countNonSpaceCharacters = function (t) {
      for (var r = 0, i = t.length, n = 0; n < i;) {
...
var Le = (function () {
  function e(t, r, i) {
    ((this.buffer = t), (this.pos = r), (this.end = i), this._validateBounds());
  }
  return (
    (e.fromString = function (t) {
      return new e(t, 0, t.length);
    }),
    (e.fromStringRange = function (t, r, i) {
      return new e(t, r, i);
    }),
    ...
    (e.prototype.getNewRange = function (t, r) {
      return new e(this.buffer, t, r);
    }),
    ...
    (e.prototype.getDebugDump = function (t, r) {
      return (
    ...
    (e.prototype.getLocation = function (t) {
      if (t < 0 || t > this.buffer.length) return { line: 0, column: 0 };
      for (var r = 1, i = 1, n = 0; n < t;) {
        var a = this.buffer[n];
        (++n,
          a !== "\r" &&
            (a ===
...
`
    ...
    (e.prototype._validateBounds = function () {
...
var pr = (function () {
  function e(t) {
    ((this.messageId = t.messageId),
      (this.unformattedText = t.messageText),
      (this.textRange = t.textRange),
      (this.tokenSequence = t.tokenSequence),
      (this.docNode = t.docNode),
      (this._text = void 0));
  }
  return (
    (e._formatMessageText = function (t, r) {
      if (
        (t || (t = "An unknown error occurred"), r.pos !== 0 || r.end !== 0)
      ) {
        var i = r.getLocation(r.pos);
        if (i.line) return "(".concat(i.line, ",").concat(i.column, "): ") + t;
      }
      return t;
    }),
    Object.defineProperty(e.prototype, "text", {
      get: function () {
        return (
          this._text === void 0 &&
            (this._text = e._formatMessageText(
...
var Vi = (function () {
  ...
  return (
    ...
    (e.prototype.addMessageForTextRange = function (t, r, i) {
      this.addMessage(new pr({ messageId: t, messageText: r, textRange: i }));
    }),
    (e.prototype.addMessageForTokenSequence = function (t, r, i, n) {
      this.addMessage(
        new pr({
          messageId: t,
          messageText: r,
          textRange: i.getContainingTextRange(),
          tokenSequence: i,
          docNode: n,
        }),
      );
    }),
    (e.prototype.addMessageForDocErrorText = function (t) {
      var r;
      (t.textExcerpt ? (r = t.textExcerpt) : (r = t.errorLocation),
        this.addMessage(
          new pr({
...
var Hi = (function () {
  function e(t, r) {
    ((this.commentRange = Le.empty),
      (this.lines = []),
      (this.tokens = []),
      (this.configuration = t),
      (this.sourceRange = r),
      (this.docComment = new Mr({ configuration: this.configuration })),
      (this.log = new Vi()));
  }
  return e;
})();
var ut = (function () {
  function e(t) {
    ((this.parserContext = t.parserContext),
      (this._startIndex = t.startIndex),
      (this._endIndex = t.endIndex),
      this._validateBounds());
  }
  return (
    (e.createEmpty = function (t) {
      return new e({ parserContext: t, startIndex: 0, endIndex: 0 });
    }),
    ...
    (e.prototype.getNewSequence = function (t, r) {
      return new e({
    ...
    (e.prototype.getContainingTextRange = function () {
      return this.isEmpty()
        ? Le.empty
...
var ie;
(function (e) {
  ((e[(e.BeginComment1 = 0)] = "BeginComment1"),
    (e[(e.BeginComment2 = 1)] = "BeginComment2"),
    (e[(e.CollectingFirstLine = 2)] = "CollectingFirstLine"),
    (e[(e.CollectingLine = 3)] = "CollectingLine"),
    (e[(e.AdvancingLine = 4)] = "AdvancingLine"),
    (e[(e.Done = 5)] = "Done"));
})(ie || (ie = {}));
var wa = (function () {
  function e() {}
  return (
    (e.extract = function (t) {
      for (
        ...
        if (l >= r.end)
          switch (h) {
            case ie.BeginComment1:
            case ie.BeginComment2:
              return (
                t.log.addMessageForTextRange(
                  w.CommentNotFound,
                  'Expecting a "/**" comment',
                  r,
                ),
        ...
        switch (h) {
          case ie.BeginComment1:
            if (_ === "/" && F === "*") ((n = k), ++l, (h = ie.BeginComment2));
            else if (!e._whitespaceCharacterRegExp.test(_))
              return (
                t.log.addMessageForTextRange(
          ...
          case ie.BeginComment2:
            ...
            break;
          case ie.CollectingFirstLine:
          case ie.CollectingLine:
            _ ===
            `
`
              ? ((h !== ie.CollectingFirstLine || c > s) &&
                  m.push(r.getNewRange(s, c)),
                (s = l),
                (c = l),
                (h = ie.AdvancingLine))
              : _ === "*" && F === "/"
                ? (c > s && m.push(r.getNewRange(s, c)),
                  (s = 0),
                  (c = 0),
                  ++l,
                  (a = l),
                  (h = ie.Done))
                : e._whitespaceCharacterRegExp.test(_) || (c = l);
            break;
          case ie.AdvancingLine:
            _ === "*"
              ? F === "/"
                ? ((s = 0), (c = 0), ++l, (a = l), (h = ie.Done))
                : (F === " " && ++l, (s = l), (c = l), (h = ie.CollectingLine))
              : _ ===
                  `
`
                ? (m.push(r.getNewRange(k, k)), (s = l))
                : e._whitespaceCharacterRegExp.test(_) ||
                  ((c = l), (h = ie.CollectingLine));
            break;
        }
      }
      return ((t.commentRange = r.getNewRange(n, a)), (t.lines = m), !0);
    }),
    (e._whitespaceCharacterRegExp = /^\s$/),
    e
  );
})();
var fr = (function () {
  function e() {}
  return (
    (e.readTokens = function (t) {
      e._ensureInitialized();
      for (var r = [], i = void 0, n = 0, a = t; n < a.length; n++) {
        var s = a[n];
        (e._pushTokensForLine(r, s), (i = s));
      }
      return (
        i
          ? r.push(new wt(f.EndOfInput, i.getNewRange(i.end, i.end), i))
          : r.push(new wt(f.EndOfInput, Le.empty, Le.empty)),
        r
      );
    }),
    (e.isPunctuation = function (t) {
      return (e._ensureInitialized(), e._punctuationTokens[t] || !1);
    }),
    (e._pushTokensForLine = function (t, r) {
      for (var i = r.buffer, n = r.end, a = r.pos, s = void 0, c = a; a < n;) {
        var l = i.charCodeAt(a),
          h = e._charCodeMap[l];
        (h === void 0 && (h = f.Other),
          (s !== void 0 && h === s && e._isMultiCharacterToken(s)) ||
            (s !== void 0 && t.push(new wt(s, r.getNewRange(c, a), r)),
            (c = a),
            (s = h)),
          ++a);
      }
      (s !== void 0 && t.push(new wt(s, r.getNewRange(c, a), r)),
        t.push(new wt(f.Newline, r.getNewRange(r.end, r.end), r)));
    }),
    (e._isMultiCharacterToken = function (t) {
      switch (t) {
        case f.Spacing:
        case f.AsciiWord:
        case f.Other:
    ...
    (e._ensureInitialized = function () {
      if (!e._charCodeMap) {
        ((e._charCodeMap = {}), (e._punctuationTokens = {}));
        for (
          var t = e._commonMarkPunctuationCharacters, r = 0;
          r < t.length;
          ++r
        ) {
          var i = t.charCodeAt(r);
          e._charCodeMap[i] = f.OtherPunctuation;
        }
        for (
          var n = {
              "\\": f.Backslash,
          ...
          var c = s[a];
          ((e._charCodeMap[c.charCodeAt(0)] = n[c]),
            (e._punctuationTokens[n[c]] = !0));
        }
        e._punctuationTokens[f.OtherPunctuation] = !0;
        for (var l = e._wordCharacters, r = 0; r < l.length; ++r) {
          var i = l.charCodeAt(r);
          e._charCodeMap[i] = f.AsciiWord;
        }
        ((e._charCodeMap[" ".charCodeAt(0)] = f.Spacing),
          (e._charCodeMap["	".charCodeAt(0)] = f.Spacing));
      }
    }),
    (e._commonMarkPunctuationCharacters = "!\"#$%&'()*+,-./:;<=>?@[\\]^`{|}~"),
    (e._wordCharacters =
...
var Ki = (function () {
  function e(t, r) {
    if (((this._parserContext = t), (this.tokens = t.tokens), r)) {
      if (r.parserContext !== this._parserContext)
        throw new Error(
          "The embeddedTokenSequence must use the same parser context",
        );
      ((this._readerStartIndex = r.startIndex),
        (this._readerEndIndex = r.endIndex));
    } else
  ...
  return (
    (e.prototype.extractAccumulatedSequence = function () {
      ...
      return ((this._accumulatedStartIndex = this._currentIndex), t);
    }),
    (e.prototype.isAccumulatedSequenceEmpty = function () {
      return this._accumulatedStartIndex === this._currentIndex;
    }),
    (e.prototype.tryExtractAccumulatedSequence = function () {
      if (!this.isAccumulatedSequenceEmpty())
        return this.extractAccumulatedSequence();
    }),
    (e.prototype.assertAccumulatedSequenceIsEmpty = function () {
      if (!this.isAccumulatedSequenceEmpty()) {
        var t = new ut({
            parserContext: this._parserContext,
            startIndex: this._accumulatedStartIndex,
...
` + JSON.stringify(r),
    ...
    (e.prototype.readToken = function () {
      ...
      var t = this.tokens[this._currentIndex];
      if (t.kind === f.EndOfInput)
        throw new Error("The EndOfInput token cannot be read");
      return (this._currentIndex++, t);
    }),
    (e.prototype.peekPreviousTokenKind = function () {
    ...
    (e.prototype.backtrackToMarker = function (t) {
      if (t > this._currentIndex) throw new Error("The marker has expired");
      ((this._currentIndex = t),
        t < this._accumulatedStartIndex && (this._accumulatedStartIndex = t));
    }),
    e
  );
})();
...
function hr(e) {
  return e !== void 0 && Object.hasOwnProperty.call(e, "failureMessage");
}
var ka = (function () {
  function e(t) {
    ((this._parserContext = t),
      (this._configuration = t.configuration),
      (this._currentSection = t.docComment.summarySection));
  }
  return (
    (e.prototype.parse = function () {
      for (var t = new Ki(this._parserContext), r = !1; !r;)
        switch (t.peekTokenKind()) {
          case f.EndOfInput:
            r = !0;
            break;
          case f.Newline:
            (this._pushAccumulatedPlainText(t),
              t.readToken(),
              this._pushNode(
                new $r({
                  parsed: !0,
                  configuration: this._configuration,
                  softBreakExcerpt: t.extractAccumulatedSequence(),
                }),
              ));
            break;
          case f.Backslash:
            (this._pushAccumulatedPlainText(t),
              this._pushNode(this._parseBackslashEscape(t)));
            break;
          case f.AtSign:
            (this._pushAccumulatedPlainText(t), this._parseAndPushBlock(t));
            break;
          case f.LeftCurlyBracket: {
            this._pushAccumulatedPlainText(t);
            var i = t.createMarker(),
              n = this._parseInlineTag(t),
              a = this._parserContext.docComment;
            if (n instanceof cr) {
              var s = t.createMarker() - 1;
              a.inheritDocTag === void 0
                ? (this._parserContext.docComment.inheritDocTag = n)
                : this._pushNode(
          ...
          case f.LessThan:
            (this._pushAccumulatedPlainText(t),
              t.peekTokenAfterKind() === f.Slash
                ? this._pushNode(this._parseHtmlEndTag(t))
                : this._pushNode(this._parseHtmlStartTag(t)));
            break;
          case f.GreaterThan:
            (this._pushAccumulatedPlainText(t),
              this._pushNode(
          ...
          case f.Backtick:
            (this._pushAccumulatedPlainText(t),
              t.peekTokenAfterKind() === f.Backtick &&
              t.peekTokenAfterAfterKind() === f.Backtick
                ? this._pushNode(this._parseFencedCode(t))
                : this._pushNode(this._parseCodeSpan(t)));
            break;
          default:
            t.readToken();
            break;
        }
      (this._pushAccumulatedPlainText(t), this._performValidationChecks());
    }),
    (e.prototype._performValidationChecks = function () {
      var t = this._parserContext.docComment;
      (t.deprecatedBlock &&
        (Jr.hasAnyTextContent(t.deprecatedBlock) ||
          this._parserContext.log.addMessageForTokenSequence(
            w.MissingDeprecationMessage,
            "The ".concat(
              t.deprecatedBlock.blockTag.tagName,
              " block must include a deprecation message,",
            ) + " e.g. describing the recommended alternative",
            t.deprecatedBlock.blockTag.getTokenSequence(),
            t.deprecatedBlock,
          )),
        t.inheritDocTag &&
          (t.remarksBlock &&
            this._parserContext.log.addMessageForTokenSequence(
              ...
              'A "'.concat(
                t.remarksBlock.blockTag.tagName,
                '" block must not be used, because that',
              ) + " content is provided by the @inheritDoc tag",
              t.remarksBlock.blockTag.getTokenSequence(),
              t.remarksBlock.blockTag,
            ),
          Jr.hasAnyTextContent(t.summarySection) &&
    ...
    (e.prototype._validateTagDefinition = function (t, r, i, n, a) {
      if (t) {
        var s = t.syntaxKind === L.InlineTag;
        s !== i
          ? i
            ? this._parserContext.log.addMessageForTokenSequence(
          ...
          : this._parserContext.configuration.validation
            ...
            (this._parserContext.configuration.isTagSupported(t) ||
              this._parserContext.log.addMessageForTokenSequence(
                w.UnsupportedTag,
                'The TSDoc tag "'.concat(r, '" is not supported by this tool'),
                n,
                a,
              ));
      } else
    ...
    (e.prototype._pushAccumulatedPlainText = function (t) {
      t.isAccumulatedSequenceEmpty() ||
        this._pushNode(
          new Me({
            parsed: !0,
            configuration: this._configuration,
            textExcerpt: t.extractAccumulatedSequence(),
          }),
        );
    }),
    (e.prototype._parseAndPushBlock = function (t) {
      var r = this._parserContext.docComment,
        i = this._parserContext.configuration,
        n = r.modifierTagSet,
        a = this._parseBlockTag(t);
      if (a.kind !== g.BlockTag) {
        this._pushNode(a);
        return;
      }
      var s = a,
        c = i.tryGetTagDefinitionWithUpperCase(s.tagNameWithUpperCase);
      if (
        (this._validateTagDefinition(c, s.tagName, !1, s.getTokenSequence(), s),
        c)
      )
        switch (c.syntaxKind) {
          case L.BlockTag:
            if (s.tagNameWithUpperCase === z.param.tagNameWithUpperCase) {
              var l = this._parseParamBlock(t, s, z.param.tagName);
              (this._parserContext.docComment.params.add(l),
                (this._currentSection = l.content));
              return;
            } else if (
              s.tagNameWithUpperCase === z.typeParam.tagNameWithUpperCase
            ) {
              var l = this._parseParamBlock(t, s, z.typeParam.tagName);
              (this._parserContext.docComment.typeParams.add(l),
                (this._currentSection = l.content));
              return;
            } else {
              var h = new Rt({
              ...
              (this._addBlockToDocComment(h),
                (this._currentSection = h.content));
            }
            return;
          case L.ModifierTag:
            n.addTag(s);
    ...
    (e.prototype._addBlockToDocComment = function (t) {
      var r = this._parserContext.docComment;
      switch (t.blockTag.tagNameWithUpperCase) {
        case z.remarks.tagNameWithUpperCase:
          r.remarksBlock = t;
          break;
        case z.privateRemarks.tagNameWithUpperCase:
          r.privateRemarks = t;
          break;
        case z.deprecated.tagNameWithUpperCase:
          r.deprecatedBlock = t;
          break;
        case z.returns.tagNameWithUpperCase:
          r.returnsBlock = t;
          break;
        case z.see.tagNameWithUpperCase:
          r._appendSeeBlock(t);
          break;
        default:
          r.appendCustomBlock(t);
      }
    }),
    (e.prototype._tryParseJSDocTypeOrValueRest = function (t, r, i, n) {
      for (var a, s = 1; s > 0;) {
        var c = t.peekTokenKind();
        switch (c) {
          case r:
            a === void 0 && s++;
            break;
          case i:
            ...
            break;
          case f.Backslash:
            a !== void 0 && (t.readToken(), (c = t.peekTokenKind()));
            break;
          case f.DoubleQuote:
          case f.SingleQuote:
          case f.Backtick:
            a === c ? (a = void 0) : a === void 0 && (a = c);
            break;
        }
        if (c === f.EndOfInput) {
          t.backtrackToMarker(n);
          return;
        }
        t.readToken();
      }
      return t.tryExtractAccumulatedSequence();
    }),
    (e.prototype._tryParseUnsupportedJSDocType = function (t, r, i) {
      if (
        (t.assertAccumulatedSequenceIsEmpty(),
        !(
          t.peekTokenKind() !== f.LeftCurlyBracket ||
          t.peekTokenAfterKind() === f.AtSign
        ))
      ) {
        var n = t.createMarker();
        t.readToken();
        var a = this._tryParseJSDocTypeOrValueRest(
          t,
          f.LeftCurlyBracket,
          f.RightCurlyBracket,
          n,
        ...
        if (a) {
          this._parserContext.log.addMessageForTokenSequence(
            ...
            "The " + i + " block should not include a JSDoc-style '{type}'",
            a,
            r,
          );
          var s = this._tryReadSpacingAndNewlines(t);
          s && (a = a.getNewSequence(a.startIndex, s.endIndex));
        }
        return a;
      }
    }),
    (e.prototype._tryParseJSDocOptionalNameRest = function (t) {
      if (
        (t.assertAccumulatedSequenceIsEmpty(),
        t.peekTokenKind() !== f.EndOfInput)
      ) {
        var r = t.createMarker();
    ...
    (e.prototype._parseParamBlock = function (t, r, i) {
      var n = t.createMarker(),
        a = this._tryReadSpacingAndNewlines(t),
        s = this._tryParseUnsupportedJSDocType(t, r, i),
        c;
      t.peekTokenKind() === f.LeftSquareBracket &&
        (t.readToken(), (c = t.extractAccumulatedSequence()));
      for (var l = "", h = !1; !h;)
        switch (t.peekTokenKind()) {
          case f.AsciiWord:
          case f.Period:
      ...
      var m = te.explainIfInvalidUnquotedIdentifier(l);
      if (m !== void 0) {
        t.backtrackToMarker(n);
        var _ = new lr({
            configuration: this._configuration,
          ...
          k =
            l.length > 0
              ? "The " +
                ...
                m
              : "The " + i + " block should be followed by a parameter name";
        return (
          this._parserContext.log.addMessageForTokenSequence(
      ...
      var F = t.extractAccumulatedSequence(),
        O;
      if (c) {
        O = this._tryParseJSDocOptionalNameRest(t);
        var U = c;
        (O &&
          (U = r.getTokenSequence().getNewSequence(c.startIndex, O.endIndex)),
          this._parserContext.log.addMessageForTokenSequence(
      ...
      var P = this._tryReadSpacingAndNewlines(t),
        Y = this._tryParseUnsupportedJSDocType(t, r, i),
        xe,
        ye,
        re;
      return (
        t.peekTokenKind() === f.Hyphen
          ? (t.readToken(),
            (xe = t.extractAccumulatedSequence()),
            (ye = this._tryReadSpacingAndNewlines(t)),
            (re = this._tryParseUnsupportedJSDocType(t, r, i)))
          : this._parserContext.log.addMessageForTokenSequence(
        ...
        new lr({
          ...
          configuration: this._configuration,
          blockTag: r,
          spacingBeforeParameterNameExcerpt: a,
          unsupportedJsdocTypeBeforeParameterNameExcerpt: s,
          unsupportedJsdocOptionalNameOpenBracketExcerpt: c,
          parameterNameExcerpt: F,
          parameterName: l,
          unsupportedJsdocOptionalNameRestExcerpt: O,
          spacingAfterParameterNameExcerpt: P,
          unsupportedJsdocTypeAfterParameterNameExcerpt: Y,
          hyphenExcerpt: xe,
          spacingAfterHyphenExcerpt: ye,
          unsupportedJsdocTypeAfterHyphenExcerpt: re,
        })
      );
    }),
    (e.prototype._pushNode = function (t) {
      this._configuration.docNodeManager.isAllowedChild(g.Paragraph, t.kind)
        ? this._currentSection.appendNodeInParagraph(t)
        : this._currentSection.appendNode(t);
    }),
    (e.prototype._parseBackslashEscape = function (t) {
      t.assertAccumulatedSequenceIsEmpty();
      var r = t.createMarker();
      if ((t.readToken(), t.peekTokenKind() === f.EndOfInput))
      ...
      var n = t.extractAccumulatedSequence();
      return new Br({
        parsed: !0,
        configuration: this._configuration,
        escapeStyle: Wr.CommonMarkBackslash,
        encodedTextExcerpt: n,
        decodedText: i.toString(),
      });
    }),
    (e.prototype._parseBlockTag = function (t) {
      t.assertAccumulatedSequenceIsEmpty();
      var r = t.createMarker();
      if (t.peekTokenKind() !== f.AtSign)
        return this._backtrackAndCreateError(
          t,
          r,
          w.MissingTag,
      ...
      switch (t.peekPreviousTokenKind()) {
        case f.EndOfInput:
        case f.Spacing:
        case f.Newline:
          break;
      ...
      var i = t.readToken().toString();
      if (t.peekTokenKind() !== f.AsciiWord)
        return this._backtrackAndCreateError(
          t,
          r,
      ...
      for (var n = t.createMarker(); t.peekTokenKind() === f.AsciiWord;)
        i += t.readToken().toString();
      switch (t.peekTokenKind()) {
        case f.Spacing:
        case f.Newline:
        case f.EndOfInput:
          break;
        default:
          var a = t.peekToken().range.toString()[0];
          return this._backtrackAndCreateError(
            t,
            r,
      ...
      if (te.explainIfInvalidTSDocTagName(i)) {
        var s = this._createFailureForTokensSince(
          t,
          w.MalformedTagName,
          "A TSDoc tag name must start with a letter and contain only letters and numbers",
          n,
        );
        return this._backtrackAndCreateErrorForFailure(t, r, "", s);
      }
      return new Nr({
        parsed: !0,
        configuration: this._configuration,
        tagName: i,
        tagNameExcerpt: t.extractAccumulatedSequence(),
      });
    }),
    (e.prototype._parseInlineTag = function (t) {
      t.assertAccumulatedSequenceIsEmpty();
      var r = t.createMarker();
      if (t.peekTokenKind() !== f.LeftCurlyBracket)
        return this._backtrackAndCreateError(
          t,
          r,
          w.MissingTag,
      ...
      t.readToken();
      var i = t.extractAccumulatedSequence(),
        n = t.createMarker();
      if (t.peekTokenKind() !== f.AtSign)
        return this._backtrackAndCreateError(
          t,
      ...
      for (var a = t.readToken().toString(); t.peekTokenKind() === f.AsciiWord;)
        a += t.readToken().toString();
      if (a === "@") {
        var s = this._createFailureForTokensSince(
          t,
          w.MalformedInlineTag,
        ...
        return this._backtrackAndCreateErrorRangeForFailure(t, r, n, "", s);
      }
      if (te.explainIfInvalidTSDocTagName(a)) {
        var s = this._createFailureForTokensSince(
          t,
          w.MalformedTagName,
          "A TSDoc tag name must start with a letter and contain only letters and numbers",
      ...
      var c = t.extractAccumulatedSequence(),
        l = this._tryReadSpacingAndNewlines(t);
      if (l === void 0 && t.peekTokenKind() !== f.RightCurlyBracket) {
        var h = t.peekToken().range.toString()[0],
          s = this._createFailureForToken(
            t,
      ...
      for (var m = !1; !m;)
        switch (t.peekTokenKind()) {
          ...
          case f.Backslash:
            if ((t.readToken(), !fr.isPunctuation(t.peekTokenKind()))) {
              var s = this._createFailureForToken(
                t,
                w.UnnecessaryBackslash,
                "A backslash can only be used to escape a punctuation character",
              );
      ...
      var _ = t.tryExtractAccumulatedSequence();
      t.readToken();
      var k = t.extractAccumulatedSequence(),
        F = {
          parsed: !0,
          configuration: this._configuration,
          ...
          tagNameExcerpt: c,
          tagName: a,
          spacingAfterTagNameExcerpt: l,
          tagContentExcerpt: _,
          closingDelimiterExcerpt: k,
        },
        O = a.toUpperCase(),
        U = new Ki(
          this._parserContext,
          _ || ut.createEmpty(this._parserContext),
        ),
        P;
      switch (O) {
        case z.inheritDoc.tagNameWithUpperCase:
          P = this._parseInheritDocTag(F, U);
          break;
        case z.link.tagNameWithUpperCase:
          P = this._parseLinkTag(F, U);
          break;
        default:
          P = new Vt(F);
      }
      var Y =
        this._parserContext.configuration.tryGetTagDefinitionWithUpperCase(O);
      return (this._validateTagDefinition(Y, a, !0, c, P), P);
    }),
    (e.prototype._parseInheritDocTag = function (t, r) {
      var i = new Vt(t),
        n = Qr({}, t);
      if (r.peekTokenKind() !== f.EndOfInput) {
        if (
          ((n.declarationReference = this._parseDeclarationReference(
            r,
            t.tagNameExcerpt,
            i,
          )),
    ...
    (e.prototype._parseLinkTag = function (t, r) {
      var i = new Vt(t),
        n = Qr({}, t);
      if (!t.tagContentExcerpt)
        return (
          this._parserContext.log.addMessageForTokenSequence(
            w.LinkTagEmpty,
      ...
      for (
        var a =
            r.peekTokenKind() === f.Slash && r.peekTokenAfterKind() === f.Slash,
          s = r.createMarker(),
          c = a;
        !c;
      )
        switch (r.peekTokenKind()) {
          case f.AsciiWord:
          case f.Period:
          case f.Hyphen:
          case f.Plus:
          ...
          case f.Colon:
            (r.readToken(),
              (a =
                r.peekTokenKind() === f.Slash &&
                r.peekTokenAfterKind() === f.Slash),
              (c = !0));
            break;
          default:
            c = !0;
        }
      if ((r.backtrackToMarker(s), a)) {
        if (!this._parseLinkTagUrlDestination(r, n, t.tagNameExcerpt, i))
          return i;
      } else if (!this._parseLinkTagCodeDestination(r, n, t.tagNameExcerpt, i))
        return i;
      if (r.peekTokenKind() === f.Spacing)
        throw new Error("Unconsumed spacing encountered after construct");
      if (r.peekTokenKind() === f.Pipe) {
        (r.readToken(),
          (n.pipeExcerpt = r.extractAccumulatedSequence()),
          (n.spacingAfterPipeExcerpt = this._tryReadSpacingAndNewlines(r)),
          (c = !1));
        for (var l = void 0; !c;)
          switch (r.peekTokenKind()) {
            case f.EndOfInput:
            ...
            case f.Newline:
              ...
              break;
            default:
              ((l = r.createMarker() + 1), r.readToken());
          }
        var m = r.tryExtractAccumulatedSequence();
        m &&
          (l === void 0
            ? (n.spacingAfterLinkTextExcerpt = m)
            : l >= m.endIndex
              ? (n.linkTextExcerpt = m)
              : ((n.linkTextExcerpt = m.getNewSequence(m.startIndex, l)),
                (n.spacingAfterLinkTextExcerpt = m.getNewSequence(
                  l,
                  m.endIndex,
                ))));
      } else if (r.peekTokenKind() !== f.EndOfInput)
        return (
          r.readToken(),
          this._parserContext.log.addMessageForTokenSequence(
    ...
    (e.prototype._parseLinkTagUrlDestination = function (t, r, i, n) {
      for (var a = "", s = !1; !s;)
        switch (t.peekTokenKind()) {
          case f.Spacing:
          case f.Newline:
      ...
      var c = t.extractAccumulatedSequence(),
        l = te.explainIfInvalidLinkUrl(a);
      return l
        ? (this._parserContext.log.addMessageForTokenSequence(
            w.LinkTagInvalidUrl,
            l,
          ...
          !1)
        : ((r.urlDestinationExcerpt = c),
          (r.spacingAfterDestinationExcerpt =
            this._tryReadSpacingAndNewlines(t)),
          !0);
    }),
    (e.prototype._parseLinkTagCodeDestination = function (t, r, i, n) {
      return (
        (r.codeDestination = this._parseDeclarationReference(t, i, n)),
        !!r.codeDestination
      );
    }),
    (e.prototype._parseDeclarationReference = function (t, r, i) {
      t.assertAccumulatedSequenceIsEmpty();
      for (var n = t.createMarker(), a = !1, s = !0, c = !1, l = !1; !l;)
        switch (t.peekTokenKind()) {
          case f.DoubleQuote:
          case f.EndOfInput:
          case f.LeftCurlyBracket:
      ...
      var h, m, _, k;
      if (a) {
        if (t.peekTokenKind() !== f.Period) {
          var F = t.peekTokenKind() === f.AtSign,
            O = !1;
          for (l = !1; !l;)
            switch (t.peekTokenKind()) {
              case f.EndOfInput:
          ...
          if (!t.isAccumulatedSequenceEmpty()) {
            h = t.extractAccumulatedSequence();
            var U = te.explainIfInvalidPackageName(h.toString());
            if (U) {
              this._parserContext.log.addMessageForTokenSequence(
        ...
        if (!t.isAccumulatedSequenceEmpty()) {
          m = t.extractAccumulatedSequence();
          var U = te.explainIfInvalidImportPath(m.toString(), !!h);
          if (U) {
            this._parserContext.log.addMessageForTokenSequence(
        ...
        if (t.peekTokenKind() !== f.PoundSymbol)
          throw new Error("Expecting pound symbol");
        if (
          (t.readToken(),
          (_ = t.extractAccumulatedSequence()),
          (k = this._tryReadSpacingAndNewlines(t)),
          h === void 0 && m === void 0)
        ) {
          this._parserContext.log.addMessageForTokenSequence(
      ...
      for (l = !1; !l;)
        switch (t.peekTokenKind()) {
          ...
          case f.DoubleQuote:
            var Y = P.length > 0,
              xe = this._parseMemberReference(t, Y, r, i);
            if (!xe) return;
            P.push(xe);
            break;
          default:
      ...
      if (h === void 0 && m === void 0 && P.length === 0) {
        this._parserContext.log.addMessageForTokenSequence(
          w.MissingReference,
      ...
      return new Fr({
        parsed: !0,
        configuration: this._configuration,
        packageNameExcerpt: h,
        importPathExcerpt: m,
        importHashExcerpt: _,
        spacingAfterImportHashExcerpt: k,
        memberReferences: P,
      });
    }),
    (e.prototype._parseMemberReference = function (t, r, i, n) {
      var a = { parsed: !0, configuration: this._configuration };
      if (r) {
        if (t.peekTokenKind() !== f.Period) {
          this._parserContext.log.addMessageForTokenSequence(
        ...
        (t.readToken(),
          (a.dotExcerpt = t.extractAccumulatedSequence()),
          (a.spacingAfterDotExcerpt = this._tryReadSpacingAndNewlines(t)));
      }
      if (
        (t.peekTokenKind() === f.LeftParenthesis &&
          (t.readToken(),
          (a.leftParenthesisExcerpt = t.extractAccumulatedSequence()),
          (a.spacingAfterLeftParenthesisExcerpt =
            this._tryReadSpacingAndNewlines(t))),
        t.peekTokenKind() === f.LeftSquareBracket)
      ) {
        if (((a.memberSymbol = this._parseMemberSymbol(t, n)), !a.memberSymbol))
          return;
      } else if (
        ((a.memberIdentifier = this._parseMemberIdentifier(t, i, n)),
        !a.memberIdentifier)
      )
        return;
      if (
        ((a.spacingAfterMemberExcerpt = this._tryReadSpacingAndNewlines(t)),
        t.peekTokenKind() === f.Colon)
      ) {
        if (
          (t.readToken(),
          (a.colonExcerpt = t.extractAccumulatedSequence()),
          (a.spacingAfterColonExcerpt = this._tryReadSpacingAndNewlines(t)),
          !a.leftParenthesisExcerpt)
        ) {
          this._parserContext.log.addMessageForTokenSequence(
        ...
        if (
          ((a.selector = this._parseMemberSelector(t, a.colonExcerpt, n)),
          !a.selector)
        )
          return;
        a.spacingAfterSelectorExcerpt = this._tryReadSpacingAndNewlines(t);
      } else if (a.leftParenthesisExcerpt) {
        this._parserContext.log.addMessageForTokenSequence(
      ...
      if (a.leftParenthesisExcerpt) {
        if (t.peekTokenKind() !== f.RightParenthesis) {
          this._parserContext.log.addMessageForTokenSequence(
        ...
        (t.readToken(),
          (a.rightParenthesisExcerpt = t.extractAccumulatedSequence()),
          (a.spacingAfterRightParenthesisExcerpt =
            this._tryReadSpacingAndNewlines(t)));
      }
      return new Hr(a);
    }),
    (e.prototype._parseMemberSymbol = function (t, r) {
      if (t.peekTokenKind() !== f.LeftSquareBracket)
        throw new Error('Expecting "["');
      t.readToken();
      var i = t.extractAccumulatedSequence(),
        n = this._tryReadSpacingAndNewlines(t),
        a = this._parseDeclarationReference(t, i, r);
      if (!a) {
        this._parserContext.log.addMessageForTokenSequence(
      ...
      if (t.peekTokenKind() !== f.RightSquareBracket) {
        this._parserContext.log.addMessageForTokenSequence(
      ...
      t.readToken();
      var s = t.extractAccumulatedSequence();
      return new Ur({
        parsed: !0,
        configuration: this._configuration,
        leftBracketExcerpt: i,
        spacingAfterLeftBracketExcerpt: n,
        symbolReference: a,
        rightBracketExcerpt: s,
      });
    }),
    (e.prototype._parseMemberIdentifier = function (t, r, i) {
      var n = void 0,
        a = void 0;
      if (t.peekTokenKind() === f.DoubleQuote) {
        for (
          t.readToken(), n = t.extractAccumulatedSequence();
          t.peekTokenKind() !== f.DoubleQuote;
        ) {
          if (t.peekTokenKind() === f.EndOfInput) {
            this._parserContext.log.addMessageForTokenSequence(
        ...
        return (
          t.readToken(),
          (a = t.extractAccumulatedSequence()),
          new ur({
            parsed: !0,
            configuration: this._configuration,
            leftQuoteExcerpt: n,
        ...
        var s = t.extractAccumulatedSequence(),
          l = s.toString(),
          h = te.explainIfInvalidUnquotedMemberIdentifier(l);
        if (h) {
          this._parserContext.log.addMessageForTokenSequence(
    ...
    (e.prototype._parseMemberSelector = function (t, r, i) {
      t.peekTokenKind() !== f.AsciiWord &&
        this._parserContext.log.addMessageForTokenSequence(
    ...
    (e.prototype._parseHtmlStartTag = function (t) {
      t.assertAccumulatedSequenceIsEmpty();
      var r = t.createMarker(),
        i = t.readToken();
      if (i.kind !== f.LessThan)
        throw new Error('Expecting an HTML tag starting with "<"');
      var n = t.extractAccumulatedSequence(),
        a = this._parseHtmlName(t);
      if (hr(a))
      ...
      for (
        var s = this._tryReadSpacingAndNewlines(t), c = [];
        t.peekTokenKind() === f.AsciiWord;
      ) {
        var l = this._parseHtmlAttribute(t);
        if (hr(l))
          return this._backtrackAndCreateErrorForFailure(
            t,
            r,
      ...
      t.assertAccumulatedSequenceIsEmpty();
      var h = t.createMarker(),
        m = !1;
      if (
        (t.peekTokenKind() === f.Slash && (t.readToken(), (m = !0)),
        t.peekTokenKind() !== f.GreaterThan)
      ) {
      ...
      return new Rr({
        ...
        nameExcerpt: a,
        spacingAfterNameExcerpt: s,
        htmlAttributes: c,
        selfClosingTag: m,
        closingDelimiterExcerpt: k,
      });
    }),
    (e.prototype._parseHtmlAttribute = function (t) {
      t.assertAccumulatedSequenceIsEmpty();
      var r = this._parseHtmlName(t);
      if (hr(r)) return r;
      var i = this._tryReadSpacingAndNewlines(t);
      if (t.peekTokenKind() !== f.Equals)
      ...
      return new qr({
        ...
        configuration: this._configuration,
        nameExcerpt: r,
        spacingAfterNameExcerpt: i,
        equalsExcerpt: n,
        spacingAfterEqualsExcerpt: a,
        valueExcerpt: c,
        spacingAfterValueExcerpt: l,
      });
    }),
    (e.prototype._parseHtmlString = function (t) {
      var r = t.createMarker(),
        i = t.peekTokenKind();
      if (i !== f.DoubleQuote && i !== f.SingleQuote)
        return this._createFailureForToken(
          t,
      ...
      t.readToken();
      for (var n = ""; ;) {
        var a = t.peekTokenKind();
        if (a === i) {
          t.readToken();
          break;
        }
        if (a === f.EndOfInput || a === f.Newline)
          return this._createFailureForToken(
            t,
        ...
        n += t.readToken().toString();
      }
      return t.peekTokenKind() === f.AsciiWord
    ...
    (e.prototype._parseHtmlEndTag = function (t) {
      t.assertAccumulatedSequenceIsEmpty();
      var r = t.createMarker(),
        i = t.peekToken();
      if (i.kind !== f.LessThan)
      ...
      t.readToken();
      var a = t.extractAccumulatedSequence(),
        s = this._parseHtmlName(t);
      if (hr(s))
        return this._backtrackAndCreateErrorForFailure(
          t,
          r,
      ...
      var c = this._tryReadSpacingAndNewlines(t);
      if (t.peekTokenKind() !== f.GreaterThan) {
        var l = this._createFailureForToken(
          t,
          w.HtmlTagMissingGreaterThan,
          'Expecting a closing ">" for the HTML tag',
        );
        return this._backtrackAndCreateErrorForFailure(t, r, "", l);
      }
      t.readToken();
      var h = t.extractAccumulatedSequence();
      return new Lr({
        parsed: !0,
        configuration: this._configuration,
        openingDelimiterExcerpt: a,
        nameExcerpt: s,
        spacingAfterNameExcerpt: c,
        closingDelimiterExcerpt: h,
      });
    }),
    (e.prototype._parseHtmlName = function (t) {
      var r = t.createMarker();
      if (t.peekTokenKind() === f.Spacing)
      ...
      var n = t.tryExtractAccumulatedSequence();
      if (!n)
        return this._createFailureForToken(
          t,
          w.MalformedHtmlName,
      ...
      var a = n.toString(),
        s = te.explainIfInvalidHtmlName(a);
      return s
        ? this._createFailureForTokensSince(t, w.MalformedHtmlName, s, r)
        : this._configuration.validation.reportUnsupportedHtmlElements &&
            !this._configuration.isHtmlElementSupported(a)
          ? this._createFailureForToken(
              t,
    ...
    (e.prototype._parseFencedCode = function (t) {
      t.assertAccumulatedSequenceIsEmpty();
      var r = t.createMarker(),
        i = r + 2;
      switch (t.peekPreviousTokenKind()) {
      ...
      for (
        var a = t.extractAccumulatedSequence();
        t.peekTokenKind() === f.Spacing;
      )
        t.readToken();
      for (var s = t.tryExtractAccumulatedSequence(), c = !1, l = void 0; !c;)
        switch (t.peekTokenKind()) {
          case f.Spacing:
          case f.Newline:
            (l === void 0 && (l = t.createMarker()),
              t.peekTokenKind() === f.Newline && (c = !0),
              t.readToken());
            break;
          case f.Backtick:
          ...
          default:
            ((l = void 0), t.readToken());
            break;
        }
      var _ = t.extractAccumulatedSequence(),
        k = _.getNewSequence(_.startIndex, l),
        F = _.getNewSequence(l, _.endIndex),
        O = -1,
        U = -1;
      c = !1;
      for (var P; !c;)
        switch (t.peekTokenKind()) {
          ...
          case f.Newline:
            for (
              P = t.readToken(), O = t.createMarker();
              t.peekTokenKind() === f.Spacing;
            )
              P = t.readToken();
            if (
              t.peekTokenKind() !== f.Backtick ||
              ((U = t.createMarker()),
              t.readToken(),
              t.peekTokenKind() !== f.Backtick) ||
              (t.readToken(), t.peekTokenKind() !== f.Backtick)
            )
              break;
            (t.readToken(), (c = !0));
            break;
      ...
      var Y = t.extractAccumulatedSequence(),
        xe = Y.getNewSequence(Y.startIndex, O),
        ye = Y.getNewSequence(O, U),
        re = Y.getNewSequence(U, Y.endIndex);
      for (c = !1; !c;)
        switch (t.peekTokenKind()) {
          case f.Spacing:
            t.readToken();
      ...
      var _t = t.tryExtractAccumulatedSequence();
      return new Or({
        parsed: !0,
        configuration: this._configuration,
        openingFenceExcerpt: a,
        spacingAfterOpeningFenceExcerpt: s,
        languageExcerpt: k,
        spacingAfterLanguageExcerpt: F,
        codeExcerpt: xe,
        spacingBeforeClosingFenceExcerpt: ye,
        closingFenceExcerpt: re,
        spacingAfterClosingFenceExcerpt: _t,
      });
    }),
    (e.prototype._parseCodeSpan = function (t) {
      t.assertAccumulatedSequenceIsEmpty();
      var r = t.createMarker();
      if (t.peekTokenKind() !== f.Backtick)
        throw new Error(
          'Expecting a code span starting with a backtick character "`"',
        );
      t.readToken();
      for (var i = t.extractAccumulatedSequence(), n = void 0, a = void 0; ;) {
        var s = t.peekTokenKind();
        if (s === f.Backtick) {
          if (t.isAccumulatedSequenceEmpty())
            return this._backtrackAndCreateErrorRange(
              t,
          ...
          ((n = t.extractAccumulatedSequence()),
            t.readToken(),
            (a = t.extractAccumulatedSequence()));
          break;
        }
        if (s === f.EndOfInput || s === f.Newline)
          return this._backtrackAndCreateError(
            t,
            r,
      ...
      return new Dr({
        ...
        openingDelimiterExcerpt: i,
        codeExcerpt: n,
        closingDelimiterExcerpt: a,
      });
    }),
    (e.prototype._tryReadSpacingAndNewlines = function (t) {
      var r = !1;
      do
        switch (t.peekTokenKind()) {
          case f.Spacing:
    ...
    (e.prototype._createError = function (t, r, i) {
      t.readToken();
      var n = t.extractAccumulatedSequence(),
        a = new bt({
          parsed: !0,
    ...
    (e.prototype._backtrackAndCreateError = function (t, r, i, n) {
      return (t.backtrackToMarker(r), this._createError(t, i, n));
    }),
    (e.prototype._backtrackAndCreateErrorRange = function (t, r, i, n, a) {
      for (t.backtrackToMarker(r); t.createMarker() !== i;) t.readToken();
      t.peekTokenKind() !== f.EndOfInput && t.readToken();
      var s = t.extractAccumulatedSequence(),
        c = new bt({
          parsed: !0,
          configuration: this._configuration,
      ...
      return (this._parserContext.log.addMessageForDocErrorText(c), c);
    }),
    (e.prototype._backtrackAndCreateErrorForFailure = function (t, r, i, n) {
      (t.backtrackToMarker(r), t.readToken());
      var a = t.extractAccumulatedSequence(),
        s = new bt({
          parsed: !0,
          configuration: this._configuration,
          textExcerpt: a,
          messageId: n.failureMessageId,
          errorMessage: i + n.failureMessage,
          errorLocation: n.failureLocation,
        });
      return (this._parserContext.log.addMessageForDocErrorText(s), s);
    }),
    (e.prototype._backtrackAndCreateErrorRangeForFailure = function (
      t,
      r,
      i,
      n,
      ...
      var s = t.extractAccumulatedSequence(),
        c = new bt({
          ...
          configuration: this._configuration,
          textExcerpt: s,
          messageId: a.failureMessageId,
          errorMessage: n + a.failureMessage,
          errorLocation: a.failureLocation,
        });
      return (this._parserContext.log.addMessageForDocErrorText(c), c);
    }),
    (e.prototype._createFailureForToken = function (t, r, i, n) {
      n || (n = t.createMarker());
      var a = new ut({
        parserContext: this._parserContext,
        startIndex: n,
      ...
      return { failureMessageId: r, failureMessage: i, failureLocation: a };
    }),
    (e.prototype._createFailureForTokensSince = function (t, r, i, n) {
      var a = t.createMarker();
      if (a < n) throw new Error("Invalid startMarker");
      a === n && ++a;
      var s = new ut({
        parserContext: this._parserContext,
        startIndex: n,
      ...
      return { failureMessageId: r, failureMessage: i, failureLocation: s };
    }),
    e
  );
})();
var ja = (function () {
  function e() {}
  return (
    (e.splitParagraphs = function (t) {
      if (t instanceof ct) e.splitParagraphsForSection(t);
      else
        for (var r = 0, i = t.getChildNodes(); r < i.length; r++) {
          var n = i[r];
          e.splitParagraphs(n);
        }
    }),
    (e.splitParagraphsForSection = function (t) {
      for (var r = t.nodes, i = [], n = 0, a = r; n < a.length; n++) {
        var s = a[n];
        s.kind === g.Paragraph ? e._splitParagraph(s, i) : i.push(s);
      }
      (t.clearNodes(), t.appendNodes(i));
    }),
    (e._splitParagraph = function (t, r) {
      var i = t.nodes,
        n = new We({ configuration: t.configuration });
      r.push(n);
      var a;
      (function (k) {
        ((k[(k.Start = 0)] = "Start"),
          (k[(k.AwaitingTrailer = 1)] = "AwaitingTrailer"),
          (k[(k.ReadingTrailer = 2)] = "ReadingTrailer"));
      })(a || (a = {}));
      for (var s = a.Start, c = 0; c < i.length;) {
        var l = !0,
          h = c;
        do {
          var m = i[h++];
          if (m.kind === g.SoftBreak) break;
          l && (this._isWhitespace(m) || (l = !1));
        } while (h < i.length);
        switch (s) {
          case a.Start:
            l || (s = a.AwaitingTrailer);
            break;
          case a.AwaitingTrailer:
            l && (s = a.ReadingTrailer);
            break;
          case a.ReadingTrailer:
            l ||
              ((n = new We({ configuration: t.configuration })),
              r.push(n),
              (s = a.AwaitingTrailer));
        ...
        for (var _ = c; _ < h; ++_) n.appendNode(i[_]);
        c = h;
      }
    }),
    (e._isWhitespace = function (t) {
      switch (t.kind) {
        case g.PlainText:
          var r = t;
          return e._whitespaceRegExp.test(r.text);
        default:
          return !1;
      }
    }),
    (e._whitespaceRegExp = /^\s*$/),
    e
  );
})();
var Ui = (function () {
  function e(t) {
    t ? (this.configuration = t) : (this.configuration = new Bi());
  }
  return (
    (e.prototype.parseString = function (t) {
      return this.parseRange(Le.fromString(t));
    }),
    (e.prototype.parseRange = function (t) {
      var r = new Hi(this.configuration, t);
      if (wa.extract(r)) {
        r.tokens = fr.readTokens(r.lines);
        var i = new ka(r);
        (i.parse(), ja.splitParagraphs(r.docComment));
      }
      return r;
    }),
    e
...
var $i = class {
  ...
  Gi = class {
    constructor(t, r) {
      ((this.name = t), (this.description = r));
    }
  };
var Ta = $(require("obsidian"));
function le(e) {
  let t = new Ta.Notice("", 8e3),
    r = createFragment((i) => {
      (i.createEl("b", { text: "Templater error" }),
        i.createSpan({ text: ":" }),
        i.createEl("br"),
        i.createSpan({ text: e.message }),
        e instanceof C &&
          e.console_msg &&
          (i.createEl("br"),
          i.createSpan({ text: "Check console for more information" }),
          console.error(
            "Templater Error:",
            e.message,
            `
...
async function de(e, t) {
  try {
    ...
    return (
      r instanceof C
        ? le(r)
        : le(new C(t, r instanceof Error ? r.message : void 0)),
      null
    );
  }
}
function je(e, t) {
  try {
    ...
    return (le(new C(t, r instanceof Error ? r.message : void 0)), null);
  }
}
...
function Yi(e, t) {
  t = (0, me.normalizePath)(t);
  let r = e.vault.getAbstractFileByPath(t);
  if (!r) throw new C(`Folder "${t}" doesn't exist`);
  if (!(r instanceof me.TFolder)) throw new C(`${t} is a file, not a folder`);
  return r;
}
function pt(e, t) {
  t = (0, me.normalizePath)(t);
  let r = e.vault.getAbstractFileByPath(t);
  if (!r) throw new C(`File "${t}" doesn't exist`);
  if (!(r instanceof me.TFile)) throw new C(`${t} is a folder, not a file`);
  return r;
}
function Re(e, t) {
  let r = Yi(e, t),
    i = [];
  return (
    me.Vault.recurseChildren(r, (n) => {
      n instanceof me.TFile && i.push(n);
    }),
    i.sort((n, a) => n.path.localeCompare(a.path)),
    i
  );
}
async function Sa(e, t) {
  return await Promise.all(
    t.map(async (i) => {
      let n = await e.vault.cachedRead(i);
      return ic(i, n);
    }),
  );
}
function ic(e, t) {
  ...
  return (
    ...
    (i.returns = r.returns),
    (i.arguments = r.arguments),
    i
  );
}
function zi(e) {
  let r = new Ui().parseString(e);
  return {
    description: nc(r.docComment.summarySection),
    returns: ac(r.docComment.returnsBlock),
    arguments: sc(r.docComment.params),
  };
}
function nc(e) {
  try {
...
function ac(e) {
  if (!e) return "";
  try {
    let t = e.content.nodes[0]?.getChildNodes()[0];
    return t instanceof Me ? t.text.trim() : "";
  } catch {
    return "";
  }
}
function sc(e) {
  try {
    return e.blocks.map((i) => {
      let n = i.parameterName,
        a = i.content
          .getChildNodes()[0]
          .getChildNodes()
          .filter((s) => s instanceof Me)
          .map((s) => s.text)
          .join(" ");
      return new Gi(n, a);
    });
...
function Wi(e, t, r) {
  ...
  let i = e.splice(t, 1)[0];
  e.splice(r, 0, i);
}
function ft(e) {
  return e.workspace.activeEditor?.file ?? e.workspace.getActiveFile();
}
function Xr(e) {
  let t = e.lastIndexOf("/");
...
function Ca(e) {
  let t = e.toString(),
    r = t.indexOf("(");
  return t
    .substring(r + 1, t.indexOf(")"))
    .replace(/ /g, "")
    .split(",");
}
function Ji(e, t, r) {
  let i = e.instanceOf(HTMLOListElement) ? "li" : "p",
    n = e.createEl(i),
    a = e.createEl("b", { text: t });
  return (
    n.appendChild(a),
    n.appendChild(activeDocument.createTextNode(`: ${r}`)),
    n
  );
}
function Zr(e, t) {
      ...
      if (Object.prototype.hasOwnProperty.call(t, r))
        if (Object.prototype.hasOwnProperty.call(e, r)) {
          ...
          if (Array.isArray(i) || Array.isArray(n)) {
            ...
            e[r] = a.concat(s).unique();
          } else
            ue(i) && ue(n) ? Zr(i, n) : n != null && n !== "" && (e[r] = n);
        } else e[r] = t[r];
  }
}
function dr(e) {
  let t = {},
    r = (0, me.getFrontMatterInfo)(e);
  if (r.frontmatter)
    try {
      t = (0, me.parseYaml)(r.frontmatter);
    } catch {
      return { frontmatter: t, content: e };
    }
  return { frontmatter: t, content: e.slice(r.contentStart) };
}
var ei = $(require("obsidian")),
  Qi = class extends ei.ConfirmationModal {
    constructor(t, r, i, n) {
      super(t);
      (this.setTitle(r),
        this.modalEl.addClass("templater-confirm-dangerous-setting-modal"),
        this.contentEl.createEl("p", { text: i }),
      ...
      let a;
      (ei.Platform.isMobile
        ? this.addButton((s) => {
            ((a = s),
              s
                .setButtonText("I understand the risks, enable")
                .setCta()
                .onClick(async () => {
                  await n();
                }));
          })
        : this.addCheckbox("I understand the risks", (s) => {
            a.setDisabled(!s);
          }).addButton((s) => {
            ((a = s),
              s
...
var ge;
(function (r) {
  ((r[(r.TemplateFiles = 0)] = "TemplateFiles"),
    (r[(r.ScriptFiles = 1)] = "ScriptFiles"));
})(ge || (ge = {}));
var Xe = class extends ti.AbstractInputSuggest {
  constructor(t, r, i) {
    super(r.app, t);
    this.inputEl = t;
    this.plugin = r;
  ...
  getSuggestions(t) {
    let r = je(
      () => Re(this.plugin.app, this.get_folder(this.mode)),
  ...
  selectSuggestion(t) {
    (this.setValue(t.path), this.inputEl.trigger("input"), this.close());
  }
};
var Xi = class extends Ut.Modal {
  constructor(t, r, i, n) {
    super(t);
    this.plugin = r;
    this.onSubmit = n;
    ((this.regex = i.regex), (this.template = i.template));
  }
  onOpen() {
    ...
    let { contentEl: t } = this,
      ...
      i = new Ut.Setting(t)
        ...
        .addText((n) => {
          (new Xe(n.inputEl, this.plugin, ge.TemplateFiles),
            n
    ...
    new Ut.Setting(t)
      .addButton((n) =>
        n
          ...
          .onClick(async () => {
            if (!this.regex) {
              r.setErrorMessage("File regex cannot be empty");
              return;
            }
            if (!this.template) {
              i.setErrorMessage("Template cannot be empty");
              return;
            }
            (await this.onSubmit(this.regex, this.template), this.close());
          }),
      )
      .addButton((n) => n.setButtonText("Cancel").onClick(() => this.close()));
  }
  onClose() {
...
var Pa = $(require("obsidian")),
  mr = class extends Pa.AbstractInputSuggest {
    constructor(t, r) {
      super(t, r);
      this.inputEl = r;
    }
    getSuggestions(t) {
      ...
      return this.app.vault
        .getAllFolders()
        .filter((n) => n.path.toLowerCase().includes(r))
        .slice(0, 1e3);
    }
    renderSuggestion(t, r) {
      r.setText(t.path);
...
var Zi = class extends $t.Modal {
  constructor(t, r, i, n, a) {
    super(t);
    this.plugin = r;
    this.onSubmit = n;
    this.validateFolder = a;
    ((this.folder = i.folder), (this.template = i.template));
  }
  onOpen() {
    ...
    new $t.Setting(t)
      .addButton((n) =>
        n
          ...
          .onClick(async () => {
            if (!this.folder) {
              r.setErrorMessage("Folder cannot be empty");
              return;
            }
            if (!this.template) {
              i.setErrorMessage("Template cannot be empty");
            ...
            let a = this.validateFolder(this.folder);
            if (a) {
              r.setErrorMessage(a);
              return;
            }
            (await this.onSubmit(this.folder, this.template), this.close());
          }),
      )
      .addButton((n) => n.setButtonText("Cancel").onClick(() => this.close()));
  }
...
var en = class extends kt.Modal {
  ...
  onOpen() {
    ...
    let r = new kt.Setting(t)
      ...
      i = t.createDiv("modal-button-container");
    (new kt.ButtonComponent(i)
      .setButtonText("Done")
      .setCta()
      .onClick(async () => {
        if (!this.folder) {
        ...
        (await this.onSubmit(this.folder), this.close());
      }),
      new kt.ButtonComponent(i)
...
var tn = class extends jt.Modal {
  ...
  onOpen() {
    ...
    let r = new jt.Setting(t)
      ...
      i = t.createDiv("modal-button-container");
    (new jt.ButtonComponent(i)
      .setButtonText("Done")
      .setCta()
      .onClick(async () => {
        if (!this.template) {
          r.setErrorMessage("Template cannot be empty");
          return;
        }
        (await this.onSubmit(this.template), this.close());
      }),
      new jt.ButtonComponent(i)
        .setButtonText("Cancel")
        .onClick(() => this.close()));
...
var Gt = $(require("obsidian")),
  rn = class extends Gt.Modal {
    constructor(t, r, i, n) {
      super(t);
      this.onSubmit = i;
      this.validateName = n;
      ((this.name = r.name), (this.command = r.command));
    }
    onOpen() {
      (this.setTitle("User function"),
        this.modalEl.addClass("templater-system-command-modal"));
      let { contentEl: t } = this,
        r = new Gt.Setting(t).setName("Function name").addText((i) => {
          i.setPlaceholder("Function name")
            .setValue(this.name)
            .onChange((n) => {
              this.name = n;
            });
        });
      (new Gt.Setting(t).setName("System command").addTextArea((i) => {
        (i
          ...
          .addButton((i) =>
            i
              ...
              .onClick(async () => {
                ...
                (await this.onSubmit(this.name, this.command), this.close());
              }),
          )
          .addButton((i) =>
            i.setButtonText("Cancel").onClick(() => this.close()),
          ));
    }
    onClose() {
      this.contentEl.empty();
...
var nn = class extends Tt.Modal {
  constructor(t, r, i, n, a) {
    super(t);
    this.plugin = r;
    this.onSubmit = n;
    this.validateTemplate = a;
    ((this.template = i.template),
      (this.insert_enabled = i.insert_enabled),
      (this.create_enabled = i.create_enabled));
  }
  onOpen() {
    ...
    let { contentEl: t } = this,
      ...
      i = new Tt.Setting(t)
        ...
        .addToggle((n) => {
          n.setValue(this.insert_enabled).onChange((a) => {
            this.insert_enabled = a;
          });
        });
    (new Tt.Setting(t)
      .setName("Create command")
      .setDesc("Adds a command that creates a new note from this template.")
      .addToggle((n) => {
        n.setValue(this.create_enabled).onChange((a) => {
          this.create_enabled = a;
        });
      }),
      new Tt.Setting(t)
        .addButton((n) =>
          n
            ...
            .onClick(async () => {
              ...
              let a = this.validateTemplate(this.template);
              if (a) {
                r.setErrorMessage(a);
                return;
              }
              if (!this.insert_enabled && !this.create_enabled) {
                i.setErrorMessage("At least one command must be enabled");
                return;
              }
              (await this.onSubmit({
        ...
        .addButton((n) =>
          n.setButtonText("Cancel").onClick(() => this.close()),
        ));
  }
  onClose() {
    this.contentEl.empty();
...
(function (a) {
  ((a.Off = "0"),
    (a.RenderDescriptionParameterReturn = "1"),
    (a.RenderDescriptionParameterList = "2"),
    (a.RenderDescriptionReturn = "3"),
    (a.RenderDescriptionOnly = "4"));
})(Ze || (Ze = {}));
function Ia(e) {
  return isBoolean(e)
    ? e
    : [
        Ze.RenderDescriptionParameterReturn,
        Ze.RenderDescriptionReturn,
      ].includes(e);
}
function Na(e) {
  return isBoolean(e)
    ...
    : [
        Ze.RenderDescriptionParameterReturn,
        Ze.RenderDescriptionParameterList,
      ].includes(e);
}
function Da(e) {
  return isBoolean(e) ? e : e != Ze.Off;
}
var an = {
    trigger_on_file_creation: !1,
    enable_startup_templates: !1,
    enable_system_commands: !1,
  },
  sn = "templater-local-settings";
function Ve(e) {
  let t = e.loadLocalStorage(sn);
  return Object.assign({}, an, t ?? {});
}
function Ma(e, t, r) {
  let i = e.loadLocalStorage(sn) ?? {};
  e.saveLocalStorage(sn, { ...i, [t]: r });
}
function Fa(e, t, r) {
  let i = t
      .split(".")
      .map((s) => (isNaN(parseInt(s, 10)) ? s : parseInt(s, 10))),
    n = i.length - 1,
    a = e;
  for (let [s, c] of i.entries())
    s === n
      ? (a[c] = r)
      : (a[c] == null && (a[c] = typeof i[s + 1] == "number" ? [] : {}),
        (a = a[c]));
}
function Ba(e, t, r) {
  let i = t.split(".").reduce((n, a) => n?.[a], e);
  return i === void 0 ? r : i;
}
function Et(e) {
  return typeof e == "string"
    ? { template: e, insert_enabled: !0, create_enabled: !0 }
    : {
        template: typeof e?.template == "string" ? e.template : "",
        insert_enabled: e?.insert_enabled ?? !0,
        create_enabled: e?.create_enabled ?? !0,
      };
}
function on(e) {
  return e.insert_enabled && e.create_enabled
    ? e.template
    : {
        template: e.template,
        insert_enabled: e.insert_enabled,
        create_enabled: e.create_enabled,
      };
}
function Oa(e) {
  let t = [];
  return (
    e.insert_enabled && t.push("Insert"),
    e.create_enabled && t.push("Create"),
    t.length > 0 ? t.join(", ") : "None"
  );
}
var et = $(require("obsidian"));
var cn = class extends et.SettingPage {
  constructor(t, r) {
    super();
    this.userScripts = [];
    ((this.pluginSettingTab = t), (this.plugin = r));
  }
  loadUserScripts() {
    let t = je(
      () => Re(this.plugin.app, this.plugin.settings.user_scripts_folder),
      "User scripts folder doesn't exist",
    );
    this.userScripts = Array.isArray(t)
      ? t.filter((r) => r.extension === "js")
      : [];
  }
  openUserScriptsFolderInDefaultApp() {
    let t = this.plugin.settings.user_scripts_folder;
    t && this.plugin.app.openWithDefaultApp((0, et.normalizePath)(t));
  }
  display() {
    if (
      ...
      this.plugin.settings.user_scripts_folder &&
        new et.Setting(this.containerEl).setHeading().addExtraButton((r) => {
          r.setIcon("folder")
            .setTooltip("Open user scripts folder")
            .onClick(() => this.openUserScriptsFolderInDefaultApp());
        }),
      this.userScripts.length === 0)
    ) {
      new et.Setting(this.containerEl)
        .setName(
          (() => {
            let r = createFragment();
            return (
              this.plugin.settings.user_scripts_folder ||
                r.append(
              ...
              r.append(
                ...
                r.createEl("code", { text: "<% tp.user.file_name() %>" }),
              ),
              r
            );
          })(),
    ...
    let t = new et.SettingGroup(this.containerEl).addClass("mod-list");
    this.userScripts.forEach((r) => {
      t.addSetting((i) => {
        i.setName(`tp.user.${r.basename}`);
      });
    });
  }
};
var gr = {
  ...
  jump_to_cursor_after_file_name: !1,
  shell_path: "",
  user_scripts_folder: "",
  folder_templates: [],
  file_templates: [],
  ...
  startup_templates: [],
  intellisense_render: Ze.RenderDescriptionParameterReturn,
  ignore_folders_on_creation: [],
};
var un = class extends ri.PluginSettingTab {
  constructor(t) {
    super(t.app, t);
    this.plugin = t;
    ...
    this.containerEl.addEventListener(
      ...
      (i) => {
        i.target &&
          "href" in i.target &&
          i.target.href &&
          typeof i.target.href == "string" &&
          i.stopPropagation();
      },
      !0,
    );
    let r = (0, ri.debounce)(() => this.update(), 200, !0);
    (t.registerEvent(this.app.vault.on("create", r)),
      t.registerEvent(this.app.vault.on("delete", r)),
      t.registerEvent(this.app.vault.on("rename", r)));
  }
  isLocalSettingsKey(t) {
    return t in an;
  }
  getControlValue(t) {
    return this.isLocalSettingsKey(t)
      ? Ve(this.plugin.app)[t]
      : Ba(this.plugin.settings, t);
  }
  async setControlValue(t, r) {
    let i = {
    ...
    if (this.isLocalSettingsKey(t) && r === !0 && t in i) {
      let n = i[t];
      (new Qi(this.app, n.title, n.warning, async () => {
        await this.commitControlValue(t, r);
      }).open(),
        this.update());
      return;
    }
  ...
  async commitControlValue(t, r) {
    (this.isLocalSettingsKey(t)
      ? Ma(this.plugin.app, t, r)
      : Fa(this.plugin.settings, t, r),
      [
        "trigger_on_file_creation",
        "trigger_on_file_creation_mode",
        "enable_startup_templates",
        "enable_system_commands",
      ].contains(t) && this.update(),
      await this.plugin.save_settings());
  }
  getSettingDefinitions() {
    let t = [],
      r = Ve(this.plugin.app);
    return (
      t.push({
        type: "group",
        items: [
          ...
          },
          {
            ...
            control: { type: "folder", key: "templates_folder" },
          },
          {
            type: "page",
            ...
            items: [
              {
                ...
                searchable: !1,
                visible: () => !this.plugin.settings.templates_folder,
              },
            ...
            desc: (() => {
              ...
              return (
                i.append(
                  ...
                  i.createEl("code", { text: "tp.file.cursor" }),
          ...
          },
          {
            ...
            control: { type: "toggle", key: "jump_to_cursor_after_file_name" },
          },
        ],
      }),
      t.push({
        ...
        items: [
          ...
          },
          {
            ...
            control: { type: "toggle", key: "syntax_highlighting_mobile" },
          },
        ],
      }),
      t.push({
        ...
        items: this.fileCreationGroup(r),
      }),
      t.push({
        type: "group",
        ...
        items: [
          {
            ...
            control: { type: "toggle", key: "enable_startup_templates" },
          },
          {
            type: "page",
            ...
            visible: () => r.enable_startup_templates,
          },
        ],
      }),
      t.push({
      ...
      t.push({
        ...
        items: this.systemCommandItems(r),
      }),
      t
    );
  }
  fileCreationGroup(t) {
    ...
    a.append(
      ...
      a.createEl("br"),
      "Add a rule for ",
      a.createEl("code", { text: "/" }),
      " if you need a catch-all.",
    );
    let s = createFragment();
    return (
      s.append(
      ...
      [
        {
          ...
          desc: r,
          control: { type: "toggle", key: "trigger_on_file_creation" },
        },
        {
          type: "page",
          ...
          visible: () => t.trigger_on_file_creation,
        },
        {
        ...
        },
        {
          ...
          visible: () =>
            t.trigger_on_file_creation &&
            this.plugin.settings.trigger_on_file_creation_mode === "folder",
        },
        {
          type: "page",
          ...
          visible: () =>
            t.trigger_on_file_creation &&
            this.plugin.settings.trigger_on_file_creation_mode === "regex",
        },
      ]
    );
  }
  templateHotkeysGroup() {
    let t = (r, i, n) => {
      new nn(this.app, this.plugin, r, i, (a) => {
        if (
          this.plugin.settings.enabled_templates_hotkeys.some(
            (s, c) => Et(s).template === a && c !== n,
          )
        )
    ...
    return {
      ...
      addItem: {
        ...
        action: () => {
          t(
            { template: "", insert_enabled: !0, create_enabled: !0 },
            async (r) => {
              (this.plugin.settings.enabled_templates_hotkeys.push(on(r)),
      ...
      items: this.plugin.settings.enabled_templates_hotkeys.map((r, i) => {
        let n = Et(r);
        return {
          name: n.template,
          desc: Oa(n),
          ...
          action: () => {
            t(
              n,
              async (a) => {
                ((this.plugin.settings.enabled_templates_hotkeys[i] = on(a)),
                  this.plugin.command_handler.sync_template_hotkeys(),
                  this.update(),
                  await this.plugin.save_settings());
              },
  ...
  ignoreFoldersGroup() {
    return {
      ...
      onDelete: (t) => {
        (this.plugin.settings.ignore_folders_on_creation.splice(t, 1),
          this.update(),
          this.plugin.save_settings());
      },
      emptyState: "No exclusions added.",
      items: this.plugin.settings.ignore_folders_on_creation.map((t) => ({
        name: t.folder,
        searchable: !1,
      })),
    };
  }
  folderTemplatesGroup() {
    let t = (r, i, n) => {
      new Zi(this.app, this.plugin, r, i, (a) => {
        if (
    ...
    return {
      ...
      onReorder: (r, i) => {
        (Wi(this.plugin.settings.folder_templates, r, i),
          this.update(),
          this.plugin.save_settings());
      },
      onDelete: (r) => {
        (this.plugin.settings.folder_templates.splice(r, 1),
          this.update(),
          this.plugin.save_settings());
      },
      emptyState: "No folder templates added.",
      items: this.plugin.settings.folder_templates.map((r, i) => ({
        name: r.folder,
        desc: r.template,
        action: () => {
          t(
            { folder: r.folder, template: r.template },
            async (n, a) => {
              ((this.plugin.settings.folder_templates[i].folder = n),
                (this.plugin.settings.folder_templates[i].template = a),
                this.update(),
                await this.plugin.save_settings());
            },
            i,
  ...
  fileTemplatesGroup() {
    let t = (r, i) => {
      new Xi(this.app, this.plugin, r, i).open();
    };
    return {
      type: "list",
      addItem: {
      ...
      onReorder: (r, i) => {
        (Wi(this.plugin.settings.file_templates, r, i),
          this.update(),
          this.plugin.save_settings());
      },
      onDelete: (r) => {
        (this.plugin.settings.file_templates.splice(r, 1),
          this.update(),
          this.plugin.save_settings());
      },
      emptyState: "No file regex templates added.",
      items: this.plugin.settings.file_templates.map((r, i) => ({
        name: r.regex,
        desc: r.template,
        action: () => {
          t({ regex: r.regex, template: r.template }, async (n, a) => {
            ((this.plugin.settings.file_templates[i].regex = n),
              (this.plugin.settings.file_templates[i].template = a),
              this.update(),
              await this.plugin.save_settings());
          });
        },
  ...
  startupTemplatesGroup() {
    return {
      type: "list",
      addItem: {
        name: "Add new startup template",
        action: () => {
          new tn(this.app, this.plugin, (t) => {
            (this.plugin.settings.startup_templates.push(t),
              this.update(),
              this.plugin.save_settings());
          }).open();
        },
      ...
      onDelete: (t) => {
        (this.plugin.settings.startup_templates.splice(t, 1),
          this.update(),
          this.plugin.save_settings());
      },
      emptyState: "No startup templates added.",
      items: this.plugin.settings.startup_templates.map((t) => ({
        name: t,
        searchable: !1,
      })),
    };
  ...
  userScriptItems() {
    ...
    return (
      t.push({
        ...
        control: { type: "folder", key: "user_scripts_folder" },
      }),
      t.push({
      ...
      t.push({
        ...
        name: "User scripts",
        searchable: !1,
        page: () => new cn(this, this.plugin),
      }),
      t
    );
  }
  systemCommandItems(t) {
    let r = createFragment();
    return (
      r.append(
      ...
      [
        {
          ...
          control: { type: "toggle", key: "enable_system_commands" },
        },
        {
          name: "Timeout",
          ...
          visible: () => t.enable_system_commands,
        },
        {
  ...
  systemCommandPairsGroup() {
    let t = (r, i, n) => {
      new rn(this.app, r, i, (a) => {
        if (
    ...
    return {
      ...
      addItem: {
        ...
        action: () => {
          t({ name: "", command: "" }, (r, i) => {
            (this.plugin.settings.templates_pairs.push([r, i]),
              this.update(),
              this.plugin.save_settings());
          });
        },
      ...
      onDelete: (r) => {
        (this.plugin.settings.templates_pairs.splice(r, 1),
          this.update(),
          this.plugin.save_settings());
      },
      emptyState: "No user functions added.",
      items: this.plugin.settings.templates_pairs.map((r, i) => ({
        name: r[0],
        desc: r[1] || void 0,
        searchable: !1,
        action: () => {
          t(
            { name: r[0], command: r[1] },
            async (n, a) => {
              ((this.plugin.settings.templates_pairs[i][0] = n),
                (this.plugin.settings.templates_pairs[i][1] = a),
                this.update(),
                await this.plugin.save_settings());
            },
            i,
...
function qa(e) {
  return !!(e && typeof e == "object" && !("data_version" in e));
}
function La(e) {
  return qa(e)
    ? oc(e)
    : {
        settings: Object.assign({}, gr, e),
...
function oc(e) {
  let t = [];
  (e.trigger_on_file_creation === !0 && t.push("'Trigger on file creation'"),
    e.enable_system_commands === !0 && t.push("'Enable system commands'"),
    Array.isArray(e.startup_templates) &&
      e.startup_templates.some((n) => n !== "") &&
      t.push("'Enable startup templates'"));
  let r =
      e.enable_folder_templates === !0
        ? "folder"
        : e.enable_file_templates === !0
          ? "regex"
          : (e.trigger_on_file_creation_mode ?? "none"),
    i = Object.assign({}, gr, e, {
      data_version: 2,
      trigger_on_file_creation_mode: r,
      folder_templates: (e.folder_templates ?? []).filter(
        (n) => n.folder || n.template,
      ),
      file_templates: (e.file_templates ?? []).filter((n) => n.template !== ""),
      templates_pairs: (e.templates_pairs ?? []).filter(([n, a]) => n || a),
      enabled_templates_hotkeys: (e.enabled_templates_hotkeys ?? []).filter(
        (n) => Et(n).template,
      ),
      startup_templates: (e.startup_templates ?? []).filter((n) => n),
      ignore_folders_on_creation: (e.ignore_folders_on_creation ?? []).filter(
        (n) => n.folder,
      ),
    });
  typeof e.intellisense_render == "number" &&
    (i.intellisense_render = String(e.intellisense_render));
  for (let n of [
    "trigger_on_file_creation",
    "enable_system_commands",
    ...
    delete i[n];
  return { settings: i, affectedSecuritySettings: t, wasMigrated: !0 };
}
var ii = $(require("obsidian"));
var Yt;
(function (r) {
  ((r[(r.InsertTemplate = 0)] = "InsertTemplate"),
    (r[(r.CreateNoteTemplate = 1)] = "CreateNoteTemplate"));
})(Yt || (Yt = {}));
var ln = class extends ii.FuzzySuggestModal {
  constructor(t) {
    super(t.app);
    ((this.plugin = t),
  ...
  getItems() {
    ...
    let t = je(
      () => Re(this.plugin.app, this.plugin.settings.templates_folder),
  ...
  getItemText(t) {
    let r = t.path;
    if (
      t.path.startsWith(this.plugin.settings.templates_folder) &&
      (0, ii.normalizePath)(this.plugin.settings.templates_folder) != "/"
    ) {
      let i = this.plugin.settings.templates_folder.length,
        n;
      (i === 0
        ? (n = 0)
  ...
  onChooseItem(t) {
    switch (this.open_mode) {
      case 0:
        this.plugin.templater.append_template_to_active_file(t);
        break;
      case 1:
  ...
  start() {
    try {
      ...
      le(t instanceof Error ? t : new Error(String(t)));
    }
  }
  insert_template() {
    ((this.open_mode = 0), this.start());
  }
  create_new_note_from_template(t) {
    ((this.creation_folder = t), (this.open_mode = 1), this.start());
  }
};
var Ra = "Error_MobileUnsupportedTemplate",
  Va =
...
var pn = class extends he {
  ...
  async teardown() {}
  generate_now() {
    return (t = "YYYY-MM-DD", r, i, n) => {
      if (i && !(0, tt.moment)(i, n).isValid())
        throw new C(
      ...
      return (
        typeof r == "string"
          ? (a = tt.moment.duration(r))
          : typeof r == "number" && (a = tt.moment.duration(r, "days")),
        (0, tt.moment)(i, n).add(a).format(t)
      );
    };
  }
  generate_tomorrow() {
    return (t = "YYYY-MM-DD") => (0, tt.moment)().add(1, "days").format(t);
  }
  generate_weekday() {
    return (t = "YYYY-MM-DD", r, i, n) => {
      if (i && !(0, tt.moment)(i, n).isValid())
      ...
      return (0, tt.moment)(i, n).weekday(r).format(t);
    };
  }
  generate_yesterday() {
    return (t = "YYYY-MM-DD") => (0, tt.moment)().add(-1, "days").format(t);
...
var Ha = 10,
  fn = class extends he {
    ...
    generate_create_new() {
      return async (t, r, i = !1, n) => {
        if (((this.create_new_depth += 1), this.create_new_depth > Ha))
          throw (
            (this.create_new_depth = 0),
            new C("Reached create_new depth limit (max = 10)")
          );
        let a = await this.plugin.templater.create_new_note_from_template(
          t,
          n,
          r,
          i,
        );
        return ((this.create_new_depth -= 1), a);
      };
    }
    generate_creation_date() {
      return (t = "YYYY-MM-DD HH:mm") =>
        (0, ee.moment)(this.config.target_file.stat.ctime).format(t);
    }
    generate_cursor() {
      return (t) => `<% tp.file.cursor(${t ?? ""}) %>`;
    }
    generate_cursor_append() {
      return (t) => {
        let r = this.plugin.app.workspace.activeEditor;
        if (!r || !r.editor) {
          le(new C("No active editor, can't append to cursor."));
          return;
        }
        return (r.editor.getDoc().replaceSelection(t), "");
      };
    }
    generate_exists() {
      return async (t) => {
        let r = (0, ee.normalizePath)(t);
        return await this.plugin.app.vault.exists(r);
      };
    }
    generate_find_tfile() {
      return (t) => {
        let r = (0, ee.normalizePath)(t);
        return this.plugin.app.metadataCache.getFirstLinkpathDest(r, "");
      };
    }
    generate_folder() {
      return (t = !1) => {
        let r = this.config.target_file.parent;
        if (!(r instanceof ee.TFolder)) return "";
        let i;
        return (t ? (i = r.path) : (i = r.name), i);
      };
    }
    generate_include() {
      return async (t) => {
        if (((this.include_depth += 1), this.include_depth > Ha))
          throw (
            (this.include_depth -= 1),
            new C("Reached inclusion depth limit (max = 10)")
          );
        let r;
        if (t instanceof ee.TFile) r = await this.plugin.app.vault.read(t);
        else {
          let i;
          if ((i = this.linkpath_regex.exec(t)) === null)
            throw (
              (this.include_depth -= 1),
              new C(
          ...
          let { path: n, subpath: a } = (0, ee.parseLinktext)(i[1]),
            s = this.plugin.app.metadataCache.getFirstLinkpathDest(n, "");
          if (!s)
            throw ((this.include_depth -= 1), new C(`File ${t} doesn't exist`));
          if (((r = await this.plugin.app.vault.read(s)), a)) {
            let c = this.plugin.app.metadataCache.getFileCache(s);
            if (c) {
              let l = (0, ee.resolveSubpath)(c, a);
              l && (r = r.slice(l.start.offset, l.end?.offset));
            }
          }
        }
        try {
          let i = await this.plugin.templater.parser.parse_commands(
            r,
            this.plugin.templater.current_functions_object,
          );
          return ((this.include_depth -= 1), i);
        } catch (i) {
          throw ((this.include_depth -= 1), i);
        }
      };
    }
    generate_last_modified_date() {
      return (t = "YYYY-MM-DD HH:mm") =>
        (0, ee.moment)(this.config.target_file.stat.mtime).format(t);
    }
    generate_move() {
      return async (t, r) => {
        let i = r || this.config.target_file,
          n = (0, ee.normalizePath)(`${t}.${i.extension}`),
          a = n.replace(/\\/g, "/").split("/");
        if ((a.pop(), a.length)) {
          let s = a.join("/");
          this.plugin.app.vault.getAbstractFileByPath(s) ||
            (await this.plugin.app.vault.createFolder(s));
        }
        return (await this.plugin.app.fileManager.renameFile(i, n), "");
      };
    }
    generate_path() {
      return (t = !1) => {
        let r = "";
        if (ee.Platform.isMobile) {
          let i = this.plugin.app.vault.adapter.fs.uri,
            n = this.plugin.app.vault.adapter.basePath;
          r = `${i}/${n}`;
        } else if (
          this.plugin.app.vault.adapter instanceof ee.FileSystemAdapter
        )
          r = this.plugin.app.vault.adapter.getBasePath();
        else throw new C("app.vault is not a FileSystemAdapter instance");
        return t
          ? this.config.target_file.path
          : `${r}/${this.config.target_file.path}`;
      };
    }
    generate_rename() {
      return async (t) => {
        ...
        let r = this.config.target_file.parent;
        if (!(r instanceof ee.TFolder)) return "";
        let i = (0, ee.normalizePath)(
          `${r.path}/${t}.${this.config.target_file.extension}`,
        );
        return (
    ...
    generate_selection() {
      return () => {
        ...
        if (!t || !t.editor)
          throw new C("Active editor is null, can't read selection.");
        return t.editor.getSelection();
      };
    }
    generate_tags() {
      let t = this.plugin.app.metadataCache.getFileCache(
        this.config.target_file,
      );
      return t ? (0, ee.getAllTags)(t) : null;
    }
    generate_title() {
...
var Ka = "en",
  ...
  hn = class extends he {
    ...
    async getRequest(t) {
      try {
        let r = await (0, ni.requestUrl)(t);
        if (r.status < 200 && r.status >= 300)
          throw new C("Error performing GET request");
        return r;
      } catch {
        throw new C("Error performing GET request");
      }
    ...
    generate_daily_quote() {
      return async (t) => {
        try {
          let r = (t || (0, ni.getLanguage)() || Ka).toLowerCase(),
            i = Ua[r] ?? Ua[Ka],
            a = (await this.getRequest(i)).json,
...
> \u2014 ${l}`;
          ...
          return (
            new C("Error generating daily quote"),
    ...
    generate_random_picture() {
      return async (t, r, i = !1) => {
        try {
          let n = await this.getRequest(
              `https://templater-unsplash-2.fly.dev/${r ? "?q=" + r : ""}`,
            ).then((s) => s.json),
            a = n.full;
          if (t && !i)
            if (t.includes("x")) {
          ...
          return i
            ? `![photo by ${n.photog}(${n.photogUrl}) on Unsplash|${t}](${a})`
            : `![photo by ${n.photog}(${n.photogUrl}) on Unsplash](${a})`;
        } catch {
          return (
            new C("Error generating random picture"),
    ...
    generate_request() {
      return async (t, r) => {
        try {
          let n = (await this.getRequest(t)).json;
          return r && n
            ? r.split(".").reduce((a, s) => {
                if (Object.prototype.hasOwnProperty.call(a, s)) return a[s];
                throw new Error(`Path ${r} not found in the JSON response`);
              }, n)
            : n;
        } catch (i) {
          throw (
            console.error(i),
            new C("Error fetching and extracting value")
          );
        }
      };
    }
...
var dn = class extends he {
  ...
  generate_on_all_templates_executed() {
    return (t) => {
      let r = this.plugin.app.workspace.on(
        "templater:all-templates-executed",
        async () => {
          (await lt(1), t());
        },
      );
      r && this.event_refs.push(r);
    };
  }
};
var mn = class extends he {
  ...
  async create_static_templates() {}
  async create_dynamic_templates() {
    let t = this.plugin.app.metadataCache.getFileCache(this.config.target_file);
    this.dynamic_functions = new Map(Object.entries(t?.frontmatter || {}));
  }
  async teardown() {}
};
var He = $(require("obsidian"));
var gn = class extends He.Modal {
  constructor(t, r, i, n, a) {
    super(t);
    this.prompt_text = r;
    this.default_value = i;
    this.multi_line = n;
    this.select_default_value = a;
    this.submitted = !1;
  }
  onOpen() {
  ...
  onClose() {
    (this.contentEl.empty(),
      this.submitted || this.reject(new C("Cancelled prompt")));
  }
  createForm() {
    let t = this.contentEl.createDiv();
    t.addClass("templater-prompt-div");
    let r;
    this.multi_line
      ? (r = new He.TextAreaComponent(t))
      : (r = new He.TextComponent(t));
    let i = this.contentEl.createDiv();
    i.addClass("templater-button-div");
    let n = new He.ButtonComponent(i);
    (n.buttonEl.addClass("mod-cta"),
      n.setButtonText("Submit").onClick((a) => {
        this.resolveAndClose(a);
      }),
      (this.value = this.default_value ?? ""),
      r.inputEl.addClass("templater-prompt-input"),
      r.setPlaceholder("Type text here"),
      r.setValue(this.value),
      r.onChange((a) => (this.value = a)),
      r.inputEl.focus(),
      this.select_default_value && r.inputEl.select(),
      r.inputEl.addEventListener("keydown", (a) => this.enterCallback(a)));
  }
  enterCallback(t) {
    t.isComposing ||
      t.keyCode === 229 ||
      (this.multi_line
        ? He.Platform.isDesktop &&
          t.key === "Enter" &&
          !t.shiftKey &&
          this.resolveAndClose(t)
        : t.key === "Enter" && this.resolveAndClose(t));
  }
  resolveAndClose(t) {
    ((this.submitted = !0),
      t.preventDefault(),
  ...
  async openAndGetValue(t, r) {
    ((this.resolve = t), (this.reject = r), this.open());
  }
};
var $a = $(require("obsidian")),
  An = class extends $a.FuzzySuggestModal {
    ...
    selectSuggestion(t, r) {
      ((this.submitted = !0), this.close(), this.onChooseSuggestion(t, r));
    }
    getItemText(t) {
      return this.text_items instanceof Function
        ? this.text_items(t)
        : this.text_items[this.items.indexOf(t)] || "Undefined Text Item";
    }
    onChooseItem(t) {
      this.resolve(t);
    }
...
var be = $(require("obsidian")),
  _n = class extends be.Modal {
    constructor(t, r, i, n, a, s) {
      ...
      let c = this.contentEl.createDiv("templater-multisuggester-div"),
        l = new be.TextComponent(c);
      (l.inputEl.addClass("templater-multisuggester-input"),
        (this.suggester = new Ga(
          t,
          l.inputEl,
          (m) => this.getItemText(m),
          i,
          a,
        ).onSelect((m) => this.onChooseItem(m))));
      let h = this.contentEl.createDiv("modal-button-container");
      (new be.ButtonComponent(h)
        .setButtonText("Save")
        .setCta()
        .onClick(() => this.save()),
        new be.ButtonComponent(h)
    ...
    display() {
      (this.listEl.empty(),
        this.selectedItems.forEach((t) => {
          let r = this.listEl.createDiv("mobile-option-setting-item");
          (r
            .createSpan("mobile-option-setting-item-name")
            .setText(this.getItemText(t)),
            r.createDiv(
              "clickable-icon mobile-option-setting-item-option-icon",
              (i) => {
                ((0, be.setIcon)(i, "lucide-x"),
    ...
    onChooseItem(t) {
      (this.selectedItems.push(t), this.processSelectedItems());
    }
    ...
    onRemoveItem(t) {
      this.selectedItems = this.selectedItems.filter((i) => i !== t);
      let r = this.items.filter(
        (i) => !this.selectedItems.some((n) => n === i),
      );
      (this.suggester.setItems(r), this.display());
    }
    save() {
  ...
  Ga = class extends be.AbstractInputSuggest {
    constructor(t, r, i, n, a) {
      super(t, r);
      this.getItemText = i;
      this.items = n;
    ...
    getSuggestions(t) {
      let r = (0, be.prepareFuzzySearch)(t);
      return this.items.reduce((i, n) => {
        let a = this.getItemText(n);
        return (r(a) && i.push(n), i);
      }, []);
    }
    renderSuggestion(t, r) {
      r.createDiv("suggestion-content").setText(this.getItemText(t));
    }
    setItems(t) {
      this.items = t;
    }
    selectSuggestion(t, r) {
      (this.setValue(""), this.close(), super.selectSuggestion(t, r));
    }
  };
var xn = class extends he {
  constructor() {
    super(...arguments);
    this.name = "system";
  }
  ...
  generate_prompt() {
    return async (t, r, i = !1, n = !1, a = !1) => {
      let s = new gn(this.plugin.app, t, r, n, a),
        c = new Promise((l, h) => {
          s.openAndGetValue(l, h);
        });
      try {
        return await c;
      } catch (l) {
  ...
  generate_suggester() {
    return async (t, r, i = !1, n = "", a, s) => {
      let c = new An(this.plugin.app, t, r, n, a, s),
        l = new Promise((h, m) => {
          c.openAndGetValue(h, m);
        });
      try {
        return await l;
      } catch (h) {
  ...
  generate_multi_suggester() {
    return async (t, r, i = !1, n = "", a, s) => {
      let c = new _n(this.plugin.app, t, r, n, a, s),
        l = new Promise((h, m) => {
          c.openAndGetValue(h, m);
        });
      try {
...
var vn = class {
  constructor(t) {
    this.plugin = t;
    this.modules_array = [];
    (this.modules_array.push(new pn(this.plugin)),
      this.modules_array.push(new fn(this.plugin)),
      this.modules_array.push(new hn(this.plugin)),
      this.modules_array.push(new mn(this.plugin)),
      this.modules_array.push(new dn(this.plugin)),
      this.modules_array.push(new xn(this.plugin)),
      this.modules_array.push(new yn(this.plugin)));
  }
  async init() {
    for (let t of this.modules_array) await t.init();
  }
  async teardown() {
    for (let t of this.modules_array) await t.teardown();
  }
  async generate_object(t) {
    let r = {};
    for (let i of this.modules_array)
      r[i.getName()] = await i.generate_object(t);
    return r;
  }
};
...
var bn = class {
  constructor(t) {
    this.plugin = t;
    if (
      Ar.Platform.isMobile ||
      !(this.plugin.app.vault.adapter instanceof Ar.FileSystemAdapter)
    )
      this.cwd = "";
    else {
      this.cwd = this.plugin.app.vault.adapter.getBasePath();
      let { promisify: r } = require("util"),
        { exec: i } = require("child_process");
      this.exec_promise = r(i);
    }
  }
  async generate_system_functions(t) {
    let r = new Map(),
      i = await this.plugin.templater.functions_generator.generate_object(
        t,
        Ke.INTERNAL,
      );
    for (let n of this.plugin.settings.templates_pairs) {
      let a = n[0],
        s = n[1];
      !a ||
        !s ||
        (Ar.Platform.isMobile
          ? r.set(a, () => new Promise((c) => c(Ra)))
          : ((s = await this.plugin.templater.parser.parse_commands(s, i)),
            r.set(a, async (c) => {
              ...
              try {
                let { stdout: m } = await this.exec_promise(s, h);
                return m.trimRight();
              } catch (m) {
                throw new C(
                  `Error with User Template ${a}`,
  ...
  async generate_object(t) {
    let r = await this.generate_system_functions(t);
...
var wn = class {
  ...
  async generate_user_script_functions() {
    ...
    if (!r) return new Map();
    for (let i of r)
      i.extension.toLowerCase() === "js" &&
        (await this.load_user_script_function(i, t));
    return t;
  }
  async load_user_script_function(t, r) {
    let i = (l) => window.require && window.require(l),
      n = {},
      a = { exports: n },
      s = await this.plugin.app.vault.read(t);
    try {
      window.eval(
      ...
      throw new C(
        `Failed to load user script at "${t.path}".`,
        l instanceof Error ? l.message : String(l),
      );
    }
    let c = n.default ?? a.exports;
    if (!c)
      throw new C(
        `Failed to load user script at "${t.path}". No exports detected.`,
      );
    if (typeof c == "function") r.set(t.basename, c);
    else if (typeof c == "object" && c !== null) {
      if (!Object.values(c).every((h) => typeof h == "function"))
        throw new C(
          `Exported object in "${t.path}" must contain only functions.`,
        );
      r.set(t.basename, c);
    } else
      throw new C(
        `Invalid export in "${t.path}". Must be a function or object of functions.`,
      );
  }
  async generate_object() {
    let t = await this.generate_user_script_functions();
...
var kn = class {
  constructor(t) {
    this.plugin = t;
    ((this.user_system_functions = new bn(t)),
      (this.user_script_functions = new wn(t)));
  }
  async generate_object(t) {
    let r = {},
      i = {};
    return (
      Ve(this.plugin.app).enable_system_commands &&
        (r = await this.user_system_functions.generate_object(t)),
      this.plugin.settings.user_scripts_folder &&
        (i = await this.user_script_functions.generate_object()),
      { ...r, ...i }
    );
  }
};
var cc = $(require("obsidian")),
  Ke;
(function (r) {
  ((r[(r.INTERNAL = 0)] = "INTERNAL"),
    (r[(r.USER_INTERNAL = 1)] = "USER_INTERNAL"));
})(Ke || (Ke = {}));
var jn = class {
  constructor(t) {
    this.plugin = t;
    ((this.internal_functions = new vn(this.plugin)),
      (this.user_functions = new kn(this.plugin)));
  }
  async init() {
  ...
  additional_functions() {
    return { app: this.plugin.app, obsidian: cc };
  }
  async generate_object(t, r = 1) {
    let i = {},
      n = this.additional_functions(),
      a = await this.internal_functions.generate_object(t),
      s = {};
    switch ((Object.assign(i, n), r)) {
      case 0:
        Object.assign(i, a);
        break;
      case 1:
        ((s = await this.user_functions.generate_object(t)),
          Object.assign(i, { ...a, user: s }));
        break;
    }
    return i;
  }
...
var Ya = new TextDecoder("utf-8", { ignoreBOM: !0, fatal: !0 });
Ya.decode();
var ai = new Uint8Array();
function si() {
  return (ai.byteLength === 0 && (ai = new Uint8Array(S.memory.buffer)), ai);
}
function ht(e, t) {
  return Ya.decode(si().subarray(e, e + t));
}
function dt(e) {
  _r === Fe.length && Fe.push(Fe.length + 1);
  let t = _r;
  return ((_r = Fe[t]), (Fe[t] = e), t);
}
var Be = 0,
  oi = new TextEncoder("utf-8"),
  lc =
...
function rt(e, t, r) {
  ...
  if (s !== i) {
    (s !== 0 && (e = e.slice(s)), (n = r(n, i, (i = s + e.length * 3))));
    let c = si().subarray(n + s, n + i);
    s += lc(e, c).written;
  }
  return ((Be = s), n);
}
...
var ci = new Int32Array();
function ke() {
  return (ci.byteLength === 0 && (ci = new Int32Array(S.memory.buffer)), ci);
}
function En(e) {
  let t = typeof e;
...
var ui = 32;
function hc(e) {
  if (ui == 1) throw new Error("out of js stack");
  return ((Fe[--ui] = e), ui);
}
function Sn(e, t) {
  try {
    ...
    S.__wbindgen_exn_store(dt(r));
  }
}
var St = class {
    static __wrap(t) {
      let r = Object.create(St.prototype);
      return ((r.ptr = t), r);
    }
    __destroy_into_raw() {
      let t = this.ptr;
    ...
    free() {
      ...
      S.__wbg_parserconfig_free(t);
    }
    get interpolate() {
      let t = S.__wbg_get_parserconfig_interpolate(this.ptr);
      return String.fromCodePoint(t);
    }
    set interpolate(t) {
      S.__wbg_set_parserconfig_interpolate(this.ptr, t.codePointAt(0));
    }
    get execution() {
      let t = S.__wbg_get_parserconfig_execution(this.ptr);
      return String.fromCodePoint(t);
    }
    set execution(t) {
      S.__wbg_set_parserconfig_execution(this.ptr, t.codePointAt(0));
    }
    get single_whitespace() {
      let t = S.__wbg_get_parserconfig_single_whitespace(this.ptr);
      return String.fromCodePoint(t);
    }
    set single_whitespace(t) {
      S.__wbg_set_parserconfig_single_whitespace(this.ptr, t.codePointAt(0));
    }
    get multiple_whitespace() {
      let t = S.__wbg_get_parserconfig_multiple_whitespace(this.ptr);
      return String.fromCodePoint(t);
    }
    set multiple_whitespace(t) {
      S.__wbg_set_parserconfig_multiple_whitespace(this.ptr, t.codePointAt(0));
    }
    constructor(t, r, i, n, a, s, c) {
      let l = rt(t, S.__wbindgen_malloc, S.__wbindgen_realloc),
        h = Be,
        m = rt(r, S.__wbindgen_malloc, S.__wbindgen_realloc),
        _ = Be,
        k = rt(c, S.__wbindgen_malloc, S.__wbindgen_realloc),
        F = Be,
        O = S.parserconfig_new(
          l,
          h,
          m,
          _,
    ...
    get opening_tag() {
      try {
        ...
        S.parserconfig_opening_tag(i, this.ptr);
        var t = ke()[i / 4 + 0],
          r = ke()[i / 4 + 1];
        return ht(t, r);
      } finally {
        (S.__wbindgen_add_to_stack_pointer(16), S.__wbindgen_free(t, r));
      }
    }
    set opening_tag(t) {
      let r = rt(t, S.__wbindgen_malloc, S.__wbindgen_realloc),
        i = Be;
      S.parserconfig_set_opening_tag(this.ptr, r, i);
    }
    get closing_tag() {
      try {
        let i = S.__wbindgen_add_to_stack_pointer(-16);
        S.parserconfig_closing_tag(i, this.ptr);
        var t = ke()[i / 4 + 0],
          r = ke()[i / 4 + 1];
        return ht(t, r);
      } finally {
    ...
    set closing_tag(t) {
      let r = rt(t, S.__wbindgen_malloc, S.__wbindgen_realloc),
        i = Be;
      S.parserconfig_set_closing_tag(this.ptr, r, i);
    }
    get global_var() {
      try {
        let i = S.__wbindgen_add_to_stack_pointer(-16);
        S.parserconfig_global_var(i, this.ptr);
        var t = ke()[i / 4 + 0],
          r = ke()[i / 4 + 1];
        return ht(t, r);
      } finally {
    ...
    set global_var(t) {
      let r = rt(t, S.__wbindgen_malloc, S.__wbindgen_realloc),
        i = Be;
      S.parserconfig_set_global_var(this.ptr, r, i);
    }
  },
  zt = class {
    static __wrap(t) {
      let r = Object.create(zt.prototype);
      return ((r.ptr = t), r);
    }
    __destroy_into_raw() {
      let t = this.ptr;
    ...
    free() {
      let t = this.__destroy_into_raw();
      S.__wbg_renderer_free(t);
    }
    constructor(t) {
      fc(t, St);
      var r = t.ptr;
      t.ptr = 0;
      let i = S.renderer_new(r);
      return zt.__wrap(i);
    }
    render_content(t, r) {
      try {
        let s = S.__wbindgen_add_to_stack_pointer(-16),
          c = rt(t, S.__wbindgen_malloc, S.__wbindgen_realloc),
          l = Be;
        S.renderer_render_content(s, this.ptr, c, l, hc(r));
        var i = ke()[s / 4 + 0],
          n = ke()[s / 4 + 1],
          a = ke()[s / 4 + 2];
        if (a) throw Tn(n);
        ...
        (S.__wbindgen_add_to_stack_pointer(16), (Fe[ui++] = void 0));
      }
    }
  };
...
function mc() {
  ...
  return (
    ...
    (e.wbg.__wbindgen_string_get = function (t, r) {
      let i = we(r),
        n = typeof i == "string" ? i : void 0;
      var a = pc(n) ? 0 : rt(n, S.__wbindgen_malloc, S.__wbindgen_realloc),
        s = Be;
      ((ke()[t / 4 + 1] = s), (ke()[t / 4 + 0] = a));
    }),
    (e.wbg.__wbg_call_97ae9d8645dc388b = function () {
      return Sn(function (t, r) {
        let i = we(t).call(we(r));
        return dt(i);
      }, arguments);
    }),
    (e.wbg.__wbg_new_8d2af00bc1e329ee = function (t, r) {
      let i = new Error(ht(t, r));
      return dt(i);
    }),
    (e.wbg.__wbg_message_fe2af63ccc8985bc = function (t) {
      let r = we(t).message;
      return dt(r);
    }),
    (e.wbg.__wbg_newwithargs_8fe23e3842840c8e = function (t, r, i, n) {
      let a = new Function(ht(t, r), ht(i, n));
      return dt(a);
    }),
    (e.wbg.__wbg_call_168da88779e35f61 = function () {
      return Sn(function (t, r, i) {
        let n = we(t).call(we(r), we(i));
        return dt(n);
      }, arguments);
    }),
    (e.wbg.__wbg_call_3999bee59e9f7719 = function () {
      return Sn(function (t, r, i, n) {
        let a = we(t).call(we(r), we(i), we(n));
        return dt(a);
      }, arguments);
    }),
    (e.wbg.__wbindgen_debug_string = function (t, r) {
      let i = En(we(r)),
        n = rt(i, S.__wbindgen_malloc, S.__wbindgen_realloc),
        a = Be;
      ((ke()[t / 4 + 1] = a), (ke()[t / 4 + 0] = n));
    }),
    (e.wbg.__wbindgen_throw = function (t, r) {
      throw new Error(ht(t, r));
    }),
    e
  );
}
...
async function za(e) {
  typeof e == "undefined" && (e = new URL("rusty_engine_bg.wasm", _c.url));
  let t = mc();
  ((typeof e == "string" ||
    ...
    (e = fetch(e)),
    gc(t));
  let { instance: r, module: i } = await dc(await e, t);
  return Ac(r, i);
}
var Wa = za;
var Ja = Aa(
...
var Cn = class {
  async init() {
    await Wa(Ja);
    let t = new St("<%", "%>", "\0", "*", "-", "_", "tR");
    this.renderer = new zt(t);
  }
  async parse_commands(t, r) {
    return this.renderer.render_content(t, r);
  }
};
var Ue;
(function (s) {
  ((s[(s.CreateNewFromTemplate = 0)] = "CreateNewFromTemplate"),
    (s[(s.AppendActiveFile = 1)] = "AppendActiveFile"),
    (s[(s.OverwriteFile = 2)] = "OverwriteFile"),
    (s[(s.OverwriteActiveFile = 3)] = "OverwriteActiveFile"),
    (s[(s.DynamicProcessor = 4)] = "DynamicProcessor"),
    (s[(s.StartupTemplate = 5)] = "StartupTemplate"));
})(Ue || (Ue = {}));
var Wt = class {
  constructor(t) {
    this.plugin = t;
    ((this.functions_generator = new jn(this.plugin)),
      (this.parser = new Cn()));
  }
  async setup() {
    ((this.files_with_pending_templates = new Set()),
      ...
      this.plugin.registerMarkdownPostProcessor((t, r) =>
        this.process_dynamic_templates(t, r),
      ));
  }
  create_running_config(t, r, i) {
    let n = ft(this.plugin.app);
    return { template_file: t, target_file: r, run_mode: i, active_file: n };
  }
  async read_and_parse_template(t) {
    if (!(t.template_file instanceof X.TFile))
      throw new C("Template file is not a TFile");
    let r = await this.plugin.app.vault.read(t.template_file);
    return this.parse_template(t, r);
  }
  async parse_template(t, r) {
    let i = await this.functions_generator.generate_object(t, Ke.USER_INTERNAL);
    return (
      (this.current_functions_object = i),
      await this.parser.parse_commands(r, i)
    );
  }
  start_templater_task(t) {
    this.files_with_pending_templates.add(t);
  }
  async end_templater_task(t) {
    (this.files_with_pending_templates.delete(t),
  ...
  async create_new_note_from_template(t, r, i, n = !0) {
    if (!r)
      switch (this.plugin.app.vault.getConfig("newFileLocation")) {
        case "current": {
          let _ = ft(this.plugin.app);
          _ && (r = _.parent instanceof X.TFolder ? _.parent : void 0);
          break;
        }
        case "folder":
          r = this.plugin.app.fileManager.getNewFileParent("");
          break;
        case "root":
          r = this.plugin.app.vault.getRoot();
          break;
        default:
          break;
      }
    let a = (t instanceof X.TFile && t.extension) || "md",
      s = await de(async () => {
        let m = r instanceof X.TFolder ? r.path : r,
          _ = this.plugin.app.vault.getAvailablePath(
            (0, X.normalizePath)(`${m ?? ""}/${i || "Untitled"}`),
            a,
          ),
          k = Xr(_);
        return (
    ...
    if (s == null) return;
    let { path: c } = s;
    this.start_templater_task(c);
    let l, h;
    if (
      (t instanceof X.TFile
        ? ((l = this.create_running_config(t, s, 0)),
          (h = await de(
            async () => this.read_and_parse_template(l),
            "Template parsing error, aborting.",
          )))
        : ((l = this.create_running_config(void 0, s, 0)),
          (h = await de(
            async () => this.parse_template(l, t),
            "Template parsing error, aborting.",
          ))),
      h == null)
    ) {
      (await this.plugin.app.vault.delete(s), await this.end_templater_task(c));
      return;
    }
    if (
      (await this.plugin.app.vault.modify(s, h),
      ...
      if (!m) {
        le(new C("No active leaf"));
        return;
      }
      (await m.openFile(s, { state: { mode: "source" } }),
        await this.plugin.editor_handler.jump_to_next_cursor_location(s, !0),
        this.plugin.settings.jump_to_cursor_after_file_name ||
          m.setEphemeralState({ rename: "all" }));
    }
    return (await this.end_templater_task(c), s);
  }
  async append_template_to_active_file(t) {
    let r = this.plugin.app.workspace.getActiveViewOfType(X.MarkdownView),
      i = this.plugin.app.workspace.activeEditor;
    if (!i || !i.file || !i.editor) {
      le(new C("No active editor, can't append templates."));
      return;
    }
    let { path: n } = i.file;
    this.start_templater_task(n);
    let a = this.create_running_config(t, i.file, 1),
      s = await de(
    ...
    let { content: c, frontmatter: l } = dr(s),
      m = i.editor.getDoc(),
      _ = m.listSelections();
    (m.replaceSelection(c),
      r &&
        (Object.keys(l).length > 0 &&
          r instanceof X.MarkdownView &&
          typeof r.metadataEditor?.insertProperties == "function" &&
          r.metadataEditor.insertProperties(l),
        await lt(100),
        await r.save()),
      ...
      await this.plugin.editor_handler.jump_to_next_cursor_location(i.file, !0),
      await this.end_templater_task(n));
  }
  async write_template_to_file(t, r) {
    let { path: i } = r;
    this.start_templater_task(i);
    let n = this.plugin.app.workspace.getActiveViewOfType(X.MarkdownView),
      a = this.plugin.app.workspace.activeEditor,
      s = ft(this.plugin.app),
      c = this.create_running_config(t, r, 2),
      l = await de(
    ...
    let { content: h, frontmatter: m } = dr(l);
    if (s?.path === r.path && a && a.editor && n) {
      let _ = "",
        { content: k, frontmatter: F } = dr(a.editor.getValue());
      (Zr(F, m),
...
`),
        (_ += k + h),
        a.editor.setValue(_),
        a.editor.setSelection({ line: 0, ch: 0 }, { line: 0, ch: 0 }),
        await lt(100),
        await n.save());
    } else
      await this.plugin.app.vault.process(r, (_) => {
        let k = "",
          { content: F, frontmatter: O } = dr(_);
        return (
          Zr(O, m),
...
`),
    ...
    (this.plugin.app.workspace.trigger("templater:new-note-from-template", {
      ...
      await this.plugin.editor_handler.jump_to_next_cursor_location(r, !0),
      this.plugin.settings.jump_to_cursor_after_file_name &&
        a?.editor &&
        a.editor.focus(),
      await this.end_templater_task(i));
  ...
  async overwrite_active_file_commands() {
    let t = this.plugin.app.workspace.activeEditor;
    if (!t || !t.file) {
      le(new C("Active editor is null, can't overwrite content"));
      return;
    }
    await this.overwrite_file_commands(t.file, !0);
  }
  async overwrite_file_commands(t, r = !1) {
    let { path: i } = t;
    this.start_templater_task(i);
    let n = this.create_running_config(t, t, r ? 3 : 2),
      a = await de(
        async () => this.read_and_parse_template(n),
        "Template parsing error, aborting.",
      );
    if (a == null) {
      await this.end_templater_task(i);
  ...
  async process_dynamic_templates(t, r) {
    let i = Ea(),
      n = activeDocument.createNodeIterator(t, NodeFilter.SHOW_TEXT),
      a,
      s = !1,
      c;
    for (; (a = n.nextNode());) {
      ...
      if (l !== null) {
        ...
        if (h !== null) {
          ...
          if (!m || !(m instanceof X.TFile)) return;
          if (!s) {
            s = !0;
            let _ = this.create_running_config(m, m, 4);
            ((c = await this.functions_generator.generate_object(
              _,
              Ke.USER_INTERNAL,
            )),
              (this.current_functions_object = c));
          }
        }
        for (; h != null;) {
          let m = h[1] + h[2],
            _ = await de(
              async () => await this.parser.parse_commands(m, c),
              `Command Parsing error in dynamic command '${m}'`,
            );
          if (_ == null) return;
          let k = i.lastIndex - h[0].length,
            F = i.lastIndex;
          ((l = l.substring(0, k) + _ + l.substring(F)),
            (i.lastIndex += _.length - h[0].length),
            (h = i.exec(l)));
        }
        a.nodeValue = l;
      }
  ...
  get_new_file_template_for_folder(t) {
    let r = t;
    for (; r instanceof X.TFolder;) {
      let i = r,
        n = this.plugin.settings.folder_templates.find(
          (a) => a.folder == i.path,
        );
  ...
  get_new_file_template_for_file(t) {
    let r = this.plugin.settings.file_templates.find((i) =>
      new RegExp(i.regex).test(t.path),
    );
    if (r && r.template) return r.template;
  }
  static async on_file_creation(t, r, i) {
    if (
      !Ve(r).trigger_on_file_creation ||
      !(i instanceof X.TFile) ||
      i.extension !== "md"
    )
      return;
    let n = (0, X.normalizePath)(t.plugin.settings.templates_folder);
    if (i.path.includes(n) && n !== "/") return;
    for (let l of t.plugin.settings.ignore_folders_on_creation) {
      let h = (0, X.normalizePath)(l.folder);
      if (i.path.startsWith(h) && h !== "") return;
    }
    if ((await lt(300), t.files_with_pending_templates.has(i.path))) return;
    let a = await r.vault.read(i),
      s = (0, X.getFrontMatterInfo)(a),
      c = a.length - s.contentStart;
    if (
      c == 0 &&
      t.plugin.settings.trigger_on_file_creation_mode === "folder"
    ) {
      if (!(i.parent instanceof X.TFolder)) return;
      let l = t.get_new_file_template_for_folder(i.parent);
      if (!l) return;
      let h = await de(async () => pt(r, l), `Couldn't find template ${l}`);
      if (h == null) return;
      await t.write_template_to_file(h, i);
    } else if (
      c == 0 &&
      t.plugin.settings.trigger_on_file_creation_mode === "regex"
    ) {
      let l = t.get_new_file_template_for_file(i);
      if (!l) return;
      let h = await de(async () => pt(r, l), `Couldn't find template ${l}`);
      if (h == null) return;
      await t.write_template_to_file(h, i);
      ...
      let l = 1e5;
      i.stat.size <= l
        ? await t.overwrite_file_commands(i)
        : console.debug(
            `Templater skipped parsing ${i.path} because file size exceeds ${l}`,
          );
    }
  }
  async execute_startup_scripts() {
    if (!!Ve(this.plugin.app).enable_startup_templates)
      for (let t of this.plugin.settings.startup_templates) {
        if (!t) continue;
        let r = je(
          () => pt(this.plugin.app, t),
          `Couldn't find startup template "${t}"`,
        );
        if (!r) continue;
        let { path: i } = r;
        this.start_templater_task(i);
        let n = this.create_running_config(r, r, 5);
        (await de(
          async () => this.read_and_parse_template(n),
...
var li = class {
  ...
  async setup() {
    (this.plugin.app.workspace.onLayoutReady(async () => {
      if (
        Ve(this.plugin.app).trigger_on_file_creation &&
        this.plugin.app.vault.getConfig("openBehavior") === "daily"
      ) {
        let r =
          this.plugin.app.internalPlugins.getEnabledPluginById("daily-notes");
        if (r) {
          let { folder: i, format: n } = r.options,
            a = (0, Jt.normalizePath)(`${i}/${(0, Jt.moment)().format(n)}.md`),
            s = ft(this.plugin.app);
          s?.path === a &&
            (await Wt.on_file_creation(this.templater, this.plugin.app, s));
        }
      }
      this.plugin.registerEvent(
        this.plugin.app.vault.on("create", (t) =>
          Wt.on_file_creation(this.templater, this.plugin.app, t),
        ),
      );
    }),
  ...
  async update_syntax_highlighting() {
    let t = this.plugin.editor_handler.desktopShouldHighlight(),
      r = this.plugin.editor_handler.mobileShouldHighlight();
    t || r
  ...
  update_file_menu() {
    this.plugin.registerEvent(
      this.plugin.app.workspace.on("file-menu", (t, r) => {
        r instanceof Jt.TFolder &&
          t.addItem((i) => {
            i.setTitle("Create new note from template")
              .setIcon("templater-icon")
              .onClick(() => {
                this.plugin.fuzzy_suggester.create_new_note_from_template(r);
              });
          });
      }),
    );
...
var Pn = class {
  constructor(t) {
    this.plugin = t;
    this.registered_hotkey_templates = new Set();
  }
  setup() {
  ...
  register_templates_hotkeys() {
    this.plugin.settings.enabled_templates_hotkeys.forEach((t) => {
      this.add_template_hotkey(t);
    });
  }
  sync_template_hotkeys() {
    for (let t of [...this.registered_hotkey_templates])
      this.remove_template_hotkey(t);
    this.register_templates_hotkeys();
  }
  add_template_hotkey(t) {
    let r = Et(t),
      i = r.template;
    if (!i) return;
    this.remove_template_hotkey(i);
    ...
    (r.insert_enabled &&
      this.plugin.addCommand({
        ...
        callback: async () => {
          let c = s();
          !c || (await this.plugin.templater.append_template_to_active_file(c));
        },
      }),
      r.create_enabled &&
        this.plugin.addCommand({
          ...
          callback: async () => {
            let c = s();
            !c ||
              (await this.plugin.templater.create_new_note_from_template(c));
          },
        }),
      this.registered_hotkey_templates.add(i));
  }
  remove_template_hotkey(t) {
    t &&
      (this.plugin.removeCommand(`${t}`),
      this.plugin.removeCommand(`create-${t}`),
      this.registered_hotkey_templates.delete(t));
  }
  register_cli_handler() {
    this.plugin.registerCliHandler(
      ...
      async (t) => this.handle_create_from_template(t),
    );
  }
  resolve_template_file(t) {
    let r = t;
    r.endsWith(".md") || (r = `${r}.md`);
    try {
      return pt(this.plugin.app, r);
    } catch {
      let i = this.plugin.settings.templates_folder;
      if (i) {
        let n = (0, Ct.normalizePath)(`${i}/${r}`);
        return pt(this.plugin.app, n);
      }
      throw new Error(`Template "${t}" not found`);
    }
  }
  async handle_create_from_template(t) {
    let { template: r, file: i, open: n } = t;
    if (!r) return "Error: template parameter is required";
    if (!i) return "Error: file parameter is required";
    try {
      let a = this.resolve_template_file(r),
        s = (0, Ct.normalizePath)(i),
        c = Xr(s),
        l = s.slice(c.length + 1).replace(/\.md$/, ""),
        h;
      if (c)
        try {
          h = Yi(this.plugin.app, c);
        } catch {}
      let m = n === "true",
        _ = await this.plugin.templater.create_new_note_from_template(
          a,
          h ?? c,
          l,
          m,
        );
      return _ ? _.path : "Error: Failed to create note from template";
    } catch (a) {
...
var Nn = class {
  ...
  async jump_to_next_cursor_location() {
    ...
    if (!t?.editor) return;
    let r = t.editor.getValue(),
      { cursor_matches: i, positions: n } =
        this.get_cursor_matches_and_positions(r);
    if (!n || !i) return;
    let a = t instanceof In.MarkdownView ? t.currentMode.getFoldInfo() : null,
      s = [];
    for (let c = i.length - 1; c >= 0; c--) {
      let l = i[c],
        h = this.get_editor_position_from_index(r, l.index),
        m = this.get_editor_position_from_index(r, l.index + l[0].length);
      s.push({ from: h, to: m, text: "" });
    }
    (t.editor.transaction({
      changes: s,
      selections: n.map((c) => ({ from: c })),
    }),
      a &&
        Array.isArray(a.folds) &&
        (n.forEach((c) => {
          a.folds = a.folds.filter((l) => l.from > c.line || l.to < c.line);
        }),
        t instanceof In.MarkdownView &&
          (t.currentMode.applyFoldInfo(a), await lt(100), await t.save())));
    try {
      if (this.app.vault.getConfig("vimMode")) {
        let c = t.editor.cm.cm;
        window.CodeMirrorAdapter?.Vim.handleKey(c, "i", "mapping");
      }
    } catch (c) {
      console.warn("Templater: Failed to enter insert mode for vim users.", c);
    }
  }
  get_editor_position_from_index(t, r) {
    let i = t.slice(0, r),
      n = 0,
      a = -1,
      s = -1;
...
`,
    ...
    a += 1;
    let c = t.slice(a, r).length;
    return { line: n, ch: c };
  }
  get_cursor_matches_and_positions(t) {
    let r =
        /<%\s*tp\.file\.cursor\((?<order>(?:-?[0-9]+(?:\.[0-9]+)?)?)\)\s*%>/g,
      i = [],
      n;
    for (; (n = r.exec(t)) !== null;) i.push(n);
    if (i.length === 0) return {};
    let a = (_) => Number(_.groups?.order || 0),
      s = (_) => ((_.groups?.order ?? "") === "" ? "" : String(a(_)));
    i.sort((_, k) => a(_) - a(k));
    let c = s(i[0]),
      l = c === "" ? [i[0]] : i.filter((_) => s(_) === c),
      h = [],
      m = 0;
    for (let _ of l) {
      let k = _.index - m;
      (h.push(this.get_editor_position_from_index(t, k)),
        (t = t.slice(0, k) + t.slice(k + _[0].length)),
        (m += _[0].length));
    }
    return { cursor_matches: l, positions: h };
  }
};
...
var yc = [
  ...
  bc = {
    5: Mn,
    "5module": Mn + " export import",
    6: Mn + " const class extends export import super",
  },
  Za = /^in(stanceof)?$/,
  wc = new RegExp("[" + Xa + "]"),
  kc = new RegExp("[" + Xa + vc + "]");
    ...
    : e < 91
      ...
      : e < 97
        ...
        : e < 123
          ? !0
          : e <= 65535
            ? e >= 170 && wc.test(String.fromCharCode(e))
            : t === !1
              ? !1
              : Fn(e, Qa);
}
        ...
        : e < 91
          ...
          : e < 97
            ...
            : e < 123
              ? !0
              : e <= 65535
                ? e >= 170 && kc.test(String.fromCharCode(e))
                : t === !1
                  ? !1
                  : Fn(e, Qa) || Fn(e, yc);
}
...
var Ee = { beforeExpr: !0 },
  ...
  Bn = {};
function R(e, t) {
  return (t === void 0 && (t = {}), (t.keyword = e), (Bn[e] = new K(e, t)));
}
var u = {
    num: new K("num", Ae),
    ...
    _default: R("default", Ee),
    _do: R("do", { isLoop: !0, beforeExpr: !0 }),
    _else: R("else", Ee),
    _finally: R("finally"),
    _for: R("for", { isLoop: !0 }),
    _function: R("function", Ae),
    _if: R("if"),
    _return: R("return", Ee),
    _switch: R("switch"),
    _throw: R("throw", Ee),
...
function es(e, t, r) {
  ...
  for (var i = t; i < r; i++) {
    ...
    if (Qt(n))
      return i < r - 1 && n === 13 && e.charCodeAt(i + 1) === 10
        ? i + 2
        : i + 1;
  }
  return -1;
...
var ts = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/,
  ...
  is =
    Array.isArray ||
    function (e) {
      return Ec.call(e) === "[object Array]";
    },
  ns = Object.create(null);
function gt(e) {
  return ns[e] || (ns[e] = new RegExp("^(?:" + e.replace(/ /g, "|") + ")$"));
}
function it(e) {
  return e <= 65535
...
xr.prototype.offset = function (t) {
  return new xr(this.line, this.column + t);
};
...
function Cc(e) {
  var t = {};
  for (var r in On) t[r] = e && Xt(e, r) ? e[r] : On[r];
  if (
...
Defaulting to 2020, but this will stop working in the future.`)),
  ...
  if (
    (is(t.onComment) && (t.onComment = Pc(t, t.onComment)),
...
function Pc(e, t) {
  return function (r, i, n, a, s, c) {
    var l = { type: r ? "Block" : "Line", value: i, start: n, end: a };
    (e.locations && (l.loc = new pi(this, s, c)),
      e.ranges && (l.range = [n, a]),
      t.push(l));
  };
}
var Pt = 1,
...
var di = 0,
  ...
  ne = function (t, r, i) {
    ((this.options = t = Cc(t)),
      ...
      (this.keywords = gt(
        bc[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5],
      )));
    var n = "";
    (t.allowReserved !== !0 &&
      ((n = Dn[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3]),
      t.sourceType === "module" && (n += " await")),
      (this.reservedWords = gt(n)));
    var a = (n ? n + " " : "") + Dn.strict;
    ((this.reservedWordsStrict = gt(a)),
      (this.reservedWordsStrictBind = gt(a + " " + Dn.strictBind)),
      (this.input = String(r)),
      (this.containsEsc = !1),
      i
        ? ((this.pos = i),
...
`,
      ...
      (this.strict =
        this.inModule || t.strict === !0 || this.strictDirective(this.pos)),
      ...
      (this.scopeStack = []),
      this.enterScope(this.options.sourceType === "commonjs" ? It : Pt),
...
ne.prototype.parse = function () {
  var t = this,
    r = this.options.program || this.startNode();
  return (
    this.nextToken(),
    this.catchStackOverflow(function () {
      return t.parseTopLevel(r);
    })
  );
};
...
Se.allowReturn.get = function () {
  return !!(
    this.inFunction ||
    (this.options.allowReturnOutsideFunction &&
      this.currentVarScope().flags & Pt)
  );
};
Se.allowSuper.get = function () {
  var e = this.currentThisScope(),
    t = e.flags;
  return (t & fi) > 0 || this.options.allowSuperOutsideMethod;
};
...
Se.allowNewDotTarget.get = function () {
  for (var e = this.scopeStack.length - 1; e >= 0; e--) {
    var t = this.scopeStack[e],
      r = t.flags;
    if (r & (Nt | yr) || (r & It && !(r & Ln))) return !0;
  }
  return !1;
};
Se.allowUsing.get = function () {
  var e = this.currentScope(),
    t = e.flags;
  return !(t & ls || (!this.inModule && t & Pt));
};
...
ne.parse = function (t, r) {
  return new this(r, t).parse();
};
ne.parseExpressionAt = function (t, r, i) {
  var n = new this(i, t, r);
  return (n.nextToken(), n.parseExpression());
};
ne.tokenizer = function (t, r) {
  return new this(r, t);
};
...
pe.strictDirective = function (e) {
  ...
  for (;;) {
    ...
    var t = Ic.exec(this.input.slice(e));
    if (!t) return !1;
...
pe.catchStackOverflow = function (e) {
  try {
    return e();
  } catch (t) {
    if (
      t instanceof Error &&
      (/\bstack\b.*\b(exceeded|overflow)\b/i.test(t.message) ||
        /\btoo much recursion\b/i.test(t.message))
    )
...
E.isLet = function (e) {
  ...
  if ($e(i)) {
    var n = r;
    do r += i <= 65535 ? 1 : 2;
    while (mt((i = this.fullCharCodeAt(r))));
    if (i === 92) return !0;
    var a = this.input.slice(n, r);
    if (!Za.test(a)) return !0;
  }
  return !1;
};
E.isAsyncFunction = function () {
  ...
  return (
    ...
    (t + 8 === this.input.length ||
      !(mt((r = this.fullCharCodeAt(t + 8))) || r === 92))
  );
};
E.isUsingKeyword = function (e, t) {
  ...
  se.lastIndex = this.pos;
  var r = se.exec(this.input),
    i = this.pos + r[0].length;
  if (_e.test(this.input.slice(this.pos, i))) return !1;
  if (e) {
    var n = i + 5,
      a;
    if (
      this.input.slice(i, n) !== "using" ||
      n === this.input.length ||
      mt((a = this.fullCharCodeAt(n))) ||
      a === 92
    )
      return !1;
    se.lastIndex = n;
    var s = se.exec(this.input);
    if (((i = n + s[0].length), s && _e.test(this.input.slice(n, i))))
      return !1;
  }
  var c = this.fullCharCodeAt(i);
  if (!$e(c) && c !== 92) return !1;
  var l = i;
  do i += c <= 65535 ? 1 : 2;
  while (mt((c = this.fullCharCodeAt(i))));
  if (c === 92) return !0;
  var h = this.input.slice(l, i);
  if (Za.test(h)) return !1;
  if (t && !e && h === "of") {
    se.lastIndex = i;
    var m = se.exec(this.input);
    if (
      ((i = i + m[0].length),
      this.input.charCodeAt(i) !== 61 ||
        (c = this.input.charCodeAt(i + 1)) === 61 ||
        c === 62)
    )
      return !1;
  }
...
E.parseStatement = function (e, t, r) {
  var i = this.type,
    n = this.startNode(),
    a;
  switch ((this.isLet(e) && ((i = u._var), (a = "let")), i)) {
    case u._break:
    case u._continue:
    ...
    case u._export:
    case u._import:
      if (this.options.ecmaVersion > 10 && i === u._import) {
        se.lastIndex = this.pos;
        var s = se.exec(this.input),
          c = this.pos + s[0].length,
          l = this.input.charCodeAt(c);
        if (l === 40 || l === 46)
      ...
      return (
        ...
        i === u._import ? this.parseImport(n) : this.parseExport(n, r)
      );
    default:
      ...
      return i === u.name && _.type === "Identifier" && this.eat(u.colon)
        ? this.parseLabeledStatement(n, m, _, e)
        : this.parseExpressionStatement(n, _);
  }
};
...
E.parseForStatement = function (e) {
  ...
  var r = this.isLet();
  if (this.type === u._var || this.type === u._const || r) {
  ...
  return this.type === u._in ||
    ...
    ? (t > -1
        ? (this.type === u._in && this.unexpected(t), (e.await = !0))
        : s &&
          this.options.ecmaVersion >= 8 &&
          (k.start === _ && !h && k.type === "Identifier" && k.name === "async"
            ? this.unexpected()
      ...
      this.toAssignable(k, !1, m),
      this.checkLValPattern(k),
      this.parseForIn(e, k))
    : (this.checkExpressionErrors(m, !0),
      t > -1 && this.unexpected(t),
      this.parseFor(e, k));
};
E.parseForAfterInit = function (e, t, r) {
  return (this.type === u._in ||
    ...
    ? (this.type === u._in
        ? ((t.kind === "using" || t.kind === "await using") &&
          ...
          this.options.ecmaVersion >= 9 && r > -1 && this.unexpected(r))
        : this.options.ecmaVersion >= 9 && (e.await = r > -1),
      this.parseForIn(e, t))
    : (r > -1 && this.unexpected(r), this.parseFor(e, t));
};
E.parseFunctionStatement = function (e, t, r) {
  return (this.next(), this.parseFunction(e, vr | (r ? 0 : Kn), !1, t));
};
...
E.parseSwitchStatement = function (e) {
  (this.next(),
    ...
    this.labels.push(Nc),
    this.enterScope(ls));
  for (var t, r = !1; this.type !== u.braceR;)
    if (this.type === u._case || this.type === u._default) {
      var i = this.type === u._case;
...
E.parseCatchClauseParam = function () {
  var e = this.parseBindingAtom(),
    t = e.type === "Identifier";
  return (
    this.enterScope(t ? cs : 0),
    this.checkLValPattern(e, t ? fs : nt),
...
E.parseLabeledStatement = function (e, t, r, i) {
  ...
  for (
    ...
    if (h.statementStart === e.start)
      ((h.statementStart = this.start), (h.kind = c));
    else break;
  }
  return (
...
E.parseVarId = function (e, t) {
  ((e.id =
    ...
    this.checkLValPattern(e.id, t === "var" ? Vn : nt, !1));
};
var vr = 1,
  Kn = 2,
  ds = 4;
E.parseFunction = function (e, t, r, i, n) {
  (this.initFunction(e),
    (this.options.ecmaVersion >= 9 || (this.options.ecmaVersion >= 6 && !i)) &&
      (this.type === u.star && t & Kn && this.unexpected(),
      (e.generator = this.eat(u.star))),
    this.options.ecmaVersion >= 8 && (e.async = !!i),
    t & vr &&
      ((e.id = t & ds && this.type !== u.name ? null : this.parseIdent()),
      e.id &&
        !(t & Kn) &&
  ...
  return (
    ...
    this.enterScope(Rn(e.async, e.generator)),
    t & vr || (e.id = this.type === u.name ? this.parseIdent() : null),
...
E.parseClassElement = function (e) {
  ...
  if (
    ...
    var h = !r.static && gi(r, "constructor"),
      m = h && e;
    (h &&
      s !== "method" &&
      this.raise(r.key.start, "Constructor can't have get/set modifier"),
      (r.kind = h ? "constructor" : s),
      this.parseClassMethod(r, n, a, m));
...
E.parseClassStaticBlock = function (e) {
  e.body = [];
  var t = this.labels;
  for (this.labels = [], this.enterScope(Nt | fi); this.type !== u.braceR;) {
...
E.parseClassId = function (e, t) {
  this.type === u.name
    ? ((e.id = this.parseIdent()), t && this.checkLValSimple(e.id, nt, !1))
...
E.parseExportDefaultDeclaration = function () {
  ...
  if (this.type === u._function || (e = this.isAsyncFunction())) {
    ...
    return (
      this.next(),
      e && this.next(),
      this.parseFunction(t, vr | ds, !1, e)
    );
...
E.checkExport = function (e, t, r) {
  !e ||
    ...
    Xt(e, t) && this.raiseRecoverable(r, "Duplicate export '" + t + "'"),
    (e[t] = !0));
};
E.checkPatternExport = function (e, t) {
  ...
  if (r === "Identifier") this.checkExport(e, t, t.start);
    ...
    for (var s = 0, c = t.elements; s < c.length; s += 1) {
      var l = c[s];
...
E.parseImport = function (e) {
  return (
    this.next(),
    this.type === u.string
      ? ((e.specifiers = Dc), (e.source = this.parseExprAtom()))
...
E.parseImportSpecifier = function () {
  ...
  return (
    ...
    this.checkLValSimple(e.local, nt),
...
E.parseWithClause = function () {
  var e = [];
  if (!this.eat(u._with)) return e;
  this.expect(u.braceL);
  for (var t = {}, r = !0; !this.eat(u.braceR);) {
    if (r) r = !1;
    else if ((this.expect(u.comma), this.afterTrailingComma(u.braceR))) break;
    var i = this.parseImportAttribute(),
      n = i.key.type === "Identifier" ? i.key.name : i.key.value;
    (Xt(t, n) &&
      this.raiseRecoverable(i.key.start, "Duplicate attribute key '" + n + "'"),
      (t[n] = !0),
      e.push(i));
  }
  return e;
...
var Ce = ne.prototype;
Ce.toAssignable = function (e, t, r) {
...
Ce.parseRestBinding = function () {
  ...
  return (
    this.next(),
    this.options.ecmaVersion === 6 && this.type !== u.name && this.unexpected(),
...
Ce.parseBindingList = function (e, t, r, i) {
    ...
    if ((a ? (a = !1) : this.expect(u.comma), t && this.type === u.comma))
      ...
      if (this.type === u.ellipsis) {
        ...
        (this.parseBindingListItem(s),
          ...
          this.expect(e));
        break;
      } else n.push(this.parseAssignableListItem(i));
    }
  return n;
};
...
Ce.parseMaybeDefault = function (e, t, r) {
  if (
...
Ce.checkLValSimple = function (e, t, r) {
  t === void 0 && (t = di);
  var i = t !== di;
  switch (e.type) {
    case "Identifier":
      (this.strict &&
        ...
        i &&
          ...
          r &&
            ...
            (r[e.name] = !0)),
          t !== hs && this.declareName(e.name, t, e.start)));
      break;
    case "ChainExpression":
      this.raiseRecoverable(
        e.start,
...
Ce.checkLValPattern = function (e, t, r) {
  switch ((t === void 0 && (t = di), e.type)) {
    case "ObjectPattern":
      for (var i = 0, n = e.properties; i < n.length; i += 1) {
        var a = n[i];
      ...
      break;
    case "ArrayPattern":
      for (var s = 0, c = e.elements; s < c.length; s += 1) {
        var l = c[s];
...
Ce.checkLValInnerPattern = function (e, t, r) {
  switch ((t === void 0 && (t = di), e.type)) {
    case "Property":
...
var Oe = function (t, r, i, n, a) {
  ...
  Zt = ne.prototype;
Zt.initialContext = function () {
  return [Z.b_stat];
};
Zt.curContext = function () {
  return this.context[this.context.length - 1];
};
Zt.braceIsBlock = function (e) {
  var t = this.curContext();
  return t === Z.f_expr || t === Z.f_stat
    ? !0
    : e === u.colon && (t === Z.b_stat || t === Z.b_expr)
      ? !t.isExpr
...
Zt.inGeneratorContext = function () {
...
u.dollarBraceL.updateContext = function () {
  (this.context.push(Z.b_tmpl), (this.exprAllowed = !0));
};
u.parenL.updateContext = function (e) {
  var t = e === u._if || e === u._for || e === u._with || e === u._while;
  (this.context.push(t ? Z.p_stat : Z.p_expr), (this.exprAllowed = !0));
};
u.incDec.updateContext = function () {};
u._function.updateContext = u._class.updateContext = function (e) {
  (e.beforeExpr &&
  e !== u._else &&
  !(e === u.semi && this.curContext() !== Z.p_stat) &&
  !(
    e === u._return && _e.test(this.input.slice(this.lastTokEnd, this.start))
  ) &&
  !((e === u.colon || e === u.braceL) && this.curContext() === Z.b_stat)
    ? this.context.push(Z.f_expr)
    : this.context.push(Z.f_stat),
    (this.exprAllowed = !1));
};
...
u.backQuote.updateContext = function () {
  (this.curContext() === Z.q_tmpl
    ? this.context.pop()
    : this.context.push(Z.q_tmpl),
    (this.exprAllowed = !1));
};
u.star.updateContext = function (e) {
  if (e === u._function) {
    var t = this.context.length - 1;
    this.context[t] === Z.f_expr
      ? (this.context[t] = Z.f_expr_gen)
      : (this.context[t] = Z.f_gen);
  }
  this.exprAllowed = !0;
};
...
var N = ne.prototype;
N.checkPropClash = function (e, t, r) {
  if (
    ...
    if (s) {
      var c;
      (a === "init"
        ? (c = (this.strict && s.init) || s.get || s.set)
        : (c = s.init || s[a]),
        c && this.raiseRecoverable(i.start, "Redefinition of property"));
...
N.parseExpression = function (e, t) {
  ...
  return this.catchStackOverflow(function () {
    var i = r.start,
      n = r.startLoc,
      a = r.parseMaybeAssign(e, t);
    if (r.type === u.comma) {
      var s = r.startNodeAt(i, n);
      for (s.expressions = [a]; r.eat(u.comma);)
        s.expressions.push(r.parseMaybeAssign(e, t));
      return r.finishNode(s, "SequenceExpression");
    }
    return a;
  });
};
N.parseMaybeAssign = function (e, t, r) {
  ...
  if ((r && (h = r.call(this, h, c, l)), this.type.isAssign)) {
    var m = this.startNodeAt(c, l);
    return (
      (m.operator = this.value),
      this.type === u.eq && (h = this.toAssignable(h, !1, t)),
      i || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1),
      t.shorthandAssign >= h.start && (t.shorthandAssign = -1),
      this.type === u.eq ? this.checkLValPattern(h) : this.checkLValSimple(h),
      (m.left = h),
      this.next(),
...
N.parseMaybeConditional = function (e, t) {
  ...
  if (
    !(n.type === "ArrowFunctionExpression" && n.start === r) &&
    this.eat(u.question)
  ) {
...
N.parseExprOp = function (e, t, r, i, n) {
  var a = this.type.binop;
  if (a != null && (!n || this.type !== u._in) && a > i) {
    var s = this.type === u.logicalOR || this.type === u.logicalAND,
      c = this.type === u.coalesce;
    c && (a = u.logicalAND.binop);
    var l = this.value;
    this.next();
    var h = this.start,
      m = this.startLoc,
      _ = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, n), h, m, a, n),
      k = this.buildBinary(t, r, e, _, l, s || c);
    return (
      ((s && this.type === u.coalesce) ||
        (c && (this.type === u.logicalOR || this.type === u.logicalAND))) &&
        this.raiseRecoverable(
          this.start,
          "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses",
        ),
      this.parseExprOp(k, t, r, i, n)
    );
  }
  return e;
};
N.buildBinary = function (e, t, r, i, n, a) {
...
N.parseMaybeUnary = function (e, t, r, i) {
  var n = this.start,
    a = this.startLoc,
    s;
  if (this.isContextual("await") && this.canAwait)
    ...
    var c = this.startNode(),
      l = this.type === u.incDec;
    ((c.operator = this.value),
      (c.prefix = !0),
      this.next(),
      (c.argument = this.parseMaybeUnary(null, !0, l, i)),
      this.checkExpressionErrors(e, !0),
      l
        ? this.checkLValSimple(c.argument)
        : this.strict && c.operator === "delete" && ms(c.argument)
          ? this.raiseRecoverable(
              c.start,
              "Deleting local variable in strict mode",
            )
          : c.operator === "delete" && Un(c.argument)
            ? this.raiseRecoverable(
                c.start,
                "Private fields can not be deleted",
              )
            : (t = !0),
      (s = this.finishNode(c, l ? "UpdateExpression" : "UnaryExpression")));
    ...
    if (((s = this.parseExprSubscripts(e, i)), this.checkExpressionErrors(e)))
      return s;
...
function ms(e) {
  return (
    e.type === "Identifier" ||
    (e.type === "ParenthesizedExpression" && ms(e.expression))
  );
}
function Un(e) {
  return (
    ...
    (e.type === "ChainExpression" && Un(e.expression)) ||
    (e.type === "ParenthesizedExpression" && Un(e.expression))
  );
}
...
N.parseSubscripts = function (e, t, r, i, n) {
  for (
    var a =
        this.options.ecmaVersion >= 8 &&
        e.type === "Identifier" &&
    ...
    var c = this.parseSubscript(e, t, r, i, a, s, n);
    if (
      (c.optional && (s = !0), c === e || c.type === "ArrowFunctionExpression")
    ) {
      if (s) {
        var l = this.startNodeAt(t, r);
        ((l.expression = c), (c = this.finishNode(l, "ChainExpression")));
      }
      return c;
    }
    e = c;
...
N.parseSubscriptAsyncArrow = function (e, t, r, i) {
  return this.parseArrowExpression(this.startNodeAt(e, t), r, !0, i);
};
N.parseSubscript = function (e, t, r, i, n, a, s) {
  var c = this.options.ecmaVersion >= 11,
    l = c && this.eat(u.questionDot);
  i &&
    l &&
    this.raise(
      this.lastTokStart,
  ...
  if (
    h ||
    (l && this.type !== u.parenL && this.type !== u.backQuote) ||
    this.eat(u.dot)
  ) {
    var m = this.startNodeAt(t, r);
    ((m.object = e),
      h
        ? ((m.property = this.parseExpression()), this.expect(u.bracketR))
    ...
    var U = this.parseExprList(u.parenR, this.options.ecmaVersion >= 8, !1, _);
...
N.parseExprAtom = function (e, t, r) {
  ...
  switch (this.type) {
    ...
    case u.name:
      ...
      if (
        ...
        return (
          this.overrideContext(Z.f_expr),
          this.parseFunction(this.startNodeAt(a, s), 0, !1, !0, t)
        );
      if (n && !this.canInsertSemicolon()) {
        if (this.eat(u.arrow))
          return this.parseArrowExpression(this.startNodeAt(a, s), [l], !1, t);
        if (
          this.options.ecmaVersion >= 8 &&
          l.name === "async" &&
          this.type === u.name &&
          ...
          return (
            ...
            (this.canInsertSemicolon() || !this.eat(u.arrow)) &&
              this.unexpected(),
            this.parseArrowExpression(this.startNodeAt(a, s), [l], !0, t)
          );
      }
      return l;
    case u.regexp:
    ...
    case u._false:
      return (
        (i = this.startNode()),
        (i.value = this.type === u._null ? null : this.type === u._true),
    ...
    case u.parenL:
      var m = this.start,
        _ = this.parseParenAndDistinguishExpression(n, t);
      return (
        e &&
    ...
    case u.bracketL:
      return (
        (i = this.startNode()),
        this.next(),
        (i.elements = this.parseExprList(u.bracketR, !0, !0, e)),
        this.finishNode(i, "ArrayExpression")
      );
    case u.braceL:
      return (this.overrideContext(Z.b_expr), this.parseObj(!1, e));
    case u._function:
...
N.parseDynamicImport = function (e) {
  if (
    ...
    this.eat(u.parenR)
      ? (e.options = null)
      : (this.expect(u.comma),
        this.afterTrailingComma(u.parenR)
          ? (e.options = null)
          : ((e.options = this.parseMaybeAssign()),
            this.eat(u.parenR) ||
              (this.expect(u.comma),
              this.afterTrailingComma(u.parenR) || this.unexpected())));
  ...
  if (this.options.ecmaVersion >= 6) {
    ...
    for (this.yieldPos = 0, this.awaitPos = 0; this.type !== u.parenR;)
      if (
        ...
        break;
      } else l.push(this.parseMaybeAssign(!1, _, this.parseParenItem));
    var U = this.lastTokEnd,
      P = this.lastTokEndLoc;
    if (
      (this.expect(u.parenR),
      e && this.shouldParseArrow(l) && this.eat(u.arrow))
    )
      return (
        this.checkPatternErrors(_, !1),
        this.checkYieldAwaitInDefaultParams(),
    ...
    ((!l.length || m) && this.unexpected(this.lastTokStart),
      O && this.unexpected(O),
      this.checkExpressionErrors(_, !0),
      (this.yieldPos = k || this.yieldPos),
      (this.awaitPos = F || this.awaitPos),
      l.length > 1
        ? ((n = this.startNodeAt(s, c)),
          (n.expressions = l),
          this.finishNodeAt(n, "SequenceExpression", U, P))
        : (n = l[0]));
...
N.parseParenArrowList = function (e, t, r, i) {
...
N.parseNew = function () {
  ...
  return (
    ...
    e.callee.type === "Super" &&
      this.raiseRecoverable(i, "Invalid use of 'super'"),
    this.eat(u.parenL)
...
N.parseObj = function (e, t) {
  var r = this.startNode(),
    i = !0,
    n = {};
  for (r.properties = [], this.next(); !this.eat(u.braceR);) {
    if (i) i = !1;
    else if (
      (this.expect(u.comma),
...
N.parseProperty = function (e, t) {
  ...
  return (
    ...
    !e && !c && this.options.ecmaVersion >= 8 && !i && this.isAsyncProp(r)
      ? ((n = !0),
        (i = this.options.ecmaVersion >= 9 && this.eat(u.star)),
        this.parsePropertyName(r))
      : (n = !1),
    this.parsePropertyValue(r, e, i, n, a, s, t, c),
...
N.parsePropertyValue = function (e, t, r, i, n, a, s, c) {
  ((r || i) && this.type === u.colon && this.unexpected(),
    this.eat(u.colon)
      ? ((e.value = t
        ...
        : !t &&
          ...
          : this.options.ecmaVersion >= 6 &&
            ...
            ? ((r || i) && this.unexpected(),
              ...
              t
                ? (e.value = this.parseMaybeDefault(n, a, this.copyNode(e.key)))
                : this.type === u.eq && s
...
N.parseMethod = function (e, t, r) {
  ...
  return (
    ...
    (this.awaitPos = 0),
    (this.awaitIdentPos = 0),
    this.enterScope(Rn(t, i.generator) | fi | (r ? us : 0)),
    this.expect(u.parenL),
...
N.parseArrowExpression = function (e, t, r, i) {
  var n = this.yieldPos,
    a = this.awaitPos,
    s = this.awaitIdentPos;
  return (
    this.enterScope(Rn(r, !1) | Ln),
    this.initFunction(e),
...
N.parseFunctionBody = function (e, t, r, i) {
  ...
  if (n)
    ...
    ((this.labels = []),
      ...
      this.checkParams(
        e,
        !a && !s && !t && !r && this.isSimpleParamList(e.params),
      ),
      this.strict && e.id && this.checkLValSimple(e.id, hs),
...
N.checkParams = function (e, t) {
  for (var r = Object.create(null), i = 0, n = e.params; i < n.length; i += 1) {
    var a = n[i];
    this.checkLValInnerPattern(a, Vn, t ? null : r);
  }
};
N.parseExprList = function (e, t, r, i) {
  for (var n = [], a = !0; !this.eat(e);) {
    if (a) a = !1;
...
N.checkUnreserved = function (e) {
  ...
  if (
    ...
    !(this.currentThisScope().flags & hi) &&
      i === "arguments" &&
      this.raiseRecoverable(
        t,
...
At.enterScope = function (e) {
  this.scopeStack.push(new Bc(e));
};
At.exitScope = function () {
  this.scopeStack.pop();
};
At.treatFunctionsAsVarInScope = function (e) {
  return e.flags & It || (!this.inModule && e.flags & Pt);
};
At.declareName = function (e, t, r) {
  var i = !1;
  if (t === nt) {
    ...
    ((i =
      ...
      n.var.indexOf(e) > -1),
      n.lexical.push(e),
      this.inModule && n.flags & Pt && delete this.undefinedExports[e]);
  } else if (t === fs) {
    ...
    (this.treatFunctionsAsVar
      ? (i = s.lexical.indexOf(e) > -1)
      : (i = s.lexical.indexOf(e) > -1 || s.var.indexOf(e) > -1),
      s.functions.push(e));
  } else
    for (var c = this.scopeStack.length - 1; c >= 0; --c) {
      var l = this.scopeStack[c];
      if (
        (l.lexical.indexOf(e) > -1 && !(l.flags & cs && l.lexical[0] === e)) ||
      ...
      if (
        (l.var.push(e),
        this.inModule && l.flags & Pt && delete this.undefinedExports[e],
        l.flags & hi)
      )
        break;
    }
...
At.currentVarScope = function () {
  for (var e = this.scopeStack.length - 1; ; e--) {
    var t = this.scopeStack[e];
    if (t.flags & (hi | yr | Nt)) return t;
  }
};
At.currentThisScope = function () {
  for (var e = this.scopeStack.length - 1; ; e--) {
    var t = this.scopeStack[e];
    if (t.flags & (hi | yr | Nt) && !(t.flags & Ln)) return t;
  }
};
var _i = function (t, r, i) {
    ((this.type = ""),
      (this.start = r),
      (this.end = 0),
      t.options.locations && (this.loc = new pi(t, i)),
...
br.startNode = function () {
  return new _i(this, this.start, this.startLoc);
};
br.startNodeAt = function (e, t) {
  return new _i(this, e, t);
};
function gs(e, t, r, i) {
  return (
    (e.type = t),
...
br.finishNodeAt = function (e, t, r, i) {
  return gs.call(this, e, t, r, i);
};
br.copyNode = function (e) {
  var t = new _i(this, e.start, this.startLoc);
...
var Oc =
  ...
  _s = As + " Extended_Pictographic",
  xs = _s,
  ys = xs + " EBase EComp EMod EPres ExtPict",
  vs = ys,
  qc = vs,
  Lc = { 9: As, 10: _s, 11: xs, 12: ys, 13: vs, 14: qc },
  Rc =
  ...
  Es = Ts + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith",
  Hc = Es + " " + Oc,
  Kc = { 9: ws, 10: ks, 11: js, 12: Ts, 13: Es, 14: Hc },
  Ss = {};
function Uc(e) {
  var t = (Ss[e] = {
    binary: gt(Lc[e] + " " + bs),
    binaryOfStrings: gt(Vc[e]),
    nonBinary: { General_Category: gt(bs), Script: gt(Kc[e]) },
  });
...
for (xi = 0, $n = [9, 10, 11, 12, 13, 14]; xi < $n.length; xi += 1)
  ((Cs = $n[xi]), Uc(Cs));
var Cs,
  xi,
  $n,
...
yi.prototype.separatedFrom = function (t) {
  for (var r = this; r; r = r.parent)
    for (var i = t; i; i = i.parent)
      if (r.base === i.base && r !== i) return !0;
  return !1;
};
yi.prototype.sibling = function () {
  return new yi(this.parent, this.base);
};
var Ge = function (t) {
  ((this.parser = t),
    (this.validFlags =
    ...
    (this.unicodeProperties =
      Ss[t.options.ecmaVersion >= 14 ? 14 : t.options.ecmaVersion]),
    (this.source = ""),
    (this.flags = ""),
    (this.start = 0),
    (this.switchU = !1),
...
Ge.prototype.reset = function (t, r, i) {
  var n = i.indexOf("v") !== -1,
    a = i.indexOf("u") !== -1;
  ((this.start = t | 0),
    (this.source = r + ""),
...
Ge.prototype.at = function (t, r) {
  ...
  if (!(r || this.switchU) || a <= 55295 || a >= 57344 || t + 1 >= n) return a;
...
Ge.prototype.eatChars = function (t, r) {
  r === void 0 && (r = !1);
...
T.validateRegExpFlags = function (e) {
  for (
    var t = e.validFlags, r = e.flags, i = !1, n = !1, a = 0;
    a < r.length;
    a++
  ) {
    var s = r.charAt(a);
...
T.validateRegExpPattern = function (e) {
...
T.regexp_disjunction = function (e) {
  var t = this.options.ecmaVersion >= 16;
  for (
    t && (e.branchID = new yi(e.branchID, null)), this.regexp_alternative(e);
    e.eat(124);
  )
...
T.regexp_alternative = function (e) {
  for (; e.pos < e.source.length && this.regexp_eatTerm(e););
};
T.regexp_eatTerm = function (e) {
...
T.regexp_eatAssertion = function (e) {
  var t = e.pos;
...
T.regexp_eatQuantifier = function (e, t) {
  return (
    t === void 0 && (t = !1),
    this.regexp_eatQuantifierPrefix(e, t) ? (e.eat(63), !0) : !1
  );
};
T.regexp_eatQuantifierPrefix = function (e, t) {
  return (
    e.eat(42) || e.eat(43) || e.eat(63) || this.regexp_eatBracedQuantifier(e, t)
  );
};
T.regexp_eatBracedQuantifier = function (e, t) {
  var r = e.pos;
  if (e.eat(123)) {
    var i = 0,
      n = -1;
...
T.regexp_eatReverseSolidusAtomEscape = function (e) {
  var t = e.pos;
  if (e.eat(92)) {
...
T.regexp_eatUncapturingGroup = function (e) {
  var t = e.pos;
  if (e.eat(40)) {
    if (e.eat(63)) {
        ...
        if (r || i) {
          ...
          if (i) {
            ...
            for (var c = 0; c < s.length; c++) {
              var l = s.charAt(c);
              (s.indexOf(l, c + 1) > -1 || r.indexOf(l) > -1) &&
                e.raise("Duplicate regular expression modifiers");
            }
          }
        }
...
T.regexp_eatCapturingGroup = function (e) {
  if (e.eat(40)) {
    if (
      (this.options.ecmaVersion >= 9
...
T.regexp_eatModifiers = function (e) {
  for (var t = "", r = 0; (r = e.current()) !== -1 && Gc(r);)
    ((t += it(r)), e.advance());
  return t;
};
function Gc(e) {
...
T.regexp_eatExtendedAtom = function (e) {
  return (
    e.eat(46) ||
    this.regexp_eatReverseSolidusAtomEscape(e) ||
    this.regexp_eatCharacterClass(e) ||
...
T.regexp_eatInvalidBracedQuantifier = function (e) {
  return (
    this.regexp_eatBracedQuantifier(e, !0) && e.raise("Nothing to repeat"),
    !1
  );
};
T.regexp_eatSyntaxCharacter = function (e) {
  var t = e.current();
  return Ps(t) ? ((e.lastIntValue = t), e.advance(), !0) : !1;
};
function Ps(e) {
  return (
    e === 36 ||
...
T.regexp_eatPatternCharacters = function (e) {
  for (var t = e.pos, r = 0; (r = e.current()) !== -1 && !Ps(r);) e.advance();
  return e.pos !== t;
};
T.regexp_eatExtendedPatternCharacter = function (e) {
  var t = e.current();
  return t !== -1 &&
    t !== 36 &&
    !(t >= 40 && t <= 43) &&
...
T.regexp_groupSpecifier = function (e) {
  if (e.eat(63)) {
...
T.regexp_eatGroupName = function (e) {
...
T.regexp_eatRegExpIdentifierName = function (e) {
...
T.regexp_eatRegExpIdentifierStart = function (e) {
  var t = e.pos,
  ...
  return (
    ...
    i === 92 &&
      ...
      (i = e.lastIntValue),
    Yc(i) ? ((e.lastIntValue = i), !0) : ((e.pos = t), !1)
  );
};
function Yc(e) {
  return $e(e, !0) || e === 36 || e === 95;
}
T.regexp_eatRegExpIdentifierPart = function (e) {
  var t = e.pos,
    r = this.options.ecmaVersion >= 11,
    i = e.current(r);
  return (
    ...
    i === 92 &&
      this.regexp_eatRegExpUnicodeEscapeSequence(e, r) &&
      (i = e.lastIntValue),
    zc(i) ? ((e.lastIntValue = i), !0) : ((e.pos = t), !1)
  );
};
function zc(e) {
  return mt(e, !0) || e === 36 || e === 95 || e === 8204 || e === 8205;
}
T.regexp_eatAtomEscape = function (e) {
...
T.regexp_eatBackReference = function (e) {
  var t = e.pos;
...
T.regexp_eatKGroupName = function (e) {
  if (e.eat(107)) {
...
T.regexp_eatCharacterEscape = function (e) {
  return (
...
T.regexp_eatCControlLetter = function (e) {
  var t = e.pos;
  if (e.eat(99)) {
...
T.regexp_eatZero = function (e) {
  return e.current() === 48 && !vi(e.lookahead())
    ? ((e.lastIntValue = 0), e.advance(), !0)
    : !1;
};
T.regexp_eatControlEscape = function (e) {
  var t = e.current();
  return t === 116
...
T.regexp_eatControlLetter = function (e) {
  var t = e.current();
  return Is(t) ? ((e.lastIntValue = t % 32), e.advance(), !0) : !1;
};
function Is(e) {
  return (e >= 65 && e <= 90) || (e >= 97 && e <= 122);
}
T.regexp_eatRegExpUnicodeEscapeSequence = function (e, t) {
  t === void 0 && (t = !1);
  var r = e.pos,
    i = t || e.switchU;
  if (e.eat(117)) {
    if (this.regexp_eatFixedHexDigits(e, 4)) {
      ...
      if (i && n >= 55296 && n <= 56319) {
        ...
        if (e.eat(92) && e.eat(117) && this.regexp_eatFixedHexDigits(e, 4)) {
          ...
          if (s >= 56320 && s <= 57343)
            return (
              (e.lastIntValue = (n - 55296) * 1024 + (s - 56320) + 65536),
              !0
            );
        }
...
T.regexp_eatIdentityEscape = function (e) {
  if (e.switchU)
...
T.regexp_eatDecimalEscape = function (e) {
  e.lastIntValue = 0;
  var t = e.current();
  if (t >= 49 && t <= 57) {
...
var Ns = 0,
  at = 1,
  Pe = 2;
T.regexp_eatCharacterClassEscape = function (e) {
  var t = e.current();
  if (Jc(t)) return ((e.lastIntValue = -1), e.advance(), at);
  var r = !1;
  if (
    e.switchU &&
    this.options.ecmaVersion >= 9 &&
    ...
    if (
      ...
      return (r && i === Pe && e.raise("Invalid property name"), i);
...
T.regexp_eatUnicodePropertyValueExpression = function (e) {
  var t = e.pos;
  if (this.regexp_eatUnicodePropertyName(e) && e.eat(61)) {
    var r = e.lastStringValue;
    if (this.regexp_eatUnicodePropertyValue(e)) {
      var i = e.lastStringValue;
      return (this.regexp_validateUnicodePropertyNameAndValue(e, r, i), at);
    }
  }
...
T.regexp_validateUnicodePropertyNameAndValue = function (e, t, r) {
  (Xt(e.unicodeProperties.nonBinary, t) || e.raise("Invalid property name"),
    e.unicodeProperties.nonBinary[t].test(r) ||
      e.raise("Invalid property value"));
};
T.regexp_validateUnicodePropertyNameOrValue = function (e, t) {
  if (e.unicodeProperties.binary.test(t)) return at;
  if (e.switchV && e.unicodeProperties.binaryOfStrings.test(t)) return Pe;
  e.raise("Invalid property name");
};
T.regexp_eatUnicodePropertyName = function (e) {
  var t = 0;
...
T.regexp_eatUnicodePropertyValue = function (e) {
  var t = 0;
  for (e.lastStringValue = ""; Qc((t = e.current()));)
    ((e.lastStringValue += it(t)), e.advance());
  return e.lastStringValue !== "";
};
function Qc(e) {
...
T.regexp_eatLoneUnicodePropertyNameOrValue = function (e) {
  return this.regexp_eatUnicodePropertyValue(e);
};
T.regexp_eatCharacterClass = function (e) {
  if (e.eat(91)) {
    var t = e.eat(94),
      r = this.regexp_classContents(e);
    return (
      e.eat(93) || e.raise("Unterminated character class"),
      t && r === Pe && e.raise("Negated character class may contain strings"),
      !0
    );
  }
  return !1;
};
T.regexp_classContents = function (e) {
  return e.current() === 93
    ? at
    : e.switchV
      ? this.regexp_classSetExpression(e)
      : (this.regexp_nonEmptyClassRanges(e), at);
};
T.regexp_nonEmptyClassRanges = function (e) {
...
T.regexp_eatClassAtom = function (e) {
  var t = e.pos;
  if (e.eat(92)) {
    if (this.regexp_eatClassEscape(e)) return !0;
    if (e.switchU) {
      var r = e.current();
      ((r === 99 || Bs(r)) && e.raise("Invalid class escape"),
        e.raise("Invalid escape"));
    }
    e.pos = t;
  }
...
T.regexp_eatClassEscape = function (e) {
  var t = e.pos;
...
T.regexp_classSetExpression = function (e) {
  var t = at,
    r;
...
T.regexp_eatClassSetRange = function (e) {
  var t = e.pos;
...
T.regexp_eatNestedClass = function (e) {
  ...
  if (e.eat(91)) {
    ...
    if (e.eat(93))
      return (
        r && i === Pe && e.raise("Negated character class may contain strings"),
        i
      );
    e.pos = t;
  }
...
T.regexp_eatClassStringDisjunction = function (e) {
  var t = e.pos;
...
T.regexp_classStringDisjunctionContents = function (e) {
  for (var t = this.regexp_classString(e); e.eat(124);)
    this.regexp_classString(e) === Pe && (t = Pe);
  return t;
};
T.regexp_classString = function (e) {
  for (var t = 0; this.regexp_eatClassSetCharacter(e);) t++;
  return t === 1 ? at : Pe;
};
T.regexp_eatClassSetCharacter = function (e) {
  var t = e.pos;
  if (e.eat(92))
    return this.regexp_eatCharacterEscape(e) ||
      ...
      : e.eat(98)
        ...
        : ((e.pos = t), !1);
  var r = e.current();
  return r < 0 || (r === e.lookahead() && Xc(r)) || Zc(r)
    ? !1
...
T.regexp_eatClassSetReservedPunctuator = function (e) {
  var t = e.current();
  return eu(t) ? ((e.lastIntValue = t), e.advance(), !0) : !1;
};
function eu(e) {
  return (
    e === 33 ||
...
T.regexp_eatClassControlLetter = function (e) {
  var t = e.current();
  return vi(t) || t === 95 ? ((e.lastIntValue = t % 32), e.advance(), !0) : !1;
};
T.regexp_eatHexEscapeSequence = function (e) {
  var t = e.pos;
  if (e.eat(120)) {
...
T.regexp_eatDecimalDigits = function (e) {
  var t = e.pos,
    r = 0;
...
T.regexp_eatHexDigits = function (e) {
  var t = e.pos,
    r = 0;
  for (e.lastIntValue = 0; Ms((r = e.current()));)
    ((e.lastIntValue = 16 * e.lastIntValue + Fs(r)), e.advance());
  return e.pos !== t;
};
function Ms(e) {
...
T.regexp_eatLegacyOctalEscapeSequence = function (e) {
...
T.regexp_eatOctalDigit = function (e) {
  var t = e.current();
  return Bs(t)
...
T.regexp_eatFixedHexDigits = function (e, t) {
  var r = e.pos;
  e.lastIntValue = 0;
  for (var i = 0; i < t; ++i) {
    var n = e.current();
    if (!Ms(n)) return ((e.pos = r), !1);
...
var Gn = function (t) {
    ((this.type = t.type),
      ...
      (this.start = t.start),
      (this.end = t.end),
      t.options.locations && (this.loc = new pi(t, t.startLoc, t.endLoc)),
...
q.next = function (e) {
  (!e &&
    ...
    this.options.onToken && this.options.onToken(new Gn(this)),
...
q.readToken = function (e) {
  return $e(e, this.options.ecmaVersion >= 6) || e === 92
    ? this.readWord()
...
q.skipBlockComment = function () {
  ...
  if (
    ...
    for (var i = void 0, n = t; (i = es(this.input, n, this.pos)) > -1;)
...
q.skipLineComment = function (e) {
  for (
    ...
    this.pos < this.input.length && !Qt(i);
  )
  ...
  e: for (; this.pos < this.input.length;) {
    ...
    switch (e) {
      ...
      case 47:
        ...
        break;
      default:
        if ((e > 8 && e < 14) || (e >= 5760 && ts.test(String.fromCharCode(e))))
          ++this.pos;
        else break e;
    }
  }
...
q.readToken_mult_modulo_exp = function (e) {
  var t = this.input.charCodeAt(this.pos + 1),
    r = 1,
    i = e === 42 ? u.star : u.modulo;
  return (
    this.options.ecmaVersion >= 7 &&
      e === 42 &&
      t === 42 &&
      (++r, (i = u.starstar), (t = this.input.charCodeAt(this.pos + 2))),
    t === 61 ? this.finishOp(u.assign, r + 1) : this.finishOp(i, r)
  );
};
...
q.readToken_plus_min = function (e) {
  ...
  return t === e
    ? t === 45 &&
      ...
      (this.lastTokEnd === 0 ||
        _e.test(this.input.slice(this.lastTokEnd, this.pos)))
  ...
  return t === e
    ? ((r = e === 62 && this.input.charCodeAt(this.pos + 2) === 62 ? 3 : 2),
      this.input.charCodeAt(this.pos + r) === 61
        ? this.finishOp(u.assign, r + 1)
        : this.finishOp(u.bitShift, r))
    : t === 33 &&
        e === 60 &&
        !this.inModule &&
      ...
      : (t === 61 && (r = 2), this.finishOp(u.relational, r));
};
...
q.readToken_question = function () {
  ...
  if (e >= 11) {
    ...
    if (t === 46) {
      var r = this.input.charCodeAt(this.pos + 2);
      if (r < 48 || r > 57) return this.finishOp(u.questionDot, 2);
    }
    if (t === 63) {
      if (e >= 12) {
...
q.readToken_numberSign = function () {
  ...
  if (
    e >= 13 &&
    (++this.pos, (t = this.fullCharCodeAtPos()), $e(t, !0) || t === 92)
  )
...
q.readRegexp = function () {
  for (var e, t, r = this.pos; ;) {
    ...
    if ((_e.test(i) && this.raise(r, "Unterminated regular expression"), e))
      e = !1;
    else {
      if (i === "[") t = !0;
      else if (i === "]" && t) t = !1;
  ...
  var c = this.regexpState || (this.regexpState = new Ge(this));
  (c.reset(r, n, s),
  ...
  return this.finishToken(u.regexp, { pattern: n, flags: s, value: l });
};
q.readInt = function (e, t, r) {
  for (
...
q.readRadixNumber = function (e) {
  ...
  return (
    ...
    this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110
      ? ((r = Os(this.input.slice(t, this.pos))), ++this.pos)
      : $e(this.fullCharCodeAtPos()) &&
        this.raise(this.pos, "Identifier directly after number"),
    this.finishToken(u.num, r)
  );
};
q.readNumber = function (e) {
  ...
  if (!r && !e && this.options.ecmaVersion >= 11 && i === 110) {
    var n = Os(this.input.slice(t, this.pos));
    return (
      ++this.pos,
      $e(this.fullCharCodeAtPos()) &&
        this.raise(this.pos, "Identifier directly after number"),
  ...
  (r && /[89]/.test(this.input.slice(t, this.pos)) && (r = !1),
    ...
    $e(this.fullCharCodeAtPos()) &&
      this.raise(this.pos, "Identifier directly after number"));
  var a = tu(this.input.slice(t, this.pos), r);
    ...
    i === 92
      ...
      : i === 8232 || i === 8233
        ? (this.options.ecmaVersion < 10 &&
          ...
          this.options.locations &&
            (this.curLine++, (this.lineStart = this.pos)))
        : (Qt(i) && this.raise(this.start, "Unterminated string constant"),
          ++this.pos);
  }
  return (
    (t += this.input.slice(r, this.pos++)),
...
q.tryReadTemplateToken = function () {
  ...
  try {
    ...
    if (e === qs) this.readInvalidTemplateToken();
    else throw e;
  }
  this.inTemplateElement = !1;
};
q.invalidStringToken = function (e, t) {
  if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw qs;
  this.raise(e, t);
};
...
q.readWord1 = function () {
  ...
  for (
    ...
    if (mt(n, i)) this.pos += n <= 65535 ? 1 : 2;
    else if (n === 92) {
...
`,
          ...
          examples: [
            ...
            {
              name: "File cursor with a decimal order",
              example:
                "<% tp.file.cursor(1) %>Content<% tp.file.cursor(1.5) %>Content<% tp.file.cursor(2) %>",
            },
          ],
        },
        cursor_append: {
    ...
    system: {
      ...
      functions: {
        ...
        prompt: {
          ...
          definition:
            "tp.system.prompt(prompt_text?: string, default_value?: string, throw_on_cancel: boolean = false, multiline?: boolean = false, select_default_value?: boolean = false)",
          args: [
            {
              name: "prompt_text",
            ...
            },
            {
              ...
              description:
                "If set to `true`, the default value shown when the modal opens is selected, so typing replaces it. Defaults to `false`.",
            },
          ],
          examples: [
            {
    ...
    web: {
      ...
      functions: {
        daily_quote: {
          name: "daily_quote",
          description:
            "Retrieves and parses a daily quote as a callout. Without arguments it uses the language configured in Obsidian (via `getLanguage()`), falling back to English. English quotes come from `https://github.com/Zachatoo/quotes-database` and Spanish quotes from `https://github.com/wulflo/frases-inventario`.",
          definition: "tp.web.daily_quote(language?: string)",
          args: [
            {
              name: "language",
              description:
                'Optional language code (e.g. `"en"`, `"es"`) selecting the quotes database. Defaults to Obsidian\'s display language, falling back to English when no database is registered for that language.',
            },
          ],
          examples: [
            {
...
function Vs(e) {
  return !!(e.definition || e.returns || e.args);
}
var Wn = class {
  constructor(t) {
    this.plugin = t;
    this.documentation = Rs;
  }
  get_all_modules_documentation() {
    let t = this.documentation.tp,
      r = Object.values(t);
    return (
      (!this.plugin.settings || !this.plugin.settings.user_scripts_folder) &&
        (r = r.filter((i) => i.name !== "user")),
      r.map((i) => ((i.queryKey = i.name), i))
    );
  }
  async get_all_functions_documentation(t, r) {
    if (t === "app")
      return this.get_app_functions_documentation(this.plugin.app, r);
    if (t === "user") {
      ...
      let n = su(r);
      if (n) {
        let s = i.find((c) => c.basename === n.scriptName);
        return s ? ou(this.plugin, s, n.scriptName) : [];
      }
      let a = await de(
        () => Sa(this.plugin.app, i),
    ...
    if (!!this.documentation.tp[t].functions)
      return Object.values(this.documentation.tp[t].functions).map(
        (i) => ((i.queryKey = i.name), i),
      );
  }
  get_app_functions_documentation(t, r) {
    if (!ue(t)) return [];
    let i = r.split(".");
    if (i.length === 0) return [];
    let n = t;
    ...
    let a = ["tp", "app", ...i.slice(0, i.length - 1)].join("."),
      s = i.slice(0, i.length - 1).join("."),
      c = [];
    for (let l in n) {
      let h = `${a}.${l}`,
        m = s ? `${s}.${l}` : l;
      c.push({
        ...
        queryKey: m,
        definition:
          typeof n[l] == "function" ? `${h}(${Ca(n[l]).join(", ")})` : h,
        description: "",
        returns: "",
        example: "",
      });
  ...
  get_module_documentation(t) {
    return this.documentation.tp[t];
  }
  get_function_documentation(t, r) {
    return this.documentation.tp[t].functions[r];
  }
  get_argument_documentation(t, r, i) {
    let n = this.get_function_documentation(t, r);
    return !n || !n.args ? null : n.args[i];
  }
};
function su(e) {
  let t = e.indexOf(".");
  if (t === -1) return null;
  let r = e.slice(0, t);
  return r ? { scriptName: r } : null;
}
async function ou(e, t, r) {
  let i = await e.app.vault.cachedRead(t),
    n = pu(i);
  return cu(i).map((s) => {
    let c = n.get(s),
      l = c?.args ? Object.keys(c.args) : [];
    return {
      name: s,
      queryKey: `${r}.${s}`,
      definition: `tp.user.${r}.${s}(${l.join(", ")})`,
      description: c?.description ?? "",
      returns: c?.returns ?? "",
      args: c?.args,
      example: "",
...
function cu(e) {
  let t;
  try {
    t = Yn(e, { ecmaVersion: "latest", sourceType: "module" });
  } catch {
    try {
      t = Yn(e, {
        ecmaVersion: "latest",
  ...
  if (!ue(t) || !Array.isArray(t.body)) return [];
  let r = new Set();
  for (let i of t.body) lu(i, r);
  return [...r];
}
function bi(e, t, r) {
  if (!ue(e) || e.type !== "MemberExpression" || e.computed) return !1;
  let i = e.object,
    n = e.property;
  return (
    ue(i) &&
...
function Hs(e, t) {
  if (!(
    ...
    for (let r of e.properties) {
      if (!ue(r) || r.type !== "Property" || r.computed) continue;
      let i = r.key;
      !ue(i) ||
        (i.type === "Identifier" && typeof i.name == "string"
          ? t.add(i.name)
          : i.type === "Literal" &&
...
function uu(e) {
  ...
  let t = e.property;
  if (!ue(t) || t.type !== "Identifier" || typeof t.name != "string")
    return null;
  let r = e.object;
  return bi(r, "module", "exports") ||
    bi(r, "exports", "default") ||
    (ue(r) && r.type === "Identifier" && r.name === "exports")
    ? t.name
    : null;
}
function lu(e, t) {
  ...
  let r = e.expression;
  if (!ue(r) || r.type !== "AssignmentExpression" || r.operator !== "=") return;
  let i = r.left;
  if (!ue(i) || i.type !== "MemberExpression") return;
  if (bi(i, "module", "exports") || bi(i, "exports", "default")) {
    Hs(r.right, t);
    return;
  }
  let n = uu(i);
...
function pu(e) {
  let t = new Map(),
    ...
    i = "[$A-Z_a-z][$\\w]*",
    n = [
      new RegExp(`(${r})\\s*(?:async\\s+)?function\\s+(${i})\\s*\\(`, "g"),
      new RegExp(`(${r})\\s*(?:const|let|var)\\s+(${i})\\s*=`, "g"),
      new RegExp(`(${r})\\s*(${i})\\s*:`, "g"),
      new RegExp(`(${r})\\s*["'](${i})["']\\s*:`, "g"),
      new RegExp(`(${r})\\s*(?:async\\s+)?(${i})\\s*\\([^)]*\\)\\s*{`, "g"),
      new RegExp(`(${r})\\s*(${i})\\s*(?=,|})`, "g"),
    ];
  for (let a of n)
...
function Ks(e) {
  if (e.length !== 0)
    return e.reduce(
      (t, r) => ((t[r.name] = { name: r.name, description: r.description }), t),
      {},
    );
}
var Jn = class extends Us.EditorSuggest {
  constructor(t) {
    super(t.app);
    ...
    this.function_name = "";
    ((this.documentation = new Wn(t)),
      (this.intellisense_render_setting = t.settings.intellisense_render));
  }
  onTrigger(t, r, i) {
    let n = r.getRange({ line: t.line, ch: 0 }, { line: t.line, ch: t.ch }),
      a = this.tp_keyword_regex.exec(n);
    if (!a) return null;
    let s,
      c = (a.groups && a.groups.module) || "";
    if ((zn(c) && (this.module_name = c), a.groups && a.groups.fn_trigger)) {
      if (c == "" || !zn(c)) return null;
      ((this.function_trigger = !0),
        (this.function_name = a.groups.fn || ""),
        (s = this.function_name));
    } else ((this.function_trigger = !1), (s = this.module_name));
    let l = {
      start: { line: t.line, ch: t.ch - s.length },
      end: { line: t.line, ch: t.ch },
      query: s,
    };
    return ((this.latest_trigger_info = l), l);
  }
  async getSuggestions(t) {
    let r;
    return (
      this.module_name && this.function_trigger
        ? (r = await this.documentation.get_all_functions_documentation(
            this.module_name,
            this.function_name,
          ))
        : (r = this.documentation.get_all_modules_documentation()),
      r
        ? r.filter((i) =>
            i.queryKey.toLowerCase().startsWith(t.query.toLowerCase()),
          )
        : []
    );
  }
  renderSuggestion(t, r) {
    let i = Vs(t),
      n =
        i &&
        t.args &&
        this.getNumberOfArguments(t.args) > 0 &&
        Na(this.intellisense_render_setting),
      a = i && t.returns && Ia(this.intellisense_render_setting),
      s = i && this.function_trigger && t.definition,
      c = t.description && Da(this.intellisense_render_setting),
      l = n || a || s || c;
    if ((r.createEl("b", { text: t.name }), l && r.createEl("br"), i)) {
      if (n) {
        r.createEl("p", { text: "Parameter list:" });
        let h = r.createEl("ol");
        for (let [m, _] of Object.entries(t.args ?? {}))
          Ji(h, m, _.description);
      }
      a && Ji(r, "Returns", t.returns);
    }
    (s && r.createEl("code", { text: t.definition }),
      c && r.createDiv({ text: t.description }));
  }
  selectSuggestion(t, r) {
    let i = this.app.workspace.activeEditor;
    if (
      !(!i || !i.editor) &&
      ...
      let n = this.latest_trigger_info.end;
      ((n.ch += t.queryKey.length), i.editor.setCursor(n));
    }
  }
  getNumberOfArguments(t) {
    try {
      return new Map(Object.entries(t)).size;
    } catch {
      return 0;
    }
  }
  updateAutocompleteIntellisenseSetting(t) {
    this.intellisense_render_setting = t;
  }
};
(function (e) {
  e(window.CodeMirror);
  ...
  (e.defineMode("javascript", function (t, r) {
    ...
    function F(o) {
      for (var p = !1, A, y = !1; (A = o.next()) != null;) {
        if (!p) {
          if (A == "/" && !y) return;
          A == "[" ? (y = !0) : y && A == "]" && (y = !1);
        }
    ...
    function Y(o, p) {
      var A = o.next();
      if (A == '"' || A == "'") return ((p.tokenize = xe(A)), p.tokenize(o, p));
      if (A == "." && o.match(/^\d[\d_]*(?:[eE][+-]?[\d_]+)?/))
        return P("number", "number");
      if (A == "." && o.match("..")) return P("spread", "meta");
      if (/[[\]{}(),;:.]/.test(A)) return P(A);
      if (A == "=" && o.eat(">")) return P("=>", "operator");
      if (A == "0" && o.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/))
        return P("number", "number");
      if (/\d/.test(A))
        return (
          o.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+-]?[\d_]+)?)?/),
          P("number", "number")
        );
      if (A == "/")
        return o.eat("*")
          ? ((p.tokenize = ye), ye(o, p))
          : o.eat("/")
            ? (o.skipToEnd(), P("comment", "comment"))
            : ma(o, p, 1)
              ? (F(o),
                o.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/),
                P("regexp", "string-2"))
              : (o.eat("="), P("operator", "operator", o.current()));
      if (A == "`") return ((p.tokenize = re), re(o, p));
      if (A == "#" && o.peek() == "!")
        return (o.skipToEnd(), P("meta", "meta"));
      if (A == "#" && o.eatWhile(h)) return P("variable", "property");
      if (
        (A == "<" && o.match("!--")) ||
        (A == "-" && o.match("->") && !/\S/.test(o.string.slice(0, o.start)))
      )
        return (o.skipToEnd(), P("comment", "comment"));
      if (_.test(A))
        return (
          (A != ">" || !p.lexical || p.lexical.type != ">") &&
            (o.eat("=")
              ? (A == "!" || A == "=") && o.eat("=")
              : /[<>*+\-|&?]/.test(A) && (o.eat(A), A == ">" && o.eat(A))),
          A == "?" && o.eat(".")
            ? P(".")
            : P("operator", "operator", o.current())
        );
      if (h.test(A)) {
        o.eatWhile(h);
        var y = o.current();
        if (p.lastType != ".") {
          if (Object.prototype.propertyIsEnumerable.call(m, y)) {
            var M = m[y];
            return P(M.type, M.style, y);
          }
          if (
            y == "async" &&
            o.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[[(\w]/, !1)
          )
            return P("async", "keyword", y);
        }
        return P("variable", "variable", y);
      }
    }
    function xe(o) {
      return function (p, A) {
        var y = !1,
          M;
        if (a && p.peek() == "@" && p.match(k))
          return ((A.tokenize = Y), P("jsonld-keyword", "meta"));
        for (; (M = p.next()) != null && !(M == o && !y);) y = !y && M == "\\";
        return (y || (A.tokenize = Y), P("string", "string"));
      };
    }
    function ye(o, p) {
      for (var A = !1, y; (y = o.next());) {
        if (y == "/" && A) {
          p.tokenize = Y;
          break;
        }
    ...
    function re(o, p) {
      ...
      return P("quasi", "string-2", o.current());
    }
    var _t = "([{}])";
    function Ie(o, p) {
      p.fatArrowAt && (p.fatArrowAt = null);
      var A = o.string.indexOf("=>", o.start);
      if (!(A < 0)) {
        if (l) {
          var y = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(
            o.string.slice(o.start, A),
          );
          y && (A = y.index);
        }
        for (var M = 0, H = !1, J = A - 1; J >= 0; --J) {
          var fe = o.string.charAt(J),
            qe = _t.indexOf(fe);
          if (qe >= 0 && qe < 3) {
            if (!M) {
              ++J;
          ...
          else if (h.test(fe)) H = !0;
          else if (/["'/`]/.test(fe))
            for (; ; --J) {
              if (J == 0) return;
              var yo = o.string.charAt(J - 1);
              if (yo == fe && o.string.charAt(J - 2) != "\\") {
                J--;
                break;
              }
            }
    ...
    function ki(o, p) {
      if (!c) return !1;
      for (var A = o.localVars; A; A = A.next) if (A.name == p) return !0;
      for (var y = o.context; y; y = y.prev)
        for (A = y.vars; A; A = A.next) if (A.name == p) return !0;
    }
    function tr(o, p, A, y, M) {
      var H = o.cc;
      for (
        x.state = o,
          x.stream = M,
          ...
          x.cc = H,
          x.style = p,
          Object.prototype.hasOwnProperty.call(o.lexical, "align") ||
            (o.lexical.align = !0);
        ;
      ) {
        var J = H.length ? H.pop() : s ? Q : ae;
        if (J(A, y)) {
    ...
    var x = { state: null, column: null, marked: null, cc: null };
    function I() {
      for (var o = arguments.length - 1; o >= 0; o--) x.cc.push(arguments[o]);
    }
    function d() {
      return (I.apply(null, arguments), !0);
    }
    function ji(o, p) {
      for (var A = p; A; A = A.next) if (A.name == o) return !0;
      return !1;
    }
    function Dt(o) {
      var p = x.state;
      if (((x.marked = "def"), !!c)) {
        if (p.context) {
          if (p.lexical.info == "var" && p.context && p.context.block) {
            var A = ra(o, p.context);
            if (A != null) {
              p.context = A;
              return;
            }
          } else if (!ji(o, p.localVars)) {
            p.localVars = new ir(o, p.localVars);
            return;
          }
        }
        r.globalVars &&
          !ji(o, p.globalVars) &&
          (p.globalVars = new ir(o, p.globalVars));
      }
    }
    function ra(o, p) {
      if (p)
        if (p.block) {
          var A = ra(o, p.prev);
          return A ? (A == p.prev ? p : new rr(A, p.vars, !0)) : null;
        } else return ji(o, p.vars) ? p : new rr(p.prev, new ir(o, p.vars), !1);
      else return null;
    }
    function kr(o) {
      return (
    ...
    function rr(o, p, A) {
      ((this.prev = o), (this.vars = p), (this.block = A));
    }
    function ir(o, p) {
      ((this.name = o), (this.next = p));
    }
    var zs = new ir("this", new ir("arguments", null));
    function Mt() {
      ((x.state.context = new rr(x.state.context, x.state.localVars, !1)),
        (x.state.localVars = zs));
    }
    function Ti() {
      ((x.state.context = new rr(x.state.context, x.state.localVars, !0)),
    ...
    function B(o, p) {
      var A = function () {
        var y = x.state,
          M = y.indented;
        if (y.lexical.type == "stat") M = y.lexical.indented;
        else
          for (var H = y.lexical; H && H.type == ")" && H.align; H = H.prev)
            M = H.indented;
        y.lexical = new wr(M, x.stream.column(), o, null, y.lexical, p);
      };
      return ((A.lex = !0), A);
    }
    function D() {
      var o = x.state;
      o.lexical.prev &&
        (o.lexical.type == ")" && (o.indented = o.lexical.indented),
        (o.lexical = o.lexical.prev));
    }
    D.lex = !0;
    function V(o) {
      function p(A) {
              ...
              : o == "debugger"
                ...
                : o == "{"
                  ...
                  : o == ";"
                    ? d()
                    : o == "if"
                      ? (x.state.lexical.info == "else" &&
                          x.state.cc[x.state.cc.length - 1] == D &&
                          x.state.cc.pop()(),
                        d(B("form"), Ei, ae, D, ca))
                      : o == "function"
                        ? d(ot)
                        : o == "for"
                          ? d(B("form"), Ti, ua, ae, Ne, D)
                          : o == "class" || (l && p == "interface")
                            ? ((x.marked = "keyword"),
                              d(B("form", o == "class" ? o : p), pa, D))
                            : o == "variable"
                              ? l && p == "declare"
                                ? ((x.marked = "keyword"), d(ae))
                                : l &&
                                    (p == "module" ||
                                      p == "enum" ||
                                      p == "type") &&
                                    x.stream.match(/^\s*\w/, !1)
                                  ? ((x.marked = "keyword"),
                                    p == "enum"
                                      ? d(da)
                                      : p == "type"
    ...
    function Ei(o) {
      return o != "(" ? I() : d(B(")"), Ft, V(")"), D);
    }
    function ia(o, p, A) {
      if (x.state.fatArrowAt == x.stream.start) {
        var y = A ? aa : na;
        if (o == "(") return d(Mt, B(")"), oe(vt, ")"), D, V("=>"), y, Ne);
        if (o == "variable") return I(Mt, De, V("=>"), y, Ne);
      }
      var M = A ? Bt : xt;
      return Object.prototype.hasOwnProperty.call(wi, o)
        ? d(M)
        : o == "function"
          ? d(ot, M)
          : o == "class" || (l && p == "interface")
            ? ((x.marked = "keyword"), d(B("form"), fo, D))
            : o == "keyword c" || o == "async"
              ? d(A ? ve : Q)
              : o == "("
                ? d(B(")"), Ft, V(")"), D, M)
    ...
    function Ft(o) {
      return o.match(/[;})\],]/) ? I() : I(Q);
    }
    function xt(o, p) {
      return o == "," ? d(Ft) : Bt(o, p, !1);
    }
    function Bt(o, p, A) {
      var y = A == !1 ? xt : Bt,
        M = A == !1 ? Q : ve;
      if (o == "=>") return d(Mt, A ? aa : na, Ne);
      if (o == "operator")
        return /\+\+|--/.test(p) || (l && p == "!")
          ? d(y)
          : l && p == "<" && x.stream.match(/^([^<>]|<[^<>]*>)*>\s*\(/, !1)
            ? d(B(">"), oe(W, ">"), D, y)
            : p == "?"
              ? d(Q, V(":"), M)
              : d(M);
      if (o == "quasi") return I(jr, y);
      if (o != ";") {
        if (o == "(") return nr(ve, ")", "call", y);
        if (o == ".") return d(to, y);
        if (o == "[") return d(B("]"), Ft, V("]"), D, y);
        if (l && p == "as") return ((x.marked = "keyword"), d(W, y));
        if (o == "regexp")
          return (
            (x.state.lastType = x.marked = "operator"),
    ...
    function Js(o) {
      if (o == "}")
        return ((x.marked = "string-2"), (x.state.tokenize = re), d(jr));
    }
    function na(o) {
      return (Ie(x.stream, x.state), I(o == "{" ? ae : Q));
    }
    function aa(o) {
      return (Ie(x.stream, x.state), I(o == "{" ? ae : ve));
    }
    function Qs(o) {
      return function (p) {
        return p == "."
    ...
    function Xs(o, p) {
      if (p == "target") return ((x.marked = "keyword"), d(xt));
    }
    function Zs(o, p) {
      if (p == "target") return ((x.marked = "keyword"), d(Bt));
    }
    function eo(o) {
      return o == ":" ? d(D, ae) : I(xt, V(";"), D);
    }
    function to(o) {
      if (o == "variable") return ((x.marked = "property"), d());
    }
    function Tr(o, p) {
      if (o == "async") return ((x.marked = "property"), d(Tr));
      if (o == "variable" || x.style == "keyword") {
        if (((x.marked = "property"), p == "get" || p == "set")) return d(ro);
        var A;
        return (
          l &&
            x.state.fatArrowAt == x.stream.start &&
            (A = x.stream.match(/^\s*:\s*/, !1)) &&
            (x.state.fatArrowAt = x.stream.pos + A[0].length),
          d(yt)
        );
      } else {
        if (o == "number" || o == "string")
          return ((x.marked = a ? "property" : x.style + " property"), d(yt));
        if (o == "jsonld-keyword") return d(yt);
        if (l && kr(p)) return ((x.marked = "keyword"), d(Tr));
        if (o == "[") return d(Q, Ot, V("]"), yt);
        if (o == "spread") return d(ve, yt);
        if (p == "*") return ((x.marked = "keyword"), d(Tr));
        if (o == ":") return I(yt);
      }
    }
    function ro(o) {
      return o != "variable" ? I(yt) : ((x.marked = "property"), d(ot));
    }
    function yt(o) {
      if (o == ":") return d(ve);
      if (o == "(") return I(ot);
    ...
    function oe(o, p, A) {
      function y(M, H) {
        if (A ? A.indexOf(M) > -1 : M == ",") {
          var J = x.state.lexical;
          return (
            J.info == "call" && (J.pos = (J.pos || 0) + 1),
            d(function (fe, qe) {
              return fe == p || qe == p ? I() : I(o);
            }, y)
          );
        }
        return M == p || H == p
      ...
      return function (M, H) {
        return M == p || H == p ? d() : I(o, y);
      };
    }
    function nr(o, p, A) {
      for (var y = 3; y < arguments.length; y++) x.cc.push(arguments[y]);
      return d(B(p, A), oe(o, p), D);
    }
    function Er(o) {
      return o == "}" ? d() : I(ae, Er);
    }
    ...
    function io(o, p) {
      if (l && (o == ":" || p == "in")) return d(W);
    }
    function sa(o) {
      if (l && o == ":")
        return x.stream.match(/^\s*\w+\s+is\b/, !1) ? d(Q, no, W) : d(W);
    }
    function no(o, p) {
      if (p == "is") return ((x.marked = "keyword"), d());
    }
    function W(o, p) {
      if (p == "keyof" || p == "typeof" || p == "infer" || p == "readonly")
        return ((x.marked = "keyword"), d(p == "typeof" ? ve : W));
      if (o == "variable" || p == "void") return ((x.marked = "type"), d(Ye));
      if (p == "|" || p == "&") return d(W);
      if (o == "string" || o == "number" || o == "atom") return d(Ye);
      if (o == "[") return d(B("]"), oe(W, "]", ","), D, Ye);
      if (o == "{") return d(B("}"), Si, D, Ye);
      if (o == "(") return d(oe(Pi, ")"), ao, Ye);
      if (o == "<") return d(oe(W, ">"), W);
      if (o == "quasi") return I(Ci, Ye);
    }
    function ao(o) {
      if (o == "=>") return d(W);
    }
    function Si(o) {
      return o.match(/[})\]]/) ? d() : o == "," || o == ";" ? d(Si) : I(ar, Si);
    }
    function ar(o, p) {
      if (o == "variable" || x.style == "keyword")
        return ((x.marked = "property"), d(ar));
      if (p == "?" || o == "number" || o == "string") return d(ar);
      if (o == ":") return d(W);
      if (o == "[") return d(V("variable"), io, V("]"), ar);
      if (o == "(") return I(Lt, ar);
      if (!o.match(/[;})\],]/)) return d();
    }
    function Ci(o, p) {
    ...
    function so(o) {
      if (o == "}")
        return ((x.marked = "string-2"), (x.state.tokenize = re), d(Ci));
    }
    function Pi(o, p) {
      return (o == "variable" && x.stream.match(/^\s*[?:]/, !1)) || p == "?"
        ? d(Pi)
        : o == ":"
          ? d(W)
          : o == "spread"
    ...
    function Ye(o, p) {
      if (p == "<") return d(B(">"), oe(W, ">"), D, Ye);
      if (p == "|" || o == "." || p == "&") return d(W);
      if (o == "[") return d(W, V("]"), Ye);
      if (p == "extends" || p == "implements")
        return ((x.marked = "keyword"), d(W));
      if (p == "?") return d(W, V(":"), W);
    }
    function oo(o, p) {
      if (p == "<") return d(B(">"), oe(W, ">"), D, Ye);
    ...
    function Ii(o, p) {
      return p == "enum" ? ((x.marked = "keyword"), d(da)) : I(De, Ot, st, lo);
    }
    function De(o, p) {
      if (l && kr(p)) return ((x.marked = "keyword"), d(De));
      if (o == "variable") return (Dt(p), d());
      if (o == "spread") return d(De);
      if (o == "[") return nr(uo, "]");
      if (o == "{") return nr(oa, "}");
    }
    function oa(o, p) {
      return o == "variable" && !x.stream.match(/^\s*:/, !1)
        ? (Dt(p), d(st))
        : (o == "variable" && (x.marked = "property"),
          o == "spread"
            ? d(De)
            : o == "}"
              ? I()
    ...
    function ca(o, p) {
      if (o == "keyword b" && p == "else") return d(B("form", "else"), ae, D);
    }
    function ua(o, p) {
      if (p == "await") return d(ua);
      if (o == "(") return d(B(")"), po, D);
    }
    function po(o) {
      return o == "var" ? d(Ii, qt) : o == "variable" ? d(qt) : I(qt);
    }
    function qt(o, p) {
      return o == ")"
        ? d()
        : o == ";"
          ? d(qt)
          : p == "in" || p == "of"
            ? ((x.marked = "keyword"), d(Q, qt))
            : I(Q, qt);
    }
    function ot(o, p) {
      if (p == "*") return ((x.marked = "keyword"), d(ot));
      if (o == "variable") return (Dt(p), d(ot));
      if (o == "(") return d(Mt, B(")"), oe(vt, ")"), D, sa, ae, Ne);
      if (l && p == "<") return d(B(">"), oe(Sr, ">"), D, ot);
    }
    function Lt(o, p) {
      if (p == "*") return ((x.marked = "keyword"), d(Lt));
      if (o == "variable") return (Dt(p), d(Lt));
      if (o == "(") return d(Mt, B(")"), oe(vt, ")"), D, sa, Ne);
      if (l && p == "<") return d(B(">"), oe(Sr, ">"), D, Lt);
    }
    function la(o, p) {
      if (o == "keyword" || o == "variable")
        return ((x.marked = "type"), d(la));
      if (p == "<") return d(B(">"), oe(Sr, ">"), D);
    }
    function vt(o, p) {
      return (
        p == "@" && d(Q, vt),
    ...
    function fo(o, p) {
      return o == "variable" ? pa(o, p) : Cr(o, p);
    }
    function pa(o, p) {
      if (o == "variable") return (Dt(p), d(Cr));
    }
    function Cr(o, p) {
      if (p == "<") return d(B(">"), oe(Sr, ">"), D, Cr);
      if (p == "extends" || p == "implements" || (l && o == ","))
        return (p == "implements" && (x.marked = "keyword"), d(l ? W : Q, Cr));
      if (o == "{") return d(B("}"), ze, D);
    }
    function ze(o, p) {
      if (
        o == "async" ||
        (o == "variable" &&
          (p == "static" || p == "get" || p == "set" || (l && kr(p))) &&
          x.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
      )
        return ((x.marked = "keyword"), d(ze));
      if (o == "variable" || x.style == "keyword")
        return ((x.marked = "property"), d(sr, ze));
      if (o == "number" || o == "string") return d(sr, ze);
      if (o == "[") return d(Q, Ot, V("]"), sr, ze);
      if (p == "*") return ((x.marked = "keyword"), d(ze));
      if (l && o == "(") return I(Lt, ze);
      if (o == ";" || o == ",") return d(ze);
      if (o == "}") return d();
      if (p == "@") return d(Q, ze);
    }
    function sr(o, p) {
      ...
      if (o == ":") return d(W, st);
      if (p == "=") return d(ve);
      var A = x.state.lexical.prev,
        y = A && A.info == "interface";
      return I(y ? Lt : ot);
    }
    function ho(o, p) {
      return p == "*"
        ? ((x.marked = "keyword"), d(Ni, V(";")))
        : p == "default"
          ? ((x.marked = "keyword"), d(Q, V(";")))
          : o == "{"
            ? d(oe(fa, "}"), Ni, V(";"))
            : I(ae);
    }
    function fa(o, p) {
      if (p == "as") return ((x.marked = "keyword"), d(V("variable")));
      if (o == "variable") return I(ve, fa);
    }
    function mo(o) {
      return o == "string"
        ? d()
    ...
    function Pr(o, p) {
      return o == "{"
        ? nr(Pr, "}")
        : (o == "variable" && Dt(p), p == "*" && (x.marked = "keyword"), d(go));
    }
    function ha(o) {
      if (o == ",") return d(Pr, ha);
    }
    function go(o, p) {
      if (p == "as") return ((x.marked = "keyword"), d(Pr));
    }
    function Ni(o, p) {
      if (p == "from") return ((x.marked = "keyword"), d(Q));
    }
    function Ao(o) {
      return o == "]" ? d() : I(oe(ve, "]"));
    }
    function da() {
      return I(B("form"), De, V("{"), B("}"), oe(_o, "}"), D, D);
    }
    function _o() {
      return I(De, st);
    }
    ...
    function ma(o, p, A) {
      return (
        ...
        (p.lastType == "quasi" &&
          /\{\s*$/.test(o.string.slice(0, o.pos - (A || 0))))
      );
    }
    return {
      startState: function (o) {
        var p = {
          ...
          lastType: "sof",
          cc: [],
          lexical: new wr((o || 0) - i, 0, "block", !1),
          localVars: r.localVars,
          context: r.localVars && new rr(null, null, !1),
          indented: o || 0,
        };
        return (
          r.globalVars &&
            typeof r.globalVars == "object" &&
            (p.globalVars = r.globalVars),
          p
        );
      },
      token: function (o, p) {
        if (
          (o.sol() &&
            (Object.prototype.hasOwnProperty.call(p.lexical, "align") ||
              (p.lexical.align = !1),
            (p.indented = o.indentation()),
            Ie(o, p)),
          p.tokenize != ye && o.eatSpace())
        )
          return null;
        var A = p.tokenize(o, p);
        return O == "comment"
          ? A
          : ((p.lastType =
              O == "operator" && (U == "++" || U == "--") ? "incdec" : O),
            tr(p, A, O, U, o));
      },
      indent: function (o, p) {
        if (o.tokenize == ye || o.tokenize == re) return e.Pass;
        if (o.tokenize != Y) return 0;
        var A = p && p.charAt(0),
          y = o.lexical,
          M;
        if (!/^\s*else\b/.test(p))
          for (var H = o.cc.length - 1; H >= 0; --H) {
            var J = o.cc[H];
            if (J == D) y = y.prev;
            else if (J != ca && J != Ne) break;
          }
        for (
          ;
          (y.type == "stat" || y.type == "form") &&
          (A == "}" ||
            ((M = o.cc[o.cc.length - 1]) &&
              (M == xt || M == Bt) &&
              !/^[,.=+\-*:?[(]/.test(p)));
        )
          y = y.prev;
        n && y.type == ")" && y.prev.type == "stat" && (y = y.prev);
        var fe = y.type,
          qe = A == fe;
        return fe == "vardef"
          ? y.indented +
              (o.lastType == "operator" || o.lastType == ","
                ? y.info.length + 1
                : 0)
          : fe == "form" && A == "{"
            ? y.indented
            : fe == "form"
              ? y.indented + i
              : fe == "stat"
                ? y.indented + (xo(o, p) ? n || i : 0)
                : y.info == "switch" && !qe && r.doubleIndentSwitch != !1
                  ? y.indented + (/^(?:case|default)\b/.test(p) ? i : 2 * i)
                  : y.align
                    ? y.column + (qe ? 0 : 1)
                    : y.indented + (qe ? 0 : i);
      },
      ...
      jsonldMode: a,
      jsonMode: s,
      expressionAllowed: ma,
      skipExpression: function (o) {
        tr(o, "atom", "atom", "true", new e.StringStream("", 2, null));
      },
    };
  }),
...
(function (e) {
  ...
  "use strict";
  e.customOverlayMode = function (t, r, i) {
    return {
      startState: function () {
        return {
          base: e.startState(t),
      ...
      token: function (n, a) {
        return (
          (n != a.streamSeen || Math.min(a.basePos, a.overlayPos) < n.start) &&
            ((a.streamSeen = n), (a.basePos = a.overlayPos = n.start)),
          n.start == a.basePos &&
            ((a.baseCur = t.token(n, a.base)), (a.basePos = n.pos)),
          n.start == a.overlayPos &&
            ((n.pos = n.start),
            (a.overlayCur = r.token(n, a.overlay)),
            (a.overlayPos = n.pos)),
          (n.pos = Math.min(a.basePos, a.overlayPos)),
          a.baseCur &&
            a.overlayCur &&
            a.baseCur.contains("line-HyperMD-codeblock") &&
            ((a.overlayCur = a.overlayCur.replace("line-templater-inline", "")),
            (a.overlayCur += " line-background-HyperMD-codeblock-bg")),
          a.overlayCur == null
            ? a.baseCur
            : (a.baseCur != null && a.overlay.combineTokens) ||
                (i && a.overlay.combineTokens == null)
              ? a.baseCur + " " + a.overlayCur
              : a.overlayCur
        );
      },
      indent:
        t.indent &&
        function (n, a, s) {
          return t.indent(n.base, a, s);
        },
      electricChars: t.electricChars,
      innerMode: function (n) {
        return { state: n.base, mode: t };
      },
      blankLine: function (n) {
        let a, s;
        return (
          t.blankLine && (a = t.blankLine(n.base)),
          r.blankLine && (s = r.blankLine(n.overlay)),
          s == null ? a : i && a != null ? a + " " + s : s
        );
      },
    };
  };
...
var $s = $(require("@codemirror/language")),
  Gs = $(require("@codemirror/state")),
  Ys = "templater",
  Xn = "templater-command",
  Zn = "templater-inline",
  fu = "templater-opening-tag",
  hu = "templater-closing-tag",
  du = "templater-interpolation-tag",
  mu = "templater-execution-tag",
  ea = class {
    constructor(t) {
      this.plugin = t;
      ((this.cursor_jumper = new Nn(t.app)),
        (this.activeEditorExtensions = []));
    }
    desktopShouldHighlight() {
      return (
        Qn.Platform.isDesktopApp && this.plugin.settings.syntax_highlighting
      );
    }
    mobileShouldHighlight() {
      return (
        Qn.Platform.isMobile && this.plugin.settings.syntax_highlighting_mobile
      );
    }
    async setup() {
      ((this.autocomplete = new Jn(this.plugin)),
        this.plugin.registerEditorSuggest(this.autocomplete),
        await this.registerCodeMirrorMode(),
        (this.templaterLanguage = Gs.Prec.high(
          $s.StreamLanguage.define(window.CodeMirror.getMode({}, Ys)),
        )),
    ...
    async jump_to_next_cursor_location(t = null, r = !1) {
      (r && !this.plugin.settings.auto_jump_to_cursor) ||
        (t && ft(this.plugin.app) !== t) ||
    ...
    async registerCodeMirrorMode() {
      if (!this.desktopShouldHighlight() && !this.mobileShouldHighlight())
        return;
      let t = window.CodeMirror.getMode({}, "javascript");
      if (t.name === "null") {
        le(
          new C(
      ...
      let r = window.CodeMirror.customOverlayMode;
      if (r == null) {
        le(
          new C(
      ...
      window.CodeMirror.defineMode(Ys, function (i) {
        let n = {
          startState: function () {
            return {
              ...window.CodeMirror.startState(t),
              inCommand: !1,
              tag_class: "",
              freeLine: !1,
            };
          ...
          copyState: function (a) {
            let s = window.CodeMirror.startState(t),
              c = a;
            return {
              ...s,
              inCommand: c.inCommand,
              tag_class: c.tag_class,
              freeLine: c.freeLine,
            };
          },
          blankLine: function (a) {
            return a.inCommand ? "line-background-templater-command-bg" : null;
          },
          token: function (a, s) {
            let c = s;
            if ((a.sol() && c.inCommand && (c.freeLine = !0), c.inCommand)) {
              let h = "";
              if (a.match(/[-_]{0,1}%>/, !0)) {
                ((c.inCommand = !1), (c.freeLine = !1));
                let _ = c.tag_class;
                return ((c.tag_class = ""), `line-${Zn} ${Xn} ${hu} ${_}`);
              }
              let m = t.token && t.token(a, c);
              return (
                a.peek() == null &&
                  c.freeLine &&
                  (h += " line-background-templater-command-bg"),
                c.freeLine || (h += ` line-${Zn}`),
                `${h} ${Xn} ${m}`
              );
            }
            let l = a.match(/<%[-_]{0,1}\s*([*+]{0,1})/, !0);
            if (l) {
              switch (l[1]) {
                case "*":
                  c.tag_class = mu;
              ...
              return (
                (c.inCommand = !0),
                `line-${Zn} ${Xn} ${fu} ${c.tag_class}`
              );
            }
            for (; a.next() != null && !a.match(/<%/, !1););
            return null;
          },
        };
        return r(window.CodeMirror.getMode(i, "hypermd"), n);
      });
    }
    updateEditorIntellisenseSetting(t) {
      this.autocomplete.updateAutocompleteIntellisenseSetting(t);
    }
  };
var ta = class extends er.Plugin {
  constructor() {
    super(...arguments);
    this.settings = { ...gr };
  }
  async onload() {
    (await this.load_settings(),
      ...
      (this.editor_handler = new ea(this)),
      await this.editor_handler.setup(),
      (this.fuzzy_suggester = new ln(this)),
      (this.event_handler = new li(this, this.templater)),
      await this.event_handler.setup(),
      (this.command_handler = new Pn(this)),
      this.command_handler.setup(),
      (0, er.addIcon)("templater-icon", Va),
      this.addRibbonIcon("templater-icon", "Templater", () => {
        this.fuzzy_suggester.insert_template();
      }).setAttribute("id", "rb-templater-icon"),
      this.addSettingTab(new un(this)),
  ...
  async load_settings() {
    let t = await this.loadData(),
      { settings: r, affectedSecuritySettings: i, wasMigrated: n } = La(t);
    ((this.settings = r),
      i.length > 0 &&
        new er.Notice(
          "Templater: The following settings were reset because they are now device-local: " +
            i.join(", ") +
            ". Re-enable them in Templater settings if you trust this vault.",
          0,
        ),
      n && (await this.saveData(this.settings)));
  }
};
