...
var DebugHelper = class {
  ...
  logEfficiency() {
    ...
    if (!canvas) return;
    console.log(
      "NodeAdded Efficiency:",
      this.nodeAddedCount / canvas.nodes.size,
    );
    console.log(
      "NodeChanged Efficiency:",
      this.nodeChangedCount / canvas.nodes.size,
    );
    console.log(
      "EdgeAdded Efficiency:",
      this.edgeAddedCount / canvas.edges.size,
    );
    console.log(
      "EdgeChanged Efficiency:",
      this.edgeChangedCount / canvas.edges.size,
    );
  }
...
var BBoxHelper = class {
  ...
  static insideBBox(position, bbox, canTouchEdge) {
    ...
    return canTouchEdge
      ? position.minX >= bbox.minX &&
          position.maxX <= bbox.maxX &&
          position.minY >= bbox.minY &&
          position.maxY <= bbox.maxY
      : position.minX > bbox.minX &&
          position.maxX < bbox.maxX &&
          position.minY > bbox.minY &&
          position.maxY < bbox.maxY;
...
var _CanvasHelper = class _CanvasHelper {
  ...
  static createControlMenuButton(menuOption) {
    ...
    (0, import_obsidian2.setTooltip)(quickSetting, menuOption.label, {
      placement: "left",
    });
  ...
  static addControlMenuButton(controlGroup, element) {
    var _a;
    if (element.id)
      (_a = controlGroup.querySelector(`#${element.id}`)) == null
        ? void 0
        : _a.remove();
  ...
  static createCardMenuOption(
    ...
    (0, import_obsidian2.setTooltip)(menuOptionElement, menuOption.label, {
      placement: "top",
    });
    ...
    if (onRightClick)
      menuOptionElement.addEventListener("contextmenu", (e) => {
        e.preventDefault();
        onRightClick(e);
      });
  ...
  static addCardMenuOption(canvas, element) {
    ...
    if (element.id)
      (_a =
        canvas == null
          ? void 0
          : canvas.cardMenuEl.querySelector(`#${element.id}`)) == null
        ? void 0
        : _a.remove();
    ...
    const menuOptionElement = this.createPopupMenuOption({
      ...
      callback: () => {
        ...
        if (menuOptionElement.classList.contains("is-active")) {
          ...
          (_b =
            (_a = menuOptionElement.parentElement) == null
              ? void 0
              : _a.querySelector(`#${submenuId}`)) == null
            ? void 0
            : _b.remove();
          return;
        }
        ...
        const submenu =
          (_c = menuOptionElement.parentElement) == null
            ? void 0
            : _c.createDiv();
        if (!submenu) return;
  ...
  static addPopupMenuOption(canvas, element, index = -1) {
    var _a;
    const popupMenuEl =
      (_a = canvas == null ? void 0 : canvas.menu) == null ? void 0 : _a.menuEl;
  ...
  static getBBox(canvasElements) {
    const bBoxes = canvasElements
      .map((element) => {
        if ("getBBox" in element) return element.getBBox();
        if (
          element.x !== void 0 &&
          element.y !== void 0 &&
          element.width !== void 0 &&
          element.height !== void 0
        )
          return {
            minX: element.x,
            minY: element.y,
  ...
  static addStyleAttributesToPopup(
    plugin,
    canvas,
    styleAttributes,
    ...
    if (!plugin.settings.getSetting("combineCustomStylesInDropdown"))
      this.addStyleAttributesButtons(
        canvas,
        styleAttributes,
        currentStyleAttributes,
        setStyleAttribute,
      ...
      this.addStyleAttributesDropdownMenu(
        canvas,
        styleAttributes,
        currentStyleAttributes,
        setStyleAttribute,
  ...
  static addStyleAttributesButtons(
    canvas,
    stylableAttributes,
    currentStyleAttributes,
    setStyleAttribute,
    ...
    for (const stylableAttribute of stylableAttributes) {
      const selectedStyle =
        (_a = stylableAttribute.options.find(
          (option) =>
            currentStyleAttributes[stylableAttribute.key] === option.value,
        )) != null
          ? _a
          : stylableAttribute.options.find((value) => value.value === null);
      if (!selectedStyle) {
        console.warn(
          `No "null" style option found for stylable attribute "${stylableAttribute.key}"`,
        );
        continue;
      }
  ...
  static addStyleAttributesDropdownMenu(
    canvas,
    stylableAttributes,
    currentStyleAttributes,
    setStyleAttribute,
    ...
    const popupMenuElement =
      (_a = canvas == null ? void 0 : canvas.menu) == null ? void 0 : _a.menuEl;
    if (!popupMenuElement) return;
    (_b = popupMenuElement.querySelector(`#${STYLE_MENU_ID}`)) == null
      ? void 0
      : _b.remove();
    ...
    (0, import_obsidian2.setTooltip)(styleMenuButtonElement, "Style", {
      placement: "top",
    });
    styleMenuButtonElement.addEventListener("click", () => {
      ...
      if (!isOpen) {
        (_a2 = popupMenuElement.querySelector(`#${STYLE_MENU_DROPDOWN_ID}`)) ==
        null
          ? void 0
          : _a2.remove();
        (_b2 = popupMenuElement.querySelector(
      ...
      for (const stylableAttribute of stylableAttributes) {
        ...
        let selectedStyle =
          (_c = stylableAttribute.options.find(
            (option) =>
              currentStyleAttributes[stylableAttribute.key] === option.value,
          )) != null
            ? _c
        ...
        stylableAttributeElement.addEventListener("click", () => {
          var _a3;
          (_a3 = popupMenuElement.querySelector(
            `#${STYLE_MENU_DROPDOWN_SUBMENU_ID}`,
          )) == null
            ? void 0
            : _a3.remove();
          ...
          const leftPosition2 =
            ...
            popupMenuElement.getBoundingClientRect().left;
          const rightPosition2 =
            popupMenuElement.getBoundingClientRect().right -
            styleMenuDropdownElement.getBoundingClientRect().left;
          if (
            popupMenuElement.getBoundingClientRect().left + leftPosition2 <
            canvasWrapperCenterX
          )
          ...
          for (const styleOption of stylableAttribute.options) {
            const styleMenuDropdownSubmenuOptionElement =
              this.createDropdownOptionElement({
                label: styleOption.label,
                icon: styleOption.icon,
                callback: () => {
                  setStyleAttribute(stylableAttribute, styleOption.value);
                  currentStyleAttributes[stylableAttribute.key] =
                    styleOption.value;
            ...
            if (selectedStyle === styleOption) {
              ...
              const selectedIconElement =
                styleMenuDropdownSubmenuOptionElement.createDiv();
  ...
  static getBestSideForFloatingEdge(sourcePos, target) {
    ...
    const possibleTargetPos = possibleSides.map((side) => [
      side,
      BBoxHelper.getCenterOfBBoxSide(targetBBox, side),
    ]);
    let bestSide = null;
    let bestDistance = Infinity;
    for (const [side, pos] of possibleTargetPos) {
      const distance = Math.sqrt(
        Math.pow(sourcePos.x - pos.x, 2) + Math.pow(sourcePos.y - pos.y, 2),
      );
...
var SvgPathHelper = class {
  ...
  static pathArrayToRoundedSvgPath(pathArray, targetRadius) {
    if (pathArray.length < 3) return this.pathArrayToSvgPath(pathArray);
    ...
    for (let i = 1; i < pathArray.length - 1; i++) {
      ...
      const prevLen = Math.sqrt(
        prevDelta.x * prevDelta.x + prevDelta.y * prevDelta.y,
      );
      const nextLen = Math.sqrt(
        nextDelta.x * nextDelta.x + nextDelta.y * nextDelta.y,
      );
      const prevUnit = prevLen
        ? { x: prevDelta.x / prevLen, y: prevDelta.y / prevLen }
        : { x: 0, y: 0 };
      const nextUnit = nextLen
        ? { x: nextDelta.x / nextLen, y: nextDelta.y / nextLen }
        : { x: 0, y: 0 };
      ...
      commands.push(
        `A ${effectiveRadius} ${effectiveRadius} 0 0 ${sweepFlag} ${secondAnchor.x} ${secondAnchor.y}`,
      );
    }
...
var EdgePathfindingAStar = class extends EdgePathfindingMethod {
  getPath() {
    const nodeBBoxes = [...this.canvas.nodes.values()]
      .filter((node) => {
        ...
        const nodeContainsFromPos = BBoxHelper.insideBBox(
          this.fromPos,
          nodeBBox,
          true,
        );
        const nodeContainsToPos = BBoxHelper.insideBBox(
          this.toPos,
          nodeBBox,
          true,
        );
    ...
    const fromPosWithMargin = BBoxHelper.moveInDirection(
      this.fromPos,
      this.fromSide,
      10,
    );
    const toPosWithMargin = BBoxHelper.moveInDirection(
      this.toPos,
      this.toSide,
      10,
    );
    const allowDiagonal = this.plugin.settings.getSetting(
      "edgeStylePathfinderAllowDiagonal",
    );
    const pathArray = this.aStarAlgorithm(
      fromPosWithMargin,
      toPosWithMargin,
      nodeBBoxes,
      CanvasHelper.GRID_SIZE / 2,
      allowDiagonal,
    );
    ...
    let svgPath;
    const roundPath = this.plugin.settings.getSetting(
      "edgeStylePathfinderPathRounded",
    );
    if (roundPath) {
      if (allowDiagonal)
        svgPath = SvgPathHelper.pathArrayToSvgPath(
          SvgPathHelper.smoothenPathArray(pathArray, SMOOTHEN_PATH_TENSION),
        );
      else
        svgPath = SvgPathHelper.pathArrayToRoundedSvgPath(
          pathArray,
          ROUND_PATH_RADIUS,
        );
  ...
  aStarAlgorithm(fromPos, toPos, obstacles, gridResolution, allowDiagonal) {
    ...
    if (
      this.isInsideObstacle(start, obstacles) ||
      this.isInsideObstacle(end, obstacles)
    )
      return null;
    const openSet = [start];
    const closedSet = [];
    ...
    while (openSet.length > 0) {
      ...
      if (performance.now() - startTimestamp > MAX_MS_CALCULATION) return null;
      if (!current) return null;
      openSet.splice(openSet.indexOf(current), 1);
      closedSet.push(current);
      if (current.x === end.x && current.y === end.y)
        return [fromPos, ...this.reconstructPath(current), toPos].map(
          (node) => ({ x: node.x, y: node.y }),
        );
      if (
        !(current.x === start.x && current.y === start.y) &&
        this.isTouchingObstacle(current, obstacles)
      )
        continue;
      for (const neighbor of this.getPossibleNeighbors(
        current,
        obstacles,
        gridResolution,
        allowDiagonal,
  ...
  isTouchingObstacle(node, obstacles) {
    return obstacles.some((obstacle) =>
      BBoxHelper.insideBBox(node, obstacle, true),
    );
  }
  isInsideObstacle(node, obstacles) {
    return obstacles.some((obstacle) =>
      BBoxHelper.insideBBox(node, obstacle, false),
    );
  }
  ...
  getPossibleNeighbors(node, obstacles, gridResolution, allowDiagonal) {
    const neighbors = [];
    const availableDirections = allowDiagonal
      ? [...BASIC_DIRECTIONS, ...DIAGONAL_DIRECTIONS]
      : BASIC_DIRECTIONS;
...
var EdgePathfindingSquare = class extends EdgePathfindingMethod {
  getPath() {
    ...
    const isPathCollidingAtFrom =
      (this.fromSide === "top" && idealCenter.y > this.fromPos.y) ||
    ...
    const isPathCollidingAtTo =
      (this.toSide === "top" && idealCenter.y > this.toPos.y) ||
    ...
    if (this.fromSide === this.toSide) {
      ...
      BBoxHelper.isHorizontal(this.fromSide) ===
      BBoxHelper.isHorizontal(this.toSide)
    ) {
      let zPath;
      if (!isPathCollidingAtFrom || !isPathCollidingAtTo) {
        ...
        const firstFromDetourPoint = BBoxHelper.isHorizontal(this.fromSide)
          ? {
              x: CanvasHelper.alignToGrid(
                this.fromBBoxSidePos.x + fromDirection * CanvasHelper.GRID_SIZE,
              ),
              y: this.fromBBoxSidePos.y,
            }
          : {
              x: this.fromBBoxSidePos.x,
              y: CanvasHelper.alignToGrid(
                this.fromBBoxSidePos.y + fromDirection * CanvasHelper.GRID_SIZE,
              ),
            };
        ...
        const firstToDetourPoint = BBoxHelper.isHorizontal(this.toSide)
          ? {
              x: CanvasHelper.alignToGrid(
                this.toBBoxSidePos.x + toDirection * CanvasHelper.GRID_SIZE,
              ),
              y: this.toBBoxSidePos.y,
            }
          : {
              x: this.toBBoxSidePos.x,
              y: CanvasHelper.alignToGrid(
                this.toBBoxSidePos.y + toDirection * CanvasHelper.GRID_SIZE,
              ),
            };
        const newFromSide = BBoxHelper.isHorizontal(this.fromSide)
          ? firstFromDetourPoint.y < this.fromPos.y
            ? "top"
            : "bottom"
          : firstFromDetourPoint.x < firstToDetourPoint.x
            ? "right"
            : "left";
        zPath = this.getZPath(
          ...
          firstToDetourPoint,
          newFromSide,
          BBoxHelper.getOppositeSide(newFromSide),
        );
      ...
      if (isPathCollidingAtFrom || isPathCollidingAtTo) {
        if (isPathCollidingAtFrom && isPathCollidingAtTo) {
          ...
          if (BBoxHelper.isHorizontal(this.fromSide)) {
            const combinedBBoxes = BBoxHelper.combineBBoxes([
              this.fromNodeBBox,
              this.toNodeBBox,
            ]);
            firstFromDetourPoint = {
              x: CanvasHelper.alignToGrid(
                (direction > 0 ? combinedBBoxes.maxX : combinedBBoxes.minX) +
                  direction * CanvasHelper.GRID_SIZE,
              ),
              y: this.fromBBoxSidePos.y,
            };
            secondFromDetourPoint = {
              x: firstFromDetourPoint.x,
              y: BBoxHelper.getCenterOfBBoxSide(this.fromNodeBBox, this.toSide)
                .y,
            };
          } else {
            const combinedBBoxes = BBoxHelper.combineBBoxes([
            ...
            firstFromDetourPoint = {
              x: this.fromBBoxSidePos.x,
              y: CanvasHelper.alignToGrid(
                (direction > 0 ? combinedBBoxes.maxY : combinedBBoxes.minY) +
                  direction * CanvasHelper.GRID_SIZE,
              ),
            };
            secondFromDetourPoint = {
              x: BBoxHelper.getCenterOfBBoxSide(this.fromNodeBBox, this.toSide)
                .x,
          ...
          if (isPathCollidingAtFrom) {
            ...
            const firstFromDetourPoint = BBoxHelper.isHorizontal(this.fromSide)
              ? {
                  x: CanvasHelper.alignToGrid(
                    this.fromBBoxSidePos.x + direction * CanvasHelper.GRID_SIZE,
                  ),
                  y: this.fromBBoxSidePos.y,
                }
              : {
                  x: this.fromBBoxSidePos.x,
                  y: CanvasHelper.alignToGrid(
                    this.fromBBoxSidePos.y + direction * CanvasHelper.GRID_SIZE,
                  ),
                };
            const useUPath = BBoxHelper.isHorizontal(this.fromSide)
              ? this.toPos.y >
                  BBoxHelper.getCenterOfBBoxSide(
                    this.fromNodeBBox,
                    BBoxHelper.getOppositeSide(this.toSide),
                  ).y ===
                BBoxHelper.direction(this.toSide) > 0
              : this.toPos.x >
                  BBoxHelper.getCenterOfBBoxSide(
                    this.fromNodeBBox,
                    BBoxHelper.getOppositeSide(this.toSide),
            ...
            const secondFromDetourPoint = BBoxHelper.isHorizontal(this.fromSide)
              ? {
                  x: firstFromDetourPoint.x,
                  y: BBoxHelper.getCenterOfBBoxSide(
                    this.fromNodeBBox,
                    connectionSide,
                  ).y,
                }
              : {
                  x: BBoxHelper.getCenterOfBBoxSide(
                    this.fromNodeBBox,
                    connectionSide,
                  ).x,
                  y: firstFromDetourPoint.y,
          ...
          if (isPathCollidingAtTo) {
            ...
            const firstToDetourPoint = BBoxHelper.isHorizontal(this.toSide)
              ? {
                  x: CanvasHelper.alignToGrid(
                    this.toBBoxSidePos.x + direction * CanvasHelper.GRID_SIZE,
                  ),
                  y: this.toBBoxSidePos.y,
                }
              : {
                  x: this.toBBoxSidePos.x,
                  y: CanvasHelper.alignToGrid(
                    this.toBBoxSidePos.y + direction * CanvasHelper.GRID_SIZE,
                  ),
                };
            const useUPath = BBoxHelper.isHorizontal(this.toSide)
              ? this.fromPos.y >
                ...
                BBoxHelper.direction(this.fromSide) > 0
              : this.fromPos.x >
                  BBoxHelper.getCenterOfBBoxSide(
                    this.toNodeBBox,
                    BBoxHelper.getOppositeSide(this.fromSide),
        ...
        pathArray.push(this.fromPos, idealCenter, this.toPos);
        center = {
          x: pathArray[1].x,
          y: pathArray[1].y,
        };
    ...
    const svgPath = this.plugin.settings.getSetting(
  ...
  getUPath(fromPos, toPos, fromSide, toSide) {
    ...
    if (BBoxHelper.isHorizontal(fromSide)) {
      const xExtremum =
        direction > 0
          ? Math.max(fromPos.x, toPos.x)
          : Math.min(fromPos.x, toPos.x);
      const x = CanvasHelper.alignToGrid(
        xExtremum + direction * CanvasHelper.GRID_SIZE,
      );
      return {
        pathArray: [fromPos, { x, y: fromPos.y }, { x, y: toPos.y }, toPos],
        center: {
          x,
      ...
      const yExtremum =
        direction > 0
          ? Math.max(fromPos.y, toPos.y)
          : Math.min(fromPos.y, toPos.y);
      const y = CanvasHelper.alignToGrid(
        yExtremum + direction * CanvasHelper.GRID_SIZE,
      );
      return {
        pathArray: [fromPos, { x: fromPos.x, y }, { x: toPos.x, y }, toPos],
        center: {
...
function styleAttributeValidator(json) {
  ...
  if (!hasOptions)
    console.error(
      'Style attribute is missing the "options" property or it is not an array',
    );
  ...
  for (const option of json.options) {
    ...
    if (!hasIcon)
      console.error(
        `Style attribute option (${(_a = option.value) != null ? _a : option.label}) is missing the "icon" property`,
      );
    if (!hasLabel2)
      console.error(
        `Style attribute option (${option.value}) is missing the "label" property`,
      );
    if (!hasValue)
      console.error(
        `Style attribute option (${option.label}) is missing the "value" property`,
      );
  ...
  if (!hasDefault)
    console.error(
      'Style attribute is missing a default option (option with a "value" of null)',
    );
  const isValid =
    hasKey && hasLabel && hasOptions && optionsValid && hasDefault;
...
var CssStylesConfigManager = class {
  ...
  parseStyleConfigsFromCSS(sheet) {
    ...
    const textContent =
      (_b =
        (_a = sheet == null ? void 0 : sheet.ownerNode) == null
          ? void 0
          : _a.textContent) == null
        ? void 0
        : _b.trim();
...
var GET_EDGE_CSS_STYLES_MANAGER = (plugin) =>
  new CssStylesConfigManager(
    plugin,
...
var EdgeStylesExtension = class extends CanvasExtension {
  ...
  init() {
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        ...
        (canvas, node, keyboard) =>
          node.initialized && keyboard
            ? this.updateAllEdgesInArea(canvas, node.getBBox())
            : void 0,
      ),
    );
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        ...
        (canvas, isDragging) => {
          ...
          const selectedNodes = canvas
            .getSelectionData()
            .nodes.map((nodeData) => canvas.nodes.get(nodeData.id))
            .filter((node) => node !== void 0);
          const selectedNodeBBoxes = selectedNodes.map((node) =>
            node.getBBox(),
          );
  ...
  shouldUpdateEdge(canvas) {
    return (
      !canvas.isDragging ||
      this.plugin.settings.getSetting("edgeStyleUpdateWhileDragging") ||
      canvas.canvasEl.hasClass("is-connecting")
    );
  }
  onPopupMenuCreated(canvas) {
    ...
    if (
      ...
      selectedEdges.length !== canvas.selection.size
    )
      return;
  ...
  onEdgeChanged(canvas, edge) {
    ...
    if (!this.shouldUpdateEdge(canvas)) {
      const tooManySelected =
        canvas.selection.size > MAX_LIVE_UPDATE_SELECTION_SIZE;
    ...
    const pathfindingMethod =
      (_a = edgeData.styleAttributes) == null ? void 0 : _a.pathfindingMethod;
    if (pathfindingMethod && pathfindingMethod in EDGE_PATHFINDING_METHODS) {
      const fromNodeBBox = edge.from.node.getBBox();
      const fromBBoxSidePos = BBoxHelper.getCenterOfBBoxSide(
        fromNodeBBox,
        edge.from.side,
      );
      const fromPos =
        edge.from.end === "none" ? fromBBoxSidePos : edge.bezier.from;
      const toNodeBBox = edge.to.node.getBBox();
      const toBBoxSidePos = BBoxHelper.getCenterOfBBoxSide(
        toNodeBBox,
        edge.to.side,
      );
      const toPos = edge.to.end === "none" ? toBBoxSidePos : edge.bezier.to;
      const PathfindingConstructor =
        EDGE_PATHFINDING_METHODS[pathfindingMethod];
    ...
    const arrowPolygonPoints = this.getArrowPolygonPoints(
      (_c = edgeData.styleAttributes) == null ? void 0 : _c.arrow,
    );
    if ((_d = edge.fromLineEnd) == null ? void 0 : _d.el)
      (_e = edge.fromLineEnd.el.querySelector("polygon")) == null
        ? void 0
        : _e.setAttribute("points", arrowPolygonPoints);
    if ((_f = edge.toLineEnd) == null ? void 0 : _f.el)
      (_g = edge.toLineEnd.el.querySelector("polygon")) == null
        ? void 0
        : _g.setAttribute("points", arrowPolygonPoints);
  }
  onEdgeCenterRequested(_canvas, edge, center) {
    var _a, _b, _c, _d;
    center.x =
      (_b = (_a = edge.center) == null ? void 0 : _a.x) != null ? _b : center.x;
    center.y =
      (_d = (_c = edge.center) == null ? void 0 : _c.y) != null ? _d : center.y;
  }
  getArrowPolygonPoints(arrowStyle) {
    if (arrowStyle === "halved-triangle") return `-2,0 7.5,12 -2,12`;
    ...
    else if (arrowStyle === "blunt") return `-10,8 10,8 10,6 -10,6`;
    else return `0,0 6.5,10.4 -6.5,10.4`;
  }
};

// src/canvas-extensions/advanced-styles/node-styles.ts
var GET_NODE_CSS_STYLES_MANAGER = (plugin) =>
  new CssStylesConfigManager(
    plugin,
...
var VariableBreakpointCanvasExtension = class extends CanvasExtension {
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        ...
        (canvas, node, breakpointRef) =>
          this.onNodeBreakpointChanged(canvas, node, breakpointRef),
      ),
    );
  }
  onNodeBreakpointChanged(canvas, node, breakpointRef) {
    ...
    if (node.breakpoint === void 0) {
      ...
      const variableBreakpointString = computedStyle.getPropertyValue(
        VARIABLE_BREAKPOINT_CSS_VAR,
      );
      let numberBreakpoint;
      if (
        variableBreakpointString.length > 0 &&
        !isNaN((numberBreakpoint = parseFloat(variableBreakpointString)))
      )
...
var SETTINGS = {
  general: {
    ...
    children: {
      nodeTypeOnDoubleClick: {
        ...
        description:
          "The type of node that will be created when double clicking on the canvas.",
        type: "dropdown",
        options: {
          text: "Text",
          file: "File",
      ...
      disableFontSizeRelativeToZoom: {
        ...
        description:
          "When enabled, the font size of e.g. group node titles and edge labels will not increase when zooming out.",
        type: "boolean",
      },
    },
  },
  ...
  canvasMetadataCompatibilityEnabled: {
    ...
    description:
      "Make .canvas files compatible with the backlinks and outgoing links feature and show the connections in the graph view.",
    infoSection: "full-metadata-cache-support",
    children: {
      enableSingleNodeLinks: {
        label: "Enable support for linking to a node using a [[wikilink]]",
        description:
          'When enabled, you can link and embed a node using [[canvas-file#node-id]] (Use the "Copy wikilink to node" command to get an id).',
        type: "boolean",
      },
      enableSingleNodePopupReferenceCopy: {
        label: "Show button to copy node [[wikilink]]",
        description:
          "When enabled, the node popup will show a button to copy the [[wikilink]] of the node for easy reference in other notes.",
        type: "boolean",
      },
    },
  },
  nativeFileSearchEnabled: {
    ...
    description:
      "When enabled, the file search will be done using the native Obsidian file search.",
  ...
  autoFileNodeEdgesFeatureEnabled: {
    ...
    description:
      "Automatically create edges between file nodes based their frontmatter links.",
    infoSection: "auto-file-node-edges",
    children: {
      autoFileNodeEdgesFrontmatterKey: {
        label: "Frontmatter key name",
        description:
          "The frontmatter key to fetch the outgoing edges from. (Keep the default to ensure best compatibility.)",
        type: "text",
  ...
  collapsibleGroupsFeatureEnabled: {
    ...
    children: {
      collapsedGroupPreviewOnDrag: {
        ...
        description:
          "When enabled, a group that is collapsed show its border while dragging a node.",
        type: "boolean",
      },
    },
  },
  ...
  nodeStylingFeatureEnabled: {
    ...
    children: {
      customNodeStyleAttributes: {
        ...
        description:
          "Add custom style settings for nodes. (Go to GitHub for more information)",
        type: "button",
        onClick: () => {
          const anchor = activeDocument.createElement("a");
          anchor.href =
            "https://github.com/Developer-Mike/obsidian-advanced-canvas/blob/main/README.md#custom-styles";
      ...
      defaultTextNodeColor: {
        ...
        description:
          "The default color of a text node. The default range is from 0 to 6, where 0 is no color. The range can be extended by using the Custom Colors feature of Advanced Canvas.",
        type: "number",
        parse: (value) => Math.max(0, parseInt(value) || 0),
      },
      defaultTextNodeStyleAttributes: {
        ...
        getParameters(settingsManager) {
          return [
            ...
            var _a;
            return (
              setting.nodeTypes === void 0 ||
              ((_a = setting.nodeTypes) == null ? void 0 : _a.includes("text"))
            );
          });
        },
      },
  ...
  edgesStylingFeatureEnabled: {
    ...
    children: {
      customEdgeStyleAttributes: {
        ...
        description:
          "Add custom style settings for edges. (Go to GitHub for more information)",
        type: "button",
        onClick: () => {
          const anchor = activeDocument.createElement("a");
          anchor.href =
      ...
      inheritEdgeColorFromNode: {
        ...
        description:
          "When creating a new edge by dragging from a node, the edge will inherit the color of the node it is dragged from.",
        type: "boolean",
      },
      defaultEdgeColor: {
        label: "Default edge color",
        description:
          "The default color of an edge. The default range is from 0 to 6, where 0 is no color. The range can be extended by using the Custom Colors feature of Advanced Canvas.",
        type: "number",
        parse: (value) => Math.max(0, parseInt(value) || 0),
      },
      ...
      edgeStyleUpdateWhileDragging: {
        ...
        description:
          "When enabled, the edge style will be updated while dragging an edge.",
        type: "boolean",
      },
      edgeStyleSquarePathRounded: {
      ...
      edgeStylePathfinderAllowDiagonal: {
        ...
        description:
          "When enabled, the A* path style will allow diagonal paths.",
        type: "boolean",
      },
      edgeStylePathfinderPathRounded: {
  ...
  floatingEdgeFeatureEnabled: {
    ...
    description:
      "Floating edges are automatically placed on the most suitable side of the node.",
    infoSection: "floating-edges-automatic-edge-side",
    children: {
      allowFloatingEdgeCreation: {
        label: "Allow floating edges creation",
        description:
          "Allow floating edges creation by dragging the edge over the target node without placing it over a specific side connection point. (If disabled, floating edges can only be created and used by other Advanced Canvas features.)",
        type: "boolean",
      },
      newEdgeFromSideFloating: {
        label: "New edge from side floating",
        description:
          'When enabled, the "from" side of the edge will always be floating.',
        type: "boolean",
      },
    },
  },
  ...
  presentationFeatureEnabled: {
    ...
    children: {
      showSetStartNodeInPopup: {
        ...
        description:
          "If turned off, you can still set the start node using the corresponding command.",
        type: "boolean",
      },
      ...
      wrapInSlidePadding: {
        ...
        description:
          "The padding of the slide when wrapping the canvas in a slide.",
        type: "number",
        parse: (value) => Math.max(0, parseInt(value) || 0),
      },
      resetViewportOnPresentationEnd: {
        ...
        description:
          "When enabled, the viewport will be reset to the original position after the presentation ends.",
        type: "boolean",
      },
      useArrowKeysToChangeSlides: {
        label: "Use arrow keys to change slides",
        description:
          "When enabled, you can use the arrow keys to change slides in presentation mode.",
        type: "boolean",
      },
      usePgUpPgDownKeysToChangeSlides: {
        label: "Use PgUp/PgDown keys to change slides",
        description:
          "When enabled, you can use the PgUp/PgDown keys to change slides in presentation mode (Makes the presentation mode compatible with most presentation remotes).",
        type: "boolean",
      },
      zoomToSlideWithoutPadding: {
        label: "Zoom to slide without padding",
        description:
          "When enabled, the canvas will zoom to the slide without padding.",
        type: "boolean",
      },
      useUnclampedZoomWhilePresenting: {
        label: "Use unclamped zoom while presenting",
        description:
          "When enabled, the zoom will not be clamped while presenting.",
        type: "boolean",
      },
      fullscreenPresentationEnabled: {
        label: "Enter fullscreen while presenting",
        description:
          "When enabled, presentations automatically request fullscreen. Disable to keep Obsidian windowed during presentations.",
        type: "boolean",
      },
      slideTransitionAnimationDuration: {
        label: "Slide transition animation duration",
        description:
          "The duration of the slide transition animation in seconds. Set to 0 to disable the animation.",
        type: "number",
      ...
      slideTransitionAnimationIntensity: {
        ...
        description:
          "The intensity of the slide transition animation. The higher the value, the more the canvas will zoom out before zooming in on the next slide.",
        type: "number",
        parse: (value) => Math.max(0, parseFloat(value) || 0),
      },
    },
  ...
  zOrderingControlFeatureEnabled: {
    ...
    description:
      "Change the persistent z-index of nodes using the context menu.",
    children: {
      zOrderingControlShowOneLayerShiftOptions: {
        label: "Show one layer shift options",
        description:
          "When enabled, you can move nodes one layer forward or backward.",
        type: "boolean",
      },
    },
  },
  ...
  readingModeFixEnabled: {
    ...
    description:
      "Tries to synchronize editing and reading view rendering. Caution: Causes visual inconsistencies compared to the default Obsidian reading view.",
  ...
  autoResizeNodeFeatureEnabled: {
    ...
    children: {
      autoResizeNodeEnabledByDefault: {
        ...
        description:
          "When enabled, the auto resize feature will be enabled by default for all nodes.",
        type: "boolean",
      },
      autoResizeNodeMaxHeight: {
        label: "Max height",
        description:
          "The maximum height of the node when auto resizing (-1 for unlimited).",
        type: "number",
        parse: (value) => {
          var _a;
      ...
      autoResizeNodeSnapToGrid: {
        label: "Snap to grid",
        description:
          "When enabled, the height of the node will snap to the grid.",
        type: "boolean",
      },
    },
  },
  canvasEncapsulationEnabled: {
    ...
    description:
      "Encapsulate a selection of nodes and edges into a new canvas using the context menu.",
  ...
  betterReadonlyEnabled: {
    ...
    children: {
      hideBackgroundGridWhenInReadonly: {
        ...
        description:
          "When enabled, the background grid will be hidden when in readonly mode.",
        type: "boolean",
      },
    },
  },
  edgeHighlightEnabled: {
    ...
    description:
      "Highlight outgoing (and optionally incoming) edges of a selected node.",
  ...
  edgeSelectionEnabled: {
    ...
    description:
      "Select edges connected to the selected node(s) using the popup menu.",
    infoSection: "edge-selection",
    children: {
      selectEdgeByDirection: {
        label: "Select edge by direction",
        description:
          "Select incoming or outgoing edges using separate popup menu items.",
        type: "boolean",
      },
    },
  },
...
var AdvancedCanvasPluginSettingTab = class
  extends import_obsidian4.PluginSettingTab
{
  ...
  display() {
    ...
    for (const [headingId, heading] of Object.entries(SETTINGS)) {
      ...
      settingsHeaderChildrenContainerEl.classList.add(
        ...
        switch (setting.type) {
          case "text":
            this.createTextSetting(
              settingsHeaderChildrenContainerEl,
              settingId,
              setting,
            );
            break;
    ...
    if (settingsKey !== null) {
      setting.addToggle((toggle) =>
        toggle
          ...
          .setValue(this.settingsManager.getSetting(settingsKey))
  ...
  createTextSetting(containerEl, settingId, setting) {
    new import_obsidian4.Setting(containerEl)
      ...
      .addText((text) =>
        text
          .setValue(this.settingsManager.getSetting(settingId))
          .onChange(async (value) => {
            await this.settingsManager.setSetting({
              [settingId]: setting.parse ? setting.parse(value) : value,
            });
          }),
      );
  }
  ...
  createDimensionSetting(containerEl, settingId, setting) {
    ...
    new import_obsidian4.Setting(containerEl)
      ...
      .addText((text) => {
        text1 = text
          .setValue(this.settingsManager.getSetting(settingId)[0].toString())
          .onChange(
            async (value) =>
              await this.settingsManager.setSetting({
                [settingId]: setting.parse([value, text2.getValue()]),
              }),
          );
      })
      .addText((text) => {
        text2 = text
          .setValue(this.settingsManager.getSetting(settingId)[1].toString())
          .onChange(
            async (value) =>
              await this.settingsManager.setSetting({
                [settingId]: setting.parse([text1.getValue(), value]),
              }),
          );
      });
  }
  ...
  createButtonSetting(containerEl, settingId, setting) {
    new import_obsidian4.Setting(containerEl)
      ...
      .setDesc(setting.description)
      .addButton((button) =>
        button.setButtonText("Open").onClick(() => setting.onClick()),
      );
  }
  createStylesSetting(containerEl, settingId, setting) {
    ...
    for (const styleAttribute of setting.getParameters(this.settingsManager)) {
      new import_obsidian4.Setting(nestedContainerEl)
        ...
        .addDropdown((dropdown) => {
          ...
          return dropdown
            .addOptions(
              Object.fromEntries(
                styleAttribute.options.map((option) => [
                  option.value,
                  option.value === null
            ...
            .setValue(
              (_a =
                this.settingsManager.getSetting(settingId)[
                  styleAttribute.key
                ]) != null
                ? _a
                : "null",
...
var WindowsManager = class {
  constructor(plugin) {
    ...
    this.plugin = plugin;
    this.plugin.registerEvent(
      this.plugin.app.workspace.on("window-open", (_win, window2) =>
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        "window-close",
        (_win, window2) =>
          (this.windows = this.windows.filter((w) => w !== window2)),
      ),
    );
  }
};
...
var Patcher = class _Patcher {
  ...
  static async waitForViewRequest(plugin, viewType, patch) {
    return this.waitForMapValueLookup(
  ...
  static tryPatchWorkspacePrototype(plugin, getTarget, patches, uninstallers) {
    return new Promise((resolve) => {
      const result = _Patcher.patchPrototype(
        plugin,
        getTarget(),
        patches,
        uninstallers,
      ...
      const listener = plugin.app.workspace.on("layout-change", () => {
        const result2 = _Patcher.patchPrototype(
          plugin,
          getTarget(),
          patches,
          uninstallers,
...
var _MigrationHelper = class _MigrationHelper {
  static needsMigration(canvas) {
    var _a;
    return (
      ((_a = canvas.metadata) == null ? void 0 : _a.version) !==
  ...
  static migrate(canvas) {
    var _a, _b;
    let version =
      (_b = (_a = canvas.metadata) == null ? void 0 : _a.version) != null
        ? _b
        : "undefined";
    ...
    while (version !== CURRENT_SPEC_VERSION) {
      ...
      if (!migrationFunction) {
        console.error(
          `No migration function found for version ${version}. Critical error!`,
        );
        break;
      }
      const { version: newVersion, canvas: migratedCanvas } =
        migrationFunction(canvas);
      version = newVersion;
    ...
    for (const node of (_a = canvas.nodes) != null ? _a : []) {
      ...
      if (node.edgesToNodeFromPortal) {
        ...
        for (const [portalId, edges] of Object.entries(edgesToNodeFromPortal)) {
          ...
          (_b = globalInterdimensionalEdges[portalId]) == null
            ? void 0
            : _b.push(...edges);
        }
...
var CanvasPatcher = class extends Patcher {
  async patch() {
    const loadedCanvasViewLeafs = this.plugin.app.workspace
      .getLeavesOfType("canvas")
      .filter(
        (leaf) =>
          !(0, import_obsidian5.requireApiVersion)("1.7.2") || !leaf.isDeferred,
      );
    if (loadedCanvasViewLeafs.length > 0) {
      console.debug(
        `Patching and reloading loaded canvas views (Count: ${loadedCanvasViewLeafs.length})`,
      );
      this.patchCanvas(loadedCanvasViewLeafs.first().view);
      for (const leaf of loadedCanvasViewLeafs) leaf.rebuildView();
    } else {
      await Patcher.waitForViewRequest(this.plugin, "canvas", (view) =>
        this.patchCanvas(view),
      );
  ...
  patchCanvas(view) {
    ...
    Patcher.patchPrototype(this.plugin, view, {
      setEphemeralState: Patcher.OverrideExisting(
        (next) =>
          function (state) {
            var _a, _b, _c;
            ...
            if (
              ((_b = (_a = state.match) == null ? void 0 : _a.matches) == null
                ? void 0
                : _b[0]) &&
              !((_c = state.match) == null ? void 0 : _c.nodeId)
            ) {
      ...
      setViewData: Patcher.OverrideExisting(
        (next) =>
          function (json, ...args) {
            ...
            try {
              ...
              console.error(
                "Invalid JSON, repairing through Advanced Canvas:",
                e,
              );
              if (this.file)
                that.plugin.createFileSnapshot(this.file.path, json);
            ...
            that.plugin.app.workspace.trigger(
              "advanced-canvas:canvas-changed",
              this.canvas,
            );
            return result;
      ...
      close: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            that.plugin.app.workspace.trigger(
    ...
    Patcher.patchPrototype(this.plugin, view.canvas, {
      markViewportChanged: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            that.plugin.app.workspace.trigger(
      ...
      markMoved: Patcher.OverrideExisting(
        (next) =>
          function (node) {
      ...
      onDoubleClick: Patcher.OverrideExisting(
        (next) =>
          function (event) {
      ...
      setDragging: Patcher.OverrideExisting(
        (next) =>
          function (dragging) {
      ...
      // OBSIDIAN-FIX
      cloneData: Patcher.OverrideExisting(
        (next) =>
          function (elements, shift) {
            const result = next.call(this, elements, shift);
            elements.nodes = elements.nodes.map((nodeData) =>
              JSON.parse(JSON.stringify(nodeData)),
            );
            elements.edges = elements.edges.map((edgeData) =>
              JSON.parse(JSON.stringify(edgeData)),
            );
            return result;
          },
      ),
      getContainingNodes: Patcher.OverrideExisting(
        (next) =>
          function (bbox) {
      ...
      updateSelection: Patcher.OverrideExisting(
        (next) =>
          function (update) {
            ...
            that.plugin.app.workspace.trigger(
              ...
              this,
              oldSelection,
              (update2) => next.call(this, update2),
            );
            return result;
          },
      ),
      createTextNode: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
      ...
      createFileNode: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            const node = next.call(this, ...args);
            that.plugin.app.workspace.trigger(
      ...
      createFileNodes: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
      ...
      createGroupNode: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            const node = next.call(this, ...args);
            that.plugin.app.workspace.trigger(
      ...
      createLinkNode: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            const node = next.call(this, ...args);
            that.plugin.app.workspace.trigger(
      ...
      addNode: Patcher.OverrideExisting(
        (next) =>
          function (node) {
            that.patchNode(node);
      ...
      addEdge: Patcher.OverrideExisting(
        (next) =>
          function (edge) {
            that.patchEdge(edge);
            if (!this.viewportChanged)
      ...
      removeNode: Patcher.OverrideExisting(
        (next) =>
          function (node) {
            const result = next.call(this, node);
            if (!this.isClearing)
      ...
      removeEdge: Patcher.OverrideExisting(
        (next) =>
          function (edge) {
      ...
      handleCopy: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            this.isCopying = true;
            const result = next.call(this, ...args);
      ...
      handlePaste: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            this.isPasting = true;
            const result = next.call(this, ...args);
      ...
      getSelectionData: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            const result = next.call(this, ...args);
            if (this.isCopying)
      ...
      zoomToBbox: Patcher.OverrideExisting(
        (next) =>
          function (bbox) {
            that.plugin.app.workspace.trigger(
            ...
            const result = next.call(this, bbox);
            that.plugin.app.workspace.trigger(
              "advanced-canvas:zoom-to-bbox:after",
              this,
              bbox,
            );
            return result;
      ...
      zoomToRealBbox: (_next) =>
        function (bbox) {
          ...
          const zoom = this.screenshotting
            ? Math.min(widthZoom, heightZoom)
            : Math.clamp(Math.min(widthZoom, heightZoom), -4, 1);
      ...
      setReadonly: Patcher.OverrideExisting(
        (next) =>
          function (readonly) {
      ...
      clear: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
      ...
      getData: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            const result = next.call(this, ...args);
            that.plugin.app.workspace.trigger(
      ...
      importData: Patcher.OverrideExisting(
        (next) =>
          function (data, clearCanvas, silent) {
            var _a;
            const targetFilePath =
              (_a = this.view.file) == null ? void 0 : _a.path;
            const setData = (data2) => {
      ...
      requestSave: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            that.plugin.app.workspace.trigger(
              "advanced-canvas:canvas-saved:before",
              this,
            );
            const result = next.call(this, ...args);
            that.plugin.app.workspace.trigger(
    ...
    Patcher.patchPrototype(this.plugin, view.canvas.menu, {
      render: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            const result = next.call(this, ...args);
            that.plugin.app.workspace.trigger(
    ...
    Patcher.patchPrototype(this.plugin, view.canvas.nodeInteractionLayer, {
      setTarget: Patcher.OverrideExisting(
        (next) =>
          function (node) {
            const result = next.call(this, node);
            that.plugin.app.workspace.trigger(
  ...
  patchNode(node) {
    ...
    Patcher.patch(this.plugin, node, {
      ...
      setData: Patcher.OverrideExisting(
        (next) =>
          function (data, addHistory) {
      ...
      updateZIndex: Patcher.OverrideExisting(
        (next) =>
          function () {
            const persistentZIndex = this.getData().zIndex;
            if (persistentZIndex === void 0) return next.call(this);
            this.canvas.zIndexCounter = Math.max(
              this.canvas.zIndexCounter,
              persistentZIndex,
            );
            this.renderZIndex();
          },
      ),
      renderZIndex: Patcher.OverrideExisting(
        (next) =>
          function () {
            const persistentZIndex = this.getData().zIndex;
            if (persistentZIndex === void 0) return next.call(this);
            ...
            if (
              this.canvas.selection.size === 1 &&
              this.canvas.selection.has(this)
            )
              this.zIndex = this.canvas.zIndexCounter + 1;
            this.nodeEl.style.zIndex = this.zIndex.toString();
          },
      ),
      setIsEditing: Patcher.OverrideExisting(
        (next) =>
      ...
      updateBreakpoint: Patcher.OverrideExisting(
        (next) =>
          function (breakpoint) {
      ...
      getBBox: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            const result = next.call(this, ...args);
            that.plugin.app.workspace.trigger(
      ...
      onConnectionPointerdown: Patcher.OverrideExisting(
        (next) =>
          function (e, side) {
            const addEdgeEventRef = that.plugin.app.workspace.on(
              "advanced-canvas:edge-added",
              (_canvas, edge) => {
                that.plugin.app.workspace.trigger(
  ...
  patchEdge(edge) {
    ...
    Patcher.patch(this.plugin, edge, {
      ...
      getCenter: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            const result = next.call(this, ...args);
            that.plugin.app.workspace.trigger(
      ...
      onConnectionPointerdown: Patcher.OverrideExisting(
        (next) =>
          function (e) {
            ...
            const fromPos = BBoxHelper.getCenterOfBBoxSide(
              this.from.node.getBBox(),
              this.from.side,
            );
            const toPos = BBoxHelper.getCenterOfBBoxSide(
              this.to.node.getBBox(),
              this.to.side,
            );
            const draggingSide =
              Math.hypot(eventPos.x - fromPos.x, eventPos.y - fromPos.y) >
              Math.hypot(eventPos.x - toPos.x, eventPos.y - toPos.y)
                ? "to"
                : "from";
            that.plugin.app.workspace.trigger(
              "advanced-canvas:edge-connection-dragging:before",
...
var LinkSuggestionsPatcher = class extends Patcher {
  async patch() {
    ...
    const suggestManager =
      (_a = this.plugin.app.workspace.editorSuggest.suggests.find(
        (s) => s.suggestManager,
      )) == null
        ? void 0
        : _a.suggestManager;
    ...
    Patcher.patchThisAndPrototype(this.plugin, suggestManager, {
      getHeadingSuggestions: Patcher.OverrideExisting(
        (next) =>
          async function (context, path, subpath) {
            ...
            if (
              !(targetFile instanceof import_obsidian6.TFile) ||
...
var AdvancedCanvasEmbed = class extends import_obsidian7.Component {
  constructor(context, file, subpath) {
    ...
    if (!subpath)
      console.warn(
        "AdvancedCanvasEmbed: No subpath provided. This embed will not work as expected.",
      );
  }
  onload() {
  ...
  async loadFile() {
    ...
    if (canvasNode.color !== void 0) {
      ...
      this.context.containerEl.classList.add(
        `mod-canvas-color-${canvasNode.color}`,
      );
    }
...
var FilepathHelper = class {
  static extension(path) {
    var _a;
    return (path == null ? void 0 : path.includes("."))
      ? (_a = path == null ? void 0 : path.split(".")) == null
        ? void 0
        : _a.pop()
      : void 0;
  }
...
var HashHelper = class _HashHelper {
  static async getBytesHash(bytes) {
    const cryptoBytes = await crypto.subtle.digest(
      "SHA-256",
...
var TaskQueue = class {
  ...
  async run() {
    ...
    while (this.queue.length > 0) {
      const [resolver, task] =
        (_a = this.queue.shift()) != null ? _a : [void 0, void 0];
...
var MetadataCachePatcher = class extends Patcher {
  async patch() {
    ...
    Patcher.patchPrototype(this.plugin, this.plugin.app.metadataCache, {
      getCache: Patcher.OverrideExisting(
        (next) =>
          function (filepath, ...args) {
            var _a;
            if (FilepathHelper.extension(filepath) === "canvas") {
              if (
                !Object.prototype.hasOwnProperty.call(this.fileCache, filepath)
              )
                return null;
              const hash =
                (_a = this.fileCache[filepath]) == null ? void 0 : _a.hash;
              return (hash && this.metadataCache[hash]) || null;
            }
            return next.call(this, filepath, ...args);
          },
      ),
      computeFileMetadataAsync: Patcher.OverrideExisting(
        (next) =>
          async function (file, ...args) {
            if (
              file instanceof import_obsidian8.TFile &&
              (file == null ? void 0 : file.extension) === "canvas"
            )
              return CanvasMetadataHandler.computeCanvasFileMetadataAsync.call(
                this,
                file,
              );
      ...
      resolveLinks: Patcher.OverrideExisting(
        (next) =>
          async function (filepath) {
            const result = next.call(this, filepath);
            if (FilepathHelper.extension(filepath) === "canvas")
              await CanvasMetadataHandler.resolveCanvasLinks.call(
                this,
                filepath,
              );
            return result;
...
var _CanvasMetadataHandler = class _CanvasMetadataHandler {
  static async computeCanvasFileMetadataAsync(file) {
    ...
    if (!cache2) this.saveFileCache(file.path, { mtime: 0, size: 0, hash: "" });
      ...
      const unchanged =
        cache2.mtime === file.stat.mtime && cache2.size === file.stat.size;
      const hasMetadataCache =
        cache2.hash &&
        Object.prototype.hasOwnProperty.call(this.metadataCache, cache2.hash);
      if (unchanged && hasMetadataCache) isStale = false;
    }
    if (isStale) {
      _CanvasMetadataHandler.linkResolveQueue.setOnFinished(() =>
  ...
  static async updateMetadataCache(file) {
    ...
    if (metadata) return this.trigger("changed", file, data, metadata);
    const slowIndexingTimeout = window.setTimeout(() => {
      new import_obsidian8.Notice(
        `Canvas indexing taking a long time for file ${file.path}`,
      );
    }, 1e4);
    try {
      metadata = await _CanvasMetadataHandler.computeCanvasMetadataAsync.call(
        this,
        data,
      );
    } finally {
  ...
  static async computeCanvasMetadataAsync(data) {
    ...
    const frontmatter =
      (_a = content.metadata) == null ? void 0 : _a.frontmatter;
    ...
    for (const [key, value] of Object.entries(
      ...
      if (typeof value === "string")
        (_b = metadata.frontmatterLinks) == null
          ? void 0
          : _b.push(...getLinks([value]));
      else if (Array.isArray(value))
        (_c = metadata.frontmatterLinks) == null
          ? void 0
          : _c.push(...getLinks(value));
    }
    metadata.nodes = {};
    metadata.links = [];
    metadata.embeds = [];
    await Promise.all(
      ((_d = content.nodes) != null ? _d : []).map(async (node, index) => {
        var _a2, _b2;
        ...
        metadata.links.push(
          ...((_a2 = nodeMetadata.links) != null ? _a2 : []).map((link) => ({
            ...link,
            position: {
              nodeId: node.id,
        ...
        metadata.embeds.push(
          ...((_b2 = nodeMetadata.embeds) != null ? _b2 : []).map((embed2) => ({
            ...embed2,
            position: {
              nodeId: node.id,
              start: { line: 0, col: 1, offset: 0 },
    ...
    for (const [index, node] of ((_e = content.nodes) != null
      ? _e
      : []
    ).entries()) {
  ...
  static async resolveCanvasLinks(filepath) {
    ...
    const references = [
      ...((_a = metadata == null ? void 0 : metadata.links) != null ? _a : []),
      ...((_b = metadata == null ? void 0 : metadata.embeds) != null ? _b : []),
    ];
  ...
  async patch() {
    ...
    await Patcher.waitForViewRequest(this.plugin, "backlink", (view) => {
      Patcher.patchPrototype(this.plugin, view.backlink, {
        recomputeBacklink: Patcher.OverrideExisting(
          (next) =>
            function (file) {
    ...
    Patcher.patchPrototype(this.plugin, this.plugin.app.vault, {
      recurseChildrenAC: (_next) =>
        function (origin, traverse) {
          for (let stack = [origin]; stack.length > 0;) {
            const current = stack.pop();
            if (current) {
              traverse(current);
              if (current instanceof import_obsidian9.TFolder)
                stack = stack.concat(current.children);
            }
          }
        },
      getMarkdownFiles: Patcher.OverrideExisting(
        (next) =>
          function () {
            ...
            this.recurseChildrenAC(root, (child) => {
              if (
                child instanceof import_obsidian9.TFile &&
                (child.extension === "md" || child.extension === "canvas")
              ) {
                files.push(child);
              }
            });
  ...
  async patch() {
    ...
    await Patcher.waitForViewRequest(this.plugin, "outgoing-link", (view) => {
      Patcher.patchPrototype(this.plugin, view.outgoingLink, {
        recomputeLinks: Patcher.OverrideExisting(
          (next) =>
            function (...args) {
              var _a;
              const isCanvas =
                ((_a = this.file) == null ? void 0 : _a.extension) === "canvas";
        ...
        recomputeUnlinked: Patcher.OverrideExisting(
          (next) =>
            function (...args) {
              var _a;
              const isCanvas =
...
var FileManagerPatcher = class extends Patcher {
  async patch() {
    ...
    Patcher.patch(this.plugin, this.plugin.app.fileManager, {
      processFrontMatter: Patcher.OverrideExisting(
        (next) =>
          async function (file, fn, options) {
            if ((file == null ? void 0 : file.extension) === "canvas") {
              that.plugin.app.vault
                ...
                .catch(() =>
                  console.error(
                    "Failed to update metadata object in canvas file.",
                  ),
                );
              return;
            }
...
var PropertiesPatcher = class extends Patcher {
  async patch() {
    ...
    await Patcher.waitForViewRequest(this.plugin, "file-properties", (view) => {
      Patcher.patchPrototype(this.plugin, view, {
        isSupportedFile: Patcher.OverrideExisting(
          (next) =>
            function (file) {
              if ((file == null ? void 0 : file.extension) === "canvas")
                return true;
        ...
        updateFrontmatter: Patcher.OverrideExisting(
          (next) =>
        ...
        saveFrontmatter: Patcher.OverrideExisting(
          (next) =>
...
var SearchPatcher = class extends Patcher {
  ...
  patchSearchQuery(searchQuery) {
    Patcher.patchThisAndPrototype(this.plugin, searchQuery, {
      _match: Patcher.OverrideExisting(
        (next) =>
          function (data) {
            var _a, _b;
            const isCanvas =
              (_b =
                (_a = data.strings.filepath) == null
                  ? void 0
                  : _a.endsWith(".canvas")) != null
                ? _b
                : false;
            if (isCanvas && !data.cache)
              data.cache = this.app.metadataCache.getCache(
                data.strings.filepath,
              );
...
var SearchCommandPatcher = class extends Patcher {
  async patch() {
    ...
    Patcher.patch(
      this.plugin,
      this.plugin.app.commands.commands["editor:open-search"],
      {
        checkCallback: Patcher.OverrideExisting(
          (next) =>
            function (checking) {
...
var CanvasSearchView = class {
  ...
  createSearchView() {
    ...
    previousButton.addEventListener("click", () =>
      this.changeMatch(this.matchIndex - 1),
    );
  ...
  onInput() {
    ...
    if (!hasQuery) this.searchMatches = [];
      ...
      this.searchMatches = Array.from(this.view.canvas.nodes.values())
        .map((node) => {
          const nodeData = node.getData();
          let content = void 0;
...
var MetadataCanvasExtension = class extends CanvasExtension {
  ...
  init() {
    this.plugin.registerEvent(
      this.plugin.app.workspace.on("advanced-canvas:canvas-changed", (canvas) =>
  ...
  onCanvasChanged(canvas) {
    ...
    if (!metadata || metadata.version !== CURRENT_SPEC_VERSION)
      return void new import_obsidian11.Notice(
        "Metadata node not found or version mismatch. Should have been migrated (but wasn't).",
      );
    const that = this;
    const validator = {
      get(target, key) {
  ...
  onMetadataChanged(canvas) {
    ...
    const currentClasses =
      (_c =
        (_b = (_a = canvas.metadata) == null ? void 0 : _a.frontmatter) == null
          ? void 0
          : _b.cssclasses) != null
        ? _c
        : [];
...
var AbstractSelectionModal = class extends import_obsidian12.FuzzySuggestModal {
  ...
  getSuggestions(query) {
    ...
    if (
      this.arbitrary &&
      query.length > 0 &&
      !suggestions.some((s) => s.item === query)
    )
      suggestions.splice(0, 0, {
        item: query,
        match: { score: 1, matches: [[0, query.length]] },
      });
    return suggestions;
  }
...
var FileNameModal = class extends import_obsidian12.SuggestModal {
  ...
  getSuggestions(query) {
    const queryWithoutExtension = query.replace(
    ...
    return suggestions.filter(
      (s) => this.app.vault.getAbstractFileByPath(s) === null,
    );
  }
...
var FileSelectModal = class extends import_obsidian12.SuggestModal {
  constructor(app, extensionsRegex, suggestNewFile = false) {
    ...
    this.files = this.app.vault
      ...
      .filter((path) => {
        var _a;
        return (_a = FilepathHelper.extension(path)) == null
          ? void 0
          : _a.match(extensionsRegex != null ? extensionsRegex : /.*/);
      });
  ...
  getSuggestions(query) {
    const suggestions = this.files.filter((path) =>
  ...
  awaitInput() {
    return new Promise((resolve, _reject) => {
      this.onChooseSuggestion = (path, _evt) => {
        ...
        if (file instanceof import_obsidian12.TFile) return resolve(file);
...
var NodeRatioCanvasExtension = class extends CanvasExtension {
  ...
  onNodeMenu(menu, node) {
    ...
    menu.addItem((item) => {
      item
        .setTitle("Set Aspect Ratio")
        .setIcon("aspect-ratio")
        .onClick(async () => {
          const NO_RATIO = "No ratio enforcement";
          const newRatioString = await new AbstractSelectionModal(
            this.plugin.app,
            "Enter aspect ratio (width:height)",
            ["16:9", "4:3", "3:2", "1:1", NO_RATIO],
          ).awaitInput();
          const nodeData = node.getData();
...
var NodeTemplatesCanvasExtension = class extends CanvasExtension {
    ...
    for (let i = 0; i < templates.length; i++) {
      ...
      this.plugin.addCommand({
        ...
        name:
          ...
          (template.label ? `"${template.label}"` : i + 1),
        checkCallback: CanvasHelper.canvasCommand(
          this.plugin,
          (_) => true,
          (canvas) => {
            const center = canvas.posCenter();
            void this.createNodeFromTemplate(canvas, template, {
  ...
  onCardMenuCreated(canvas) {
    var _a;
    const existingButtons = canvas.cardMenuEl.querySelectorAll(
      `[id^="${TEMPLATE_NODE_BUTTON_ID_PREFIX}"]`,
    );
      ...
      CanvasHelper.addCardMenuOption(
        ...
        CanvasHelper.createCardMenuOption(
          canvas,
          {
            ...
            label:
              "Drag to add template node " +
              (template.label ? `"${template.label}"` : i + 1),
            icon: (_a = template.icon) != null ? _a : "book-dashed",
          },
          () => ({ width: template.width, height: template.height }),
          (canvas2, pos) =>
            void this.createNodeFromTemplate(canvas2, template, pos),
  ...
  async createNodeFromTemplate(canvas, template, pos) {
    ...
    if (template.type === "text") node = canvas.createTextNode(creationOptions);
      ...
      tfile != null
        ? tfile
        : (tfile = await new FileSelectModal(
            this.plugin.app,
            void 0,
            true,
          ).awaitInput());
      ...
      node = canvas.createGroupNode(creationOptions);
    else if (template.type === "link")
      node = canvas.createLinkNode({ ...creationOptions, url: template.url });
      ...
      item
        ...
        .onClick(async () => {
          ...
          const index = parseInt(
            buttonEl.id.replace(TEMPLATE_NODE_BUTTON_ID_PREFIX, ""),
          );
          const templates = this.plugin.settings.getSetting("nodeTemplates");
  ...
  async saveNodeAsTemplate(canvas) {
    ...
    if (!icon) {
      new import_obsidian13.Notice(
        "No icon selected, template creation cancelled.",
      );
      return;
    }
    const label = await new AbstractSelectionModal(
      this.plugin.app,
      "Set template label (optional)",
      [],
      true,
    ).awaitInput();
    await this.plugin.settings.setSetting({
      nodeTemplates: [
        ...this.plugin.settings.getSetting("nodeTemplates"),
        {
          ...
          path:
            selectedNodeData.type === "file" ? selectedNodeData.file : void 0,
...
var PresentationCanvasExtension = class extends CanvasExtension {
  ...
  init() {
    this.plugin.registerEvent(
      this.plugin.app.workspace.on("canvas:selection-menu", (menu, canvas) => {
        menu.addItem((item) =>
          item
            ...
            .onClick(() =>
              this.addSlide(
                canvas,
                void 0,
                BBoxHelper.enlargeBBox(
                  BBoxHelper.combineBBoxes(
                    [...canvas.selection.values()].map((element) =>
                      element.getBBox(),
                    ),
                  ),
    ...
    this.plugin.addCommand({
      ...
      checkCallback: CanvasHelper.canvasCommand(
        ...
        (canvas) =>
          ...
          canvas.getSelectionData().nodes.length === 1,
        (canvas) =>
          this.setStartNode(
            canvas,
            canvas.nodes.get(canvas.getSelectionData().nodes[0].id),
          ),
      ),
    });
    this.plugin.addCommand({
  ...
  async animateNodeTransition(canvas, fromNode, toNode) {
    const removePadding = this.plugin.settings.getSetting(
      "zoomToSlideWithoutPadding",
    );
    const animationDurationMs =
      this.plugin.settings.getSetting("slideTransitionAnimationDuration") * 1e3;
    const toNodeBBox = CanvasHelper.getSmallestAllowedZoomBBox(
      canvas,
      toNode.getBBox(),
    );
    const toNodeBBoxPadded = removePadding
      ? toNodeBBox
      : BBoxHelper.enlargeBBox(toNodeBBox, 50);
    if (animationDurationMs > 0 && fromNode) {
      const animationIntensity = this.plugin.settings.getSetting(
        "slideTransitionAnimationIntensity",
      );
      const fromNodeBBox = CanvasHelper.getSmallestAllowedZoomBBox(
        canvas,
        fromNode.getBBox(),
      );
      const fromNodeBBoxPadded = removePadding
        ? fromNodeBBox
        : BBoxHelper.enlargeBBox(fromNodeBBox, 50);
      const currentNodeBBoxEnlarged = BBoxHelper.scaleBBox(
        fromNodeBBoxPadded,
        animationIntensity,
      );
      ...
      if (fromNode.getData().id !== toNode.getData().id) {
        const nextNodeBBoxEnlarged = BBoxHelper.scaleBBox(
          toNodeBBoxPadded,
          animationIntensity,
        );
  ...
  async startPresentation(canvas, tryContinue = false) {
    if (!tryContinue || this.visitedNodeIds.length === 0) {
      const startNode2 =
        ...
        canvas.nodes.get(canvas.metadata["startNode"]);
      if (!startNode2) {
        new import_obsidian14.Notice(
          "No start node found. Please mark a node as a start node through the popup menu.",
        );
        return;
      }
    ...
    const shouldEnterFullscreen = this.plugin.settings.getSetting(
      "fullscreenPresentationEnabled",
    );
    ...
    if (this.presentationUsesFullscreen) {
      this.fullscreenModalObserver = new MutationObserver((mutationRecords) => {
        mutationRecords.forEach((mutationRecord) => {
          mutationRecord.addedNodes.forEach((node) => {
            ...
            (_a = activeDocument.fullscreenElement) == null
              ? void 0
              : _a.appendChild(node);
          });
        });
      ...
      this.fullscreenModalObserver.observe(activeDocument.body, {
        childList: true,
      });
  ...
  nextNode(canvas) {
    ...
    if (!fromNode) return;
    const outgoingEdges = canvas
      .getEdgesForNode(fromNode)
      .filter((edge) => edge.from.node.getData().id === fromNodeId);
    ...
    if (outgoingEdges.length > 1) {
      ...
      const traversedEdgesCount =
        this.visitedNodeIds.filter(
          (visitedNodeId) => visitedNodeId === fromNodeId,
        ).length - 1;
      const nextEdge = sortedEdges[traversedEdgesCount];
      toNode =
        (_b = nextEdge == null ? void 0 : nextEdge.to) == null
          ? void 0
          : _b.node;
    }
    if (toNode) {
...
var ZOrderingCanvasExtension = class extends CanvasExtension {
  ...
  init() {
    this.plugin.registerEvent(
      this.plugin.app.workspace.on("canvas:node-menu", (menu, node) =>
        this.nodeContextMenu(node, menu),
      ),
    );
    this.plugin.registerEvent(
      this.plugin.app.workspace.on("canvas:selection-menu", (menu, canvas) =>
        this.selectionContextMenu(canvas, menu),
      ),
    );
  }
  ...
  moveOneLayer(canvas, selectedNode, forward) {
    ...
    const collidingNodes = [...canvas.nodes.values()]
      .filter((node) =>
        BBoxHelper.isColliding(selectedNodeBBox, node.getBBox()),
      )
      .filter((node) => node !== selectedNode);
    const nearestZIndexNode = collidingNodes
      .sort((a, b) => (forward ? a.zIndex - b.zIndex : b.zIndex - a.zIndex))
      .filter((node) =>
        forward
          ? node.zIndex > selectedNode.zIndex
          : node.zIndex < selectedNode.zIndex,
      )
      .first();
...
var BetterReadonlyCanvasExtension = class extends CanvasExtension {
  ...
  addQuickSettings(canvas) {
    ...
    const settingsContainer =
      (_a = canvas.quickSettingsButton) == null ? void 0 : _a.parentElement;
    ...
    const toggle = CanvasHelper.createControlMenuButton({
      ...
      callback: () =>
        void (async () => {
          ...
          toggle.dataset.toggled = JSON.stringify(
            this.plugin.settings.getSetting(settingKey),
          );
  ...
  updatePopupMenu(canvas) {
    const hidden =
      canvas.readonly && this.plugin.settings.getSetting("disableNodePopup");
...
var EncapsulateCanvasExtension = class extends CanvasExtension {
  ...
  async encapsulateSelection(canvas) {
    ...
    const canvasSettings =
      this.plugin.app.internalPlugins.plugins.canvas.instance.options;
    ...
    if (defaultNewCanvasLocation === "current")
      targetFolderPath =
        (_c =
          (_b = (_a = canvas.view.file) == null ? void 0 : _a.parent) == null
            ? void 0
            : _b.path) != null
          ? _c
          : targetFolderPath;
      ...
      targetFolderPath =
        (_d = canvasSettings.newFileFolderPath) != null ? _d : targetFolderPath;
...
var CopyNodeReferenceCanvasExtension = class _CopyNodeReferenceCanvasExtension extends CanvasExtension {
  ...
  onPopupMenuCreated(canvas) {
    ...
    const menuOption = {
      ...
      icon: "link",
      callback: () =>
        _CopyNodeReferenceCanvasExtension.copyWikilinkToNode(
          canvas.view.file,
          selectionData.nodes[0],
        ),
    };
      ...
      .then(
        () =>
          new import_obsidian15.Notice(
            "Copied wikilink to node to clipboard.",
            2e3,
          ),
      )
      .catch(
        () =>
          new import_obsidian15.Notice(
            "Failed to copy wikilink to node to clipboard.",
            2e3,
          ),
      );
  }
...
var CommandsCanvasExtension = class extends CanvasExtension {
  ...
  init() {
        ...
        checkCallback: CanvasHelper.canvasCommand(
          ...
          (canvas) => {
            ...
            return (
              !canvas.readonly &&
              canvas.selection.size === 1 &&
              ((_a = canvas.selection.values().next().value) == null
                ? void 0
                : _a.getData().type) === "text"
            );
          },
    ...
    this.plugin.addCommand({
      ...
      checkCallback: CanvasHelper.canvasCommand(
        this.plugin,
        (canvas) => !canvas.readonly && canvas.selection.size > 0,
        (canvas) => this.flipSelection(canvas, true),
      ),
    });
    this.plugin.addCommand({
    ...
    this.plugin.addCommand({
      ...
      checkCallback: CanvasHelper.canvasCommand(
        this.plugin,
        (canvas) =>
          !canvas.readonly && canvas.getSelectionData().nodes.length === 2,
        (canvas) => {
          const selectedNodes = canvas
            .getSelectionData()
            .nodes.map((nodeData) => canvas.nodes.get(nodeData.id))
          ...
          nodeA.setData({
            ...
            x: nodeBData.x,
            y: nodeBData.y,
            width: nodeBData.width,
            height: nodeBData.height,
          });
          nodeB.setData({
            ...nodeBData,
            x: nodeAData.x,
            y: nodeAData.y,
            width: nodeAData.width,
            height: nodeAData.height,
          });
          canvas.pushHistory(canvas.getData());
        },
      ),
    ...
    this.plugin.addCommand({
      ...
      checkCallback: CanvasHelper.canvasCommand(
        ...
        (canvas) => {
          ...
          let selectedNodeIds = canvas
            .getSelectionData()
            .nodes.map((node) => node.id);
          if (selectedNodeIds.length === 0)
            selectedNodeIds = [...canvas.nodes.keys()];
          const metadata =
            this.plugin.app.metadataCache.getFileCache(canvasFile);
          if (!metadata) return;
          const outgoingLinks = /* @__PURE__ */ new Set();
          for (const nodeId of selectedNodeIds) {
            let relativeFile = canvasFile;
            let nodeOutgoingLinks =
              (_b = (_a = metadata.nodes) == null ? void 0 : _a[nodeId]) == null
                ? void 0
                : _b.links;
            if (!nodeOutgoingLinks) {
              const file =
                (_c = canvas.nodes.get(nodeId)) == null ? void 0 : _c.file;
              if (!file) continue;
              const fileMetadata =
                this.plugin.app.metadataCache.getFileCache(file);
              nodeOutgoingLinks =
                fileMetadata == null ? void 0 : fileMetadata.links;
              relativeFile = file;
            }
    ...
    this.plugin.addCommand({
      ...
      checkCallback: CanvasHelper.canvasCommand(
        ...
        (canvas) => {
          const canvasFile = canvas.view.file;
          if (!canvasFile) return;
          const selectedNodesData = canvas
            .getSelectionData()
            .nodes.map((node) => node);
          ...
          if (selectedNodesData.length > 0) {
            for (const nodeData of selectedNodesData) {
              ...
              for (const nodeBacklink of nodeBacklinks.data.keys()) {
                ...
                if (!(resolvedLink instanceof import_obsidian16.TFile))
                  continue;
                backlinks.add(resolvedLink);
              }
            }
          } else {
            const canvasBacklinks =
              this.plugin.app.metadataCache.getBacklinksForFile(canvasFile);
  ...
  async createFileNode(canvas, file) {
    ...
    file != null
      ? file
      : (file = await new FileSelectModal(
          this.plugin.app,
          void 0,
          true,
        ).awaitInput());
  ...
  cloneNode(canvas, cloneDirection) {
    ...
    const offset = {
      x:
        (sourceNode.width + nodeMargin) *
        (cloneDirection === "left" ? -1 : cloneDirection === "right" ? 1 : 0),
      y:
        (sourceNode.height + nodeMargin) *
        (cloneDirection === "up" ? -1 : cloneDirection === "down" ? 1 : 0),
    };
  ...
  expandNode(canvas, expandDirection) {
    ...
    if (!node) return;
    const expandNodeStepSize =
      this.plugin.settings.getSetting("expandNodeStepSize");
    const expand = {
  ...
  flipSelection(canvas, horizontally) {
    ...
    for (const edge of canvas.edges.values()) {
      ...
      if (
        nodeIds.has(edgeData.fromNode) &&
        BBoxHelper.isHorizontal(edgeData.fromSide) === horizontally
      )
        newFromSide = BBoxHelper.getOppositeSide(edgeData.fromSide);
      let newToSide = edgeData.toSide;
      if (
        nodeIds.has(edgeData.toNode) &&
        BBoxHelper.isHorizontal(edgeData.toSide) === horizontally
      )
  ...
  getNextNode(canvas, direction) {
    ...
    const selectedNodeData =
      (_a = canvas.getSelectionData().nodes) == null ? void 0 : _a.first();
    ...
    const possibleTargetNodes = Array.from(canvas.nodes.values()).filter(
      (node) => {
        const nodeData = node.getData();
        return (
          nodeData.id !== selectedNodeData.id &&
          (nodeData.type === "text" || nodeData.type === "file")
        );
      },
    );
    const closestNode = possibleTargetNodes.reduce((closestNode2, node) => {
      ...
      const isInVerticalRange =
        selectedNodeBBox.minY <= nodeBBox.maxY &&
        selectedNodeBBox.maxY >= nodeBBox.minY;
      const isInHorizontalRange =
        selectedNodeBBox.minX <= nodeBBox.maxX &&
        selectedNodeBBox.maxX >= nodeBBox.minX;
...
var AutoResizeNodeCanvasExtension = class extends CanvasExtension {
  ...
  init() {
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        "advanced-canvas:node-editing-state-changed",
        (canvas, node, editing) =>
          void this.onNodeEditingStateChanged(canvas, node, editing),
      ),
    );
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        "advanced-canvas:node-text-content-changed",
        (canvas, node, viewUpdate) =>
          void this.onNodeTextContentChanged(canvas, node, viewUpdate.view.dom),
      ),
    );
  }
  isValidNodeType(nodeData) {
    return (
      nodeData.type === "text" ||
      (nodeData.type === "file" && nodeData.file.endsWith(".md"))
    );
  }
  onNodeCreated(_canvas, node) {
    const autoResizeNodeEnabledByDefault = this.plugin.settings.getSetting(
      "autoResizeNodeEnabledByDefault",
    );
  ...
  onPopupMenuCreated(canvas) {
    ...
    const selectedNodes = canvas
      .getSelectionData()
      .nodes.filter((nodeData) => this.isValidNodeType(nodeData))
      .map((nodeData) => canvas.nodes.get(nodeData.id))
      .filter((node) => node !== void 0);
    if (selectedNodes.length === 0) return;
    const autoResizeHeightEnabled = selectedNodes.some(
      (node) => node.getData().dynamicHeight,
    );
    CanvasHelper.addPopupMenuOption(
      canvas,
      CanvasHelper.createPopupMenuOption({
        id: "auto-resize-height",
        label: autoResizeHeightEnabled
          ? "Disable auto-resize"
          : "Enable auto-resize",
  ...
  async onNodeEditingStateChanged(_canvas, node, editing) {
    ...
    await sleep(10);
    if (editing) {
      void this.onNodeTextContentChanged(
        _canvas,
        node,
        node.child.editMode.cm.dom,
      );
      return;
    }
    const renderedMarkdownContainer = node.nodeEl.querySelector(
  ...
  setNodeHeight(node, height) {
    if (height === 0) return;
    const maxHeight = this.plugin.settings.getSetting(
      "autoResizeNodeMaxHeight",
    );
    ...
    if (this.plugin.settings.getSetting("autoResizeNodeSnapToGrid"))
      height =
        Math.ceil(height / CanvasHelper.GRID_SIZE) * CanvasHelper.GRID_SIZE;
    node.setData({
      ...nodeData,
      height,
    });
...
var PortalsCanvasExtension = class _PortalsCanvasExtension extends CanvasExtension {
  ...
  init() {
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        "advanced-canvas:dragging-state-changed",
        (canvas, startedDragging) =>
          this.onDraggingStateChanged(canvas, startedDragging),
      ),
    );
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        "advanced-canvas:containing-nodes-requested",
        (canvas, bbox, nodes) =>
          this.onContainingNodesRequested(canvas, bbox, nodes),
      ),
    );
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        "advanced-canvas:edge-connection-try-dragging:before",
        (canvas, edge, event, cancelRef) =>
          this.onEdgeConnectionTryDraggingBefore(
            canvas,
            edge,
            event,
            cancelRef,
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        "advanced-canvas:edge-connection-dragging:after",
        (canvas, edge, event, newEdge, side, previousEnds) =>
          this.onEdgeConnectionDraggingAfter(
            canvas,
            edge,
            event,
            newEdge,
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        "advanced-canvas:selection-changed",
        (canvas, oldSelection, updateSelection) =>
          this.onSelectionChanged(canvas, oldSelection, updateSelection),
      ),
    );
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
      ...
      this.plugin.app.workspace.on(
        ...
        (canvas, data, setData) => {
          this.onSetData(canvas, data)
            .then((newData) => {
              if (
                newData.nodes.length === data.nodes.length &&
                newData.edges.length === data.edges.length
              )
                return;
              setData(newData);
            })
            .catch((error) => {
              ...
              new import_obsidian17.Notice(
                "An error occurred while loading portal data. Please check console for details.",
              );
            });
        },
      ),
  ...
  onFileModified(canvas, file) {
    const isAffected =
      Object.values(canvas.nodes).filter(
        (nodeData) =>
  ...
  onContainingNodesRequested(_canvas, _bbox, nodes) {
    const filteredNodes = nodes.filter(
      (node) => !_PortalsCanvasExtension.isPortalElement(node.id),
    );
    nodes.splice(0, nodes.length, ...filteredNodes);
  }
  onSelectionChanged(canvas, _oldSelection, updateSelection) {
    updateSelection(() => {
      const updatedSelection = Array.from(canvas.selection).filter(
        (canvasElement) =>
          !_PortalsCanvasExtension.isPortalElement(canvasElement.id),
      );
  ...
  onDraggingStateChanged(canvas, startedDragging) {
    ...
    if (
      !canvas
        .getSelectionData()
        .nodes.some((node) => node.type === "file" && node.portal)
    )
      return;
  ...
  onNodeResized(_canvas, portalNode) {
    ...
    portalNode.setData({
      ...
      height: portalNode.prevHeight
        ? portalNode.prevHeight
        : portalNodeData.height,
    });
  }
  ...
  onEdgeConnectionTryDraggingBefore(_canvas, edge, _event, cancelRef) {
    ...
    new import_obsidian17.Notice(
      "Updating edges from portals is not supported yet.",
    );
  }
  onEdgeConnectionDraggingAfter(
    canvas,
    edge,
    _event,
    _newEdge,
    ...
    if (_PortalsCanvasExtension.isPortalElement(edge.id)) return;
    if (
      !_PortalsCanvasExtension.isPortalElement(edge.from.node.id) ||
      !_PortalsCanvasExtension.isPortalElement(edge.to.node.id)
    )
      return;
    canvas.removeEdge(edge);
    new import_obsidian17.Notice(
      "Creating edges with both ends in portals are not supported yet.",
    );
  }
  onPopupMenu(canvas) {
    if (canvas.readonly) return;
    const selectedFileNodes = canvas
      .getSelectionData()
      .nodes.map((nodeData) => {
        var _a;
        const node = canvas.nodes.get(nodeData.id);
    ...
    const portalNodeData = portalNode.getData();
    if (
      portalNodeData.portal &&
      portalNodeData.file !== portalNode.currentPortalFile
    )
  ...
  onGetData(_canvas, data) {
    data.nodes = data.nodes.filter(
      (nodeData) => !_PortalsCanvasExtension.isPortalElement(nodeData.id),
    );
    for (const nodeData of data.nodes) delete nodeData.isPortalLoaded;
    const portalsIdMap = new Map(
      data.nodes
        .filter((nodeData) => nodeData.portal)
    ...
    data.edges = data.edges.filter((edgeData) => {
      ...
      const isFromNodeFromPortal =
        _PortalsCanvasExtension.getNestedIds(edgeData.fromNode).length > 1;
      const isToNodeFromPortal =
        _PortalsCanvasExtension.getNestedIds(edgeData.toNode).length > 1;
      if (!isFromNodeFromPortal && !isToNodeFromPortal) return true;
      if (isFromNodeFromPortal && isToNodeFromPortal) return false;
      const targetPortalId = this.getParentPortalId(
        isFromNodeFromPortal ? edgeData.fromNode : edgeData.toNode,
      );
      const targetPortalData = portalsIdMap.get(targetPortalId);
      if (!targetPortalData) return false;
      (_a = targetPortalData.interdimensionalEdges) != null
        ? _a
        : (targetPortalData.interdimensionalEdges = []);
  ...
  async onSetData(canvas, dataRef) {
    ...
    const addedData = await Promise.all(
      data.nodes.map((nodeData) => this.tryOpenPortal(canvas, nodeData)),
    );
  ...
  async tryOpenPortal(
    canvas,
    portalNodeData,
    nestedPortalFiles = /* @__PURE__ */ new Set(),
  ) {
    ...
    const portalFile = this.plugin.app.vault.getAbstractFileByPath(
      portalNodeData.file,
    );
    if (
      !(portalFile instanceof import_obsidian17.TFile) ||
      portalFile.extension !== "canvas"
    )
      return addedData;
    const portalFileDataString =
      await this.plugin.app.vault.cachedRead(portalFile);
    ...
    for (const nodeDataFromPortal of portalFileData.nodes) {
      ...
      const nestedNodes = await this.tryOpenPortal(
        canvas,
        addedNode,
        nestedPortalFiles,
      );
    ...
    const targetSize = this.getPortalSize(
      CanvasHelper.getBBox(addedData.nodes),
    );
  ...
  getPortalSize(sourceBBox) {
    ...
    const targetSize = {
      width: Math.max(
        sourceSize.width + PORTAL_PADDING * 2,
        MIN_OPEN_PORTAL_SIZE.width,
      ),
      height: Math.max(
        sourceSize.height + PORTAL_PADDING * 2,
        MIN_OPEN_PORTAL_SIZE.height,
      ),
    };
  ...
  isChildOfPortal(portal, canvasElement, directChild = true) {
    ...
    return (
      canvasElement.id !== portal.id && // Not the portal itself
      ...
      CanvasHelper.createControlMenuButton({
        ...
        callback: () => {
          ...
          const propertiesPlugin =
            this.plugin.app.internalPlugins.plugins["properties"];
          if (!(propertiesPlugin == null ? void 0 : propertiesPlugin._loaded)) {
            new import_obsidian18.Notice(
              `Core plugin "Properties view" was not found or isn't enabled. Enable it and restart Obsidian.`,
            );
            return;
          }
          let propertiesLeaf =
            (_a2 = this.plugin.app.workspace
              .getLeavesOfType("file-properties")
              .first()) != null
              ? _a2
              : null;
          if (!propertiesLeaf) {
            propertiesLeaf = this.plugin.app.workspace.getRightLeaf(false);
            void (propertiesLeaf == null
              ? void 0
              : propertiesLeaf.setViewState({ type: "file-properties" }));
          }
          if (propertiesLeaf)
            void this.plugin.app.workspace.revealLeaf(propertiesLeaf);
        },
      }),
    );
  }
...
var BetterDefaultSettingsCanvasExtension = class extends CanvasExtension {
  ...
  init() {
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on("advanced-canvas:settings-changed", () =>
        this.modifyCanvasSettings(this.plugin.getCurrentCanvas()),
      ),
    );
    this.plugin.registerEvent(
      this.plugin.app.workspace.on("advanced-canvas:canvas-changed", (canvas) =>
        this.modifyCanvasSettings(canvas),
      ),
    );
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        "advanced-canvas:double-click",
        (canvas, event, preventDefault) =>
          void this.onDoubleClick(canvas, event, preventDefault),
      ),
    );
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
  ...
  modifyCanvasSettings(canvas) {
    if (!canvas) return;
    const defaultTextNodeDimensionsArray = this.plugin.settings.getSetting(
      "defaultTextNodeDimensions",
    );
    ...
    const defaultFileNodeDimensionsArray = this.plugin.settings.getSetting(
      "defaultFileNodeDimensions",
    );
    ...
    canvas.config.minContainerDimension =
      this.plugin.settings.getSetting("minNodeSize");
  }
  async onDoubleClick(canvas, event, preventDefault) {
    if (
      event.defaultPrevented ||
      event.target !== canvas.wrapperEl ||
      canvas.isDragging ||
      canvas.readonly
    )
      return;
    ...
    switch (this.plugin.settings.getSetting("nodeTypeOnDoubleClick")) {
      case "file": {
        const file = await new FileSelectModal(
          this.plugin.app,
          void 0,
          true,
        ).awaitInput();
  ...
  applyDefaultNodeStyles(_canvas, node) {
    ...
    let color = this.plugin.settings
      .getSetting("defaultTextNodeColor")
      .toString();
  ...
  async applyDefaultEdgeStyles(canvas, edge) {
    ...
    if (canvas.canvasEl.hasClass("is-connecting")) {
      await new Promise((resolve) => {
        ...
        }).observe(canvas.canvasEl, {
          attributes: true,
          attributeFilter: ["class"],
        });
      });
    }
    const lineDirection = this.plugin.settings.getSetting(
      "defaultEdgeLineDirection",
    );
    edge.setData({
      ...edge.getData(),
...
var ColorPaletteCanvasExtension = class extends CanvasExtension {
  ...
  init() {
    this.plugin.registerEvent(
      this.plugin.app.workspace.on("window-open", (_win, _window) =>
  ...
  updateCustomColorModStyleClasses() {
    var _a;
    const customCss = this.getCustomColors()
      .map(
        (colorId) => `
    ...
    for (const win of this.plugin.windowsManager.windows) {
      ...
      (_a = doc.getElementById(CUSTOM_COLORS_MOD_STYLES_ID)) == null
        ? void 0
        : _a.remove();
  ...
  patchColorSelection(canvas) {
    ...
    this.observer = new MutationObserver((mutations) => {
      const colorMenuOpened = mutations.some((mutation) =>
        Object.values(mutation.addedNodes).some(
          (node) =>
            node.instanceOf(HTMLElement) &&
            node.classList.contains("canvas-submenu") &&
            Object.values(node.childNodes).some(
              (node2) =>
                node2.instanceOf(HTMLElement) &&
                node2.classList.contains("canvas-color-picker-item"),
            ),
        ),
      );
...
var CollapsibleGroupsCanvasExtension = class extends CanvasExtension {
  ...
  init() {
    ...
    this.plugin.addCommand({
      ...
      checkCallback: CanvasHelper.canvasCommand(
        ...
        (canvas) =>
          canvas.selection.size === 1 &&
          canvas.selection.values().next().value.getData().type === "group",
        (canvas) =>
          this.toggleCollapseGroup(
            canvas,
  ...
  onNodeChanged(canvas, groupNode) {
    ...
    (0, import_obsidian19.setIcon)(
      collapseEl,
      groupNodeData.collapsed ? "plus-circle" : "minus-circle",
    );
    collapseEl.onclick = () => this.toggleCollapseGroup(canvas, groupNode);
    groupNode.collapseEl = collapseEl;
    (_b = groupNode.labelEl) == null
      ? void 0
      : _b.insertAdjacentElement("afterend", collapseEl);
  }
  onCopy(_canvas, selectionData) {
    for (const collapsedGroupData of selectionData.nodes) {
      if (
        collapsedGroupData.type !== "group" ||
        !collapsedGroupData.collapsed ||
        !collapsedGroupData.collapsedData
      )
        continue;
      selectionData.nodes.push(
        ...collapsedGroupData.collapsedData.nodes.map((nodeData) => ({
          ...nodeData,
  ...
  onNodeBBoxRequested(canvas, node, bbox) {
    ...
    const collapseElBBox =
      (_a = node.collapseEl) == null ? void 0 : _a.getBoundingClientRect();
    if (!collapseElBBox) return;
    const labelElBBox =
      (_b = node.labelEl) == null ? void 0 : _b.getBoundingClientRect();
    if (!labelElBBox) return;
    const minPos = canvas.posFromClient({
      x: collapseElBBox.left,
      y: collapseElBBox.top,
    });
    const maxPos = canvas.posFromClient({
      x: labelElBBox.right,
      y: collapseElBBox.bottom,
    });
    bbox.minX = minPos.x;
    bbox.minY = minPos.y;
    bbox.maxX = maxPos.x;
  ...
  collapseNodes(data) {
    var _a;
    (_a = data == null ? void 0 : data.nodes) == null
      ? void 0
      : _a.forEach((groupNodeData) => {
          var _a2, _b, _c, _d;
          ...
          const containedNodesData = data.nodes.filter(
            (nodeData) =>
              nodeData.id !== groupNodeData.id &&
              BBoxHelper.insideBBox(
                CanvasHelper.getBBox([nodeData]),
                groupNodeBBox,
                false,
              ),
          );
          const containedEdgesData = data.edges.filter((edgeData) => {
            return (
              containedNodesData.some(
                (nodeData) => nodeData.id === edgeData.fromNode,
              ) ||
              containedNodesData.some(
                (nodeData) => nodeData.id === edgeData.toNode,
              )
            );
          });
          data.nodes = data.nodes.filter(
            (nodeData) => !containedNodesData.includes(nodeData),
          );
          data.edges = data.edges.filter(
            (edgeData) => !containedEdgesData.includes(edgeData),
          );
          const newContainedNodesData = containedNodesData.filter(
            (nodeData) => {
              var _a3, _b2, _c2;
              return !((_c2 =
                (_b2 =
                  (_a3 = groupNodeData.collapsedData) == null
                    ? void 0
                    : _a3.nodes) == null
                  ? void 0
                  : _b2.some((e) => e.id === nodeData.id)) != null
                ? _c2
                : false);
            },
          );
          const newContainedEdgesData = containedEdgesData.filter(
            (edgeData) => {
              var _a3, _b2, _c2;
              return !((_c2 =
                (_b2 =
                  (_a3 = groupNodeData.collapsedData) == null
                    ...
                    : _a3.edges) == null
                  ? void 0
                  : _b2.some((n) => n.id === edgeData.id)) != null
                ? _c2
                : false);
            },
          );
          groupNodeData.collapsedData = {
            nodes: [
              ...((_b =
                (_a2 = groupNodeData.collapsedData) == null
                  ? void 0
                  : _a2.nodes) != null
                ? _b
                : []),
            ...
            edges: [
              ...((_d =
                (_c = groupNodeData.collapsedData) == null
                  ? void 0
                  : _c.edges) != null
                ? _d
                : []),
...
var FocusModeCanvasExtension = class extends CanvasExtension {
  ...
  toggleFocusMode(canvas) {
    var _a, _b;
    const controlMenuFocusToggle =
      (_b =
        (_a = canvas.quickSettingsButton) == null
          ? void 0
          : _a.parentElement) == null
        ? void 0
        : _b.querySelector(`#${CONTROL_MENU_FOCUS_TOGGLE_ID}`);
...
var AutoFileNodeEdgesCanvasExtension = class extends CanvasExtension {
  ...
  onMetadataChanged(canvas, file) {
    ...
    for (const node of canvas.nodes.values()) {
      if (
        node.getData().type !== "file" ||
        ((_a = node.file) == null ? void 0 : _a.path) !== file.path
      )
        continue;
  ...
  updateFileNodeEdges(canvas, node) {
    ...
    const newEdges = Array.from(edges.values()).filter(
      (edge) => !canvas.edges.has(edge.id),
    );
    canvas.importData({ nodes: [], edges: newEdges }, false, false);
    for (const edge of canvas.edges.values()) {
      if (
        edge.id.startsWith(`${AUTO_EDGE_ID_PREFIX}${node.id}`) &&
        !edges.has(edge.id)
      )
        canvas.removeEdge(edge);
    }
  ...
  getFileNodeEdges(canvas, node) {
    ...
    const linkedFilesFrontmatterKey = this.plugin.settings.getSetting(
      "autoFileNodeEdgesFrontmatterKey",
    );
    const fileLinksToBeLinkedTo =
      (_b =
        (_a = fileMetadata.frontmatterLinks) == null
          ? void 0
          : _a.filter(
              (link) => link.key.split(".")[0] === linkedFilesFrontmatterKey,
            )) != null
        ? _b
        : [];
    const filepathsToBeLinkedTo = fileLinksToBeLinkedTo
      ...
      .map((file) => (file == null ? void 0 : file.path))
      .filter((path) => path !== null);
    const nodesToBeLinkedTo = Array.from(canvas.nodes.values()).filter(
      (otherNode) => {
        var _a2;
        return (
          otherNode.id !== node.id &&
          filepathsToBeLinkedTo.includes(
            (_a2 = otherNode.file) == null ? void 0 : _a2.path,
          )
        );
      },
    );
    ...
    for (const otherNode of nodesToBeLinkedTo) {
      ...
      const bestFromSide = CanvasHelper.getBestSideForFloatingEdge(
        BBoxHelper.getCenterOfBBoxSide(otherNode.getBBox(), "right"),
        node,
      );
      const bestToSide = CanvasHelper.getBestSideForFloatingEdge(
        BBoxHelper.getCenterOfBBoxSide(node.getBBox(), "left"),
        otherNode,
      );
      newEdges.set(edgeId, {
        id: edgeId,
...
var FlipEdgeCanvasExtension = class extends CanvasExtension {
  ...
  onPopupMenuCreated(canvas) {
    ...
    for (const icon of POSSIBLE_ICONS) {
      edgeDirectionButton =
        (_b = popupMenuEl.querySelector(
          `button:not([id]) > .svg-icon.${icon}`,
        )) == null
          ? void 0
          : _b.parentElement;
    ...
    edgeDirectionButton.addEventListener("click", () =>
      this.onEdgeDirectionDropdownCreated(canvas),
    );
  }
...
var EdgeSelectionCanvasExtension = class extends CanvasExtension {
  ...
  onPopupMenuCreated(canvas) {
    ...
    const selectEdgeByDirection = this.plugin.settings.getSetting(
      "selectEdgeByDirection",
    );
...
var ExportCanvasExtension = class extends CanvasExtension {
  ...
  init() {
    ...
    this.plugin.addCommand({
      ...
      checkCallback: CanvasHelper.canvasCommand(
        ...
        (canvas) => canvas.selection.size > 0,
        (canvas) =>
          void this.showExportImageSettingsModal(
            canvas,
            canvas
              .getSelectionData()
              .nodes.map((nodeData) => canvas.nodes.get(nodeData.id))
  ...
  async showExportImageSettingsModal(canvas, nodesToExport) {
    ...
    const updateDynamicSettings = () => {
      ...
      if (svg) {
        (_a =
          pixelRatioSetting == null ? void 0 : pixelRatioSetting.settingEl) ==
        null
          ? void 0
          : _a.hide();
        (_b =
          noFontExportSetting == null
            ? void 0
            : noFontExportSetting.settingEl) == null
          ? void 0
          : _b.show();
        (_c =
          transparentBackgroundSetting == null
            ? void 0
            : transparentBackgroundSetting.settingEl) == null
          ? void 0
          : _c.hide();
      } else {
        (_d =
    ...
    let svg = false;
    new import_obsidian20.Setting(modal.contentEl)
    ...
    pixelRatioSetting = new import_obsidian20.Setting(modal.contentEl)
      .setName("Pixel ratio")
      .setDesc(
        "Higher pixel ratios result in higher resolution images but also larger file sizes.",
      )
      .addSlider((slider) =>
        slider
          .setDynamicTooltip()
    ...
    noFontExportSetting = new import_obsidian20.Setting(modal.contentEl)
      .setName("Skip font export")
      .setDesc(
        "This will not include the fonts in the exported SVG. This will make the SVG file smaller.",
      )
      .addToggle((toggle) =>
        toggle
    ...
    let theme = activeDocument.body.classList.contains("theme-dark")
      ? "dark"
      : "light";
    new import_obsidian20.Setting(modal.contentEl)
      .setName("Theme")
    ...
    new import_obsidian20.Setting(modal.contentEl)
      .setName("Show logo")
      .setDesc(
        "This will add an Obsidian + Advanced Canvas logo to the bottom left.",
      )
      .addToggle((toggle) =>
        toggle.setValue(watermark).onChange((value) => (watermark = value)),
      );
    ...
    new import_obsidian20.Setting(modal.contentEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(garbledText).onChange((value) => (garbledText = value)),
      );
    let transparentBackground = false;
    transparentBackgroundSetting = new import_obsidian20.Setting(
      modal.contentEl,
    )
    ...
    new import_obsidian20.Setting(modal.contentEl).addButton((button) =>
      button
        .setButtonText("Save")
        .setCta()
        .onClick(async () => {
  ...
  async exportImage(
    ...
    var _a, _b, _c;
    const cachedTheme = activeDocument.body.classList.contains("theme-dark")
      ? "dark"
      : "light";
    ...
    const edgesToExport = [...canvas.edges.values()].filter((edge) => {
      const edgeData = edge.getData();
      return (
        nodesToExportIds.includes(edgeData.fromNode) &&
        nodesToExportIds.includes(edgeData.toNode)
      );
    });
    ...
    try {
      const targetBoundingBox = CanvasHelper.getBBox([
        ...nodesToExport,
        ...edgesToExport,
      ]);
      let enlargedTargetBoundingBox = BBoxHelper.scaleBBox(
        targetBoundingBox,
        1.1,
      );
      const enlargedTargetBoundingBoxSize = {
        width: enlargedTargetBoundingBox.maxX - enlargedTargetBoundingBox.minX,
        height: enlargedTargetBoundingBox.maxY - enlargedTargetBoundingBox.minY,
      };
      const canvasElSize = {
      ...
      const requiredPixelRatio = Math.max(
        enlargedTargetBoundingBoxSize.width / canvasElSize.width,
        enlargedTargetBoundingBoxSize.height / canvasElSize.height,
      );
      const pixelRatio = svg
        ? void 0
        : Math.round(requiredPixelRatio * pixelRatioFactor);
      watermarkEl = watermark
        ? this.getWatermark(enlargedTargetBoundingBox)
        : null;
      if (watermarkEl) canvas.canvasEl.appendChild(watermarkEl);
      const actualAspectRatio =
        canvas.canvasRect.width / canvas.canvasRect.height;
      const targetAspectRatio =
        (enlargedTargetBoundingBox.maxX - enlargedTargetBoundingBox.minX) /
        (enlargedTargetBoundingBox.maxY - enlargedTargetBoundingBox.minY);
      ...
      if (actualAspectRatio > targetAspectRatio) {
        ...
        adjustedBoundingBox.maxY =
          enlargedTargetBoundingBox.minY + actualHeight;
      }
      canvas.zoomToRealBbox(adjustedBoundingBox);
      canvas.setViewport(canvas.tx, canvas.ty, canvas.tZoom);
      await sleep(10);
      let canvasScale = parseFloat(
        ((_a = canvas.canvasEl.style.transform.match(
          /scale\((\d+(\.\d+)?)\)/,
        )) == null
          ? void 0
          : _a[1]) || "1",
      );
      const edgePathsBBox = BBoxHelper.combineBBoxes(
        edgesToExport.map((edge) => {
          const edgeCenter = edge.getCenter();
          const labelWidth = edge.labelElement
            ? edge.labelElement.wrapperEl.getBoundingClientRect().width /
              canvasScale
            : 0;
          return {
      ...
      enlargedTargetBoundingBox = BBoxHelper.combineBBoxes([
        enlargedTargetBoundingBox,
        enlargedEdgePathsBBox,
      ]);
      adjustedBoundingBox = BBoxHelper.combineBBoxes([
        adjustedBoundingBox,
        enlargedEdgePathsBBox,
      ]);
      canvas.zoomToRealBbox(adjustedBoundingBox);
      ...
      canvasScale = parseFloat(
        ((_b = canvas.canvasEl.style.transform.match(
          /scale\((\d+(\.\d+)?)\)/,
        )) == null
          ? void 0
          : _b[1]) || "1",
      ...
      let unloadedNodes = nodesToExport.filter(
        (node) => node.initialized === false || node.isContentMounted === false,
      );
      const startTimestamp = performance.now();
      while (
        unloadedNodes.length > 0 &&
        performance.now() - startTimestamp < MAX_ALLOWED_LOADING_TIME
      ) {
        await sleep(10);
        unloadedNodes = nodesToExport.filter(
          (node) =>
      ...
      if (unloadedNodes.length === 0) {
        ...
        const filter = (element) => {
          var _a2, _b2, _c2, _d;
          if (
            ((_a2 = element.classList) == null
              ? void 0
              : _a2.contains("canvas-node")) &&
            !nodeElements.includes(element)
          )
            return false;
          if (
            ((_c2 =
              (_b2 = element.parentElement) == null ? void 0 : _b2.classList) ==
            null
              ? void 0
              : _c2.contains("canvas-edges")) &&
            !edgePathAndArrowElements.includes(element)
          )
            return false;
          if (
            ((_d = element.classList) == null
              ? void 0
              : _d.contains("canvas-path-label-wrapper")) &&
            !edgeLabelElements.includes(element)
          )
            return false;
          return true;
        };
        ...
        let imageDataUri = svg
          ? await toSvg(canvas.canvasEl, options)
        ...
        const ERROR_MESSAGE =
          "Export cancelled: Nodes did not finish loading in time";
  ...
  getWatermark(bbox) {
    ...
    const watermarkEl = activeDocument.createElementNS(
...
var FloatingEdgeCanvasExtension = class extends CanvasExtension {
  ...
  init() {
    ...
    if (this.plugin.settings.getSetting("allowFloatingEdgeCreation")) {
      this.plugin.registerEvent(
        this.plugin.app.workspace.on(
          "advanced-canvas:edge-connection-dragging:before",
          (canvas, edge, event, newEdge, side) =>
            this.onEdgeStartedDragging(canvas, edge, event, newEdge, side),
        ),
      );
    }
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        "advanced-canvas:edge-connection-dragging:after",
        (canvas, edge, event, newEdge, side) =>
          this.onEdgeStoppedDragging(canvas, edge, event, newEdge, side),
      ),
    );
  }
  ...
  onNodeMoved(canvas, node) {
    ...
    for (const edge of affectedEdges) this.updateEdgeConnectionSide(edge);
  }
  updateEdgeConnectionSide(edge) {
    const edgeData = edge.getData();
    if (edgeData.fromFloating) {
      const fixedNodeConnectionPoint = BBoxHelper.getCenterOfBBoxSide(
        edge.to.node.getBBox(),
        edge.to.side,
      );
      const bestSide = CanvasHelper.getBestSideForFloatingEdge(
        fixedNodeConnectionPoint,
        edge.from.node,
      );
  ...
  onEdgeStartedDragging(canvas, edge, _event, newEdge, _side) {
    ...
    this.onPointerMove = (event) => {
      if (
        cachedViewportNodes === null ||
        hasNaNFloatingEdgeDropZones ||
        canvas.viewportChanged
      ) {
        hasNaNFloatingEdgeDropZones = false;
        cachedViewportNodes = canvas.getViewportNodes().map((node) => {
          const nodeFloatingEdgeDropZone =
            this.getFloatingEdgeDropZoneForNode(node);
          if (
            isNaN(nodeFloatingEdgeDropZone.minX) ||
            isNaN(nodeFloatingEdgeDropZone.minY) ||
            isNaN(nodeFloatingEdgeDropZone.maxX) ||
            isNaN(nodeFloatingEdgeDropZone.maxY)
          )
      ...
      for (const [
        node,
        nodeFloatingEdgeDropZoneClientRect,
      ] of cachedViewportNodes) {
        const hovering = BBoxHelper.insideBBox(
  ...
  onEdgeStoppedDragging(_canvas, edge, event, _newEdge, side) {
    ...
    const floatingEdgeDropZone =
      this.getFloatingEdgeDropZoneForNode(dropZoneNode);
    const wasDroppedInFloatingEdgeDropZone = this.plugin.settings.getSetting(
      "allowFloatingEdgeCreation",
    )
      ? BBoxHelper.insideBBox(
          { x: event.clientX, y: event.clientY },
          floatingEdgeDropZone,
          true,
        )
      : false;
    const edgeData = edge.getData();
    if (
      side === "from" &&
      wasDroppedInFloatingEdgeDropZone == edgeData.fromFloating
    )
      return;
    if (
      side === "to" &&
      wasDroppedInFloatingEdgeDropZone == edgeData.toFloating
    )
      return;
    if (side === "from")
  ...
  getFloatingEdgeDropZoneForNode(node) {
    ...
    const nodeFloatingEdgeDropZoneSize = {
      width: parseFloat(
        nodeFloatingEdgeDropZoneElStyle.getPropertyValue("width"),
      ),
      height: parseFloat(
        nodeFloatingEdgeDropZoneElStyle.getPropertyValue("height"),
      ),
    };
    return {
      minX:
        nodeElClientBoundingRect.left +
        (nodeElClientBoundingRect.width - nodeFloatingEdgeDropZoneSize.width) /
          2,
      minY:
        nodeElClientBoundingRect.top +
        (nodeElClientBoundingRect.height -
          nodeFloatingEdgeDropZoneSize.height) /
          2,
      maxX:
        nodeElClientBoundingRect.right -
        (nodeElClientBoundingRect.width - nodeFloatingEdgeDropZoneSize.width) /
          2,
      maxY:
        nodeElClientBoundingRect.bottom -
        (nodeElClientBoundingRect.height -
          nodeFloatingEdgeDropZoneSize.height) /
          2,
    };
  ...
  init() {
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        "advanced-canvas:selection-changed",
        (canvas, oldSelection, updateSelection) =>
          this.onSelectionChanged(canvas, oldSelection),
      ),
    );
  }
  onSelectionChanged(canvas, oldSelection) {
    var _a, _b, _c, _d, _e;
    const connectedEdgesToBeHighlighted = new Set(
      canvas.getSelectionData().nodes.flatMap((nodeData) => {
        var _a2, _b2;
        return [
          ...((_a2 = canvas.edgeFrom.get(canvas.nodes.get(nodeData.id))) != null
            ? _a2
            : []),
          ...(this.plugin.settings.getSetting("highlightIncomingEdges")
            ? (_b2 = canvas.edgeTo.get(canvas.nodes.get(nodeData.id))) != null
              ? _b2
              : []
            : []),
        ];
    ...
    for (const edge of canvas.edges.values()) {
      ...
      (_b = (_a = edge.lineEndGroupEl) == null ? void 0 : _a.classList) == null
        ? void 0
        : _b.toggle("is-focused", isFocused);
      (_e =
        (_d = (_c = edge.labelElement) == null ? void 0 : _c.textareaEl) == null
          ? void 0
          : _d.classList) == null
        ? void 0
        : _e.toggle("is-focused", isFocused);
    }
  }
};
...
var ReadingModeFixCanvasExtension = class extends CanvasExtension {
  ...
  updateNodeRenderer(node) {
    var _a, _b;
    const renderer =
      (_b = (_a = node.child) == null ? void 0 : _a.previewMode) == null
        ? void 0
        : _b.renderer;
    if (!renderer) return;
    renderer.onRendered(() => {
...
var CanvasMetadataExposerExtension = class extends CanvasExtension {
  ...
  init() {
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on("advanced-canvas:canvas-changed", (canvas) =>
        this.updateExposedSettings(canvas),
      ),
    );
  }
...
var CanvasWrapperExposerExtension = class _CanvasWrapperExposerExtension extends CanvasExtension {
  ...
  init() {
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on("advanced-canvas:canvas-changed", (canvas) =>
        _CanvasWrapperExposerExtension.updateCanvasExposedSettings(
          this.plugin,
          canvas.wrapperEl,
        ),
      ),
...
var NodeExposerExtension = class extends CanvasExtension {
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        ...
        (_canvas, node) => {
          ...
          const iframe =
            (_b =
              (_a = node.nodeEl.querySelector("iframe")) == null
                ? void 0
                : _a.contentDocument) == null
              ? void 0
              : _b.body;
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        ...
        (_canvas, node, editing) => {
          ...
          new MutationObserver(() =>
            iframe.classList.toggle(CANVAS_NODE_IFRAME_BODY_CLASS, true),
  ...
  setDataAttributes(element, nodeData) {
    for (const exposedDataKey of getExposedNodeData(this.plugin.settings)) {
      const datasetPairs =
        nodeData[exposedDataKey] && typeof nodeData[exposedDataKey] === "object"
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        ...
        (canvas, node) => {
          ...
          for (const exposedDataKey of getExposedNodeData(
            this.plugin.settings,
          )) {
            const datasetPairs =
              nodeData[exposedDataKey] instanceof Object
                ? Object.entries(nodeData[exposedDataKey])
                : [[exposedDataKey, nodeData[exposedDataKey]]];
            for (const [key, value] of datasetPairs) {
              const modifiedKey =
                TARGET_NODE_DATASET_PREFIX +
          ...
          if (PortalsCanvasExtension.isPortalElement(node.id))
    ...
    this.plugin.registerEvent(
      this.plugin.app.workspace.on(
        ...
        (_canvas, edge) => {
          ...
          if (!edgeData) return;
          for (const exposedDataKey of getExposedEdgeData(
            this.plugin.settings,
          )) {
            const datasetPairs =
              edgeData[exposedDataKey] &&
              typeof edgeData[exposedDataKey] === "object"
...
var BasesTableViewPatcher = class extends Patcher {
  ...
  async patchViewFactory(bases) {
    const that = this;
    await Patcher.patchOnce(
      this.plugin,
      bases.registrations.table,
      (resolve) => ({
        factory: Patcher.OverrideExisting(
          (next) =>
            function (...args) {
              const view = next.call(this, ...args);
  ...
  async patchTableView(basesView) {
    ...
    await Patcher.patchOnce(this.plugin, basesView, (resolve) => ({
      updateVirtualDisplay: Patcher.OverrideExisting(
        (next) =>
          function (...args) {
            const result = next.call(this, ...args);
      ...
      render: Patcher.OverrideExisting(
        (next) =>
          function (ctx) {
            var _a;
            const isCanvas =
              ((_a = ctx.file) == null ? void 0 : _a.extension) === "canvas";
...
var AdvancedCanvasPlugin = class extends import_obsidian21.Plugin {
  ...
  getCurrentCanvas() {
    var _a;
    return (
      ((_a = this.getCurrentCanvasView()) == null ? void 0 : _a.canvas) || null
    );
  }
  createFileSnapshot(path, content) {
    var _a;
    const fileRecoveryPlugin =
      (_a = this.app.internalPlugins.plugins["file-recovery"]) == null
        ? void 0
        : _a.instance;
